...
#else
static inline bool fdmon_epoll_try_upgrade(AioContext* ctx, unsigned npfd) { return false; }
...
#else
static inline bool fdmon_io_uring_setup(AioContext* ctx) { return false; }
