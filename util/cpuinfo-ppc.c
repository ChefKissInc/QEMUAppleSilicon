...
unsigned __attribute__((constructor)) cpuinfo_init(void)
{
    ...
    if (hwcap2 & PPC_FEATURE2_ARCH_3_1) { info |= CPUINFO_V3_1 | CPUINFO_V3_0 | CPUINFO_V2_07 | CPUINFO_V2_06; }
    ...
    if (hwcap2 & PPC_FEATURE2_ISEL) { info |= CPUINFO_ISEL; }
    if (hwcap & PPC_FEATURE_HAS_ALTIVEC) {
        ...
        if (hwcap & PPC_FEATURE_HAS_VSX) {
             ...
             */
            if (hwcap2 & PPC_FEATURE2_VEC_CRYPTO) { info |= CPUINFO_CRYPTO; }
        }
    }
#endif
