...
REG32(WDOGITCR, 0xf00)
    REG_FIELD(WDOGITCR, ENABLE, 0, 1)
#define R_WDOGITCR_VALID_MASK R_WDOGITCR_ENABLE_MASK
REG32(WDOGITOP, 0xf04)
    REG_FIELD(WDOGITOP, WDOGRES, 0, 1)
    REG_FIELD(WDOGITOP, WDOGINT, 1, 1)
