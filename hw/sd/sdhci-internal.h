...
#define TRANSFERRING_DATA(x) ((x) & (SDHC_DOING_READ | SDHC_DOING_WRITE))
...
#define SDHC_CLOCK_IS_ON(x)   (((x) & SDHC_CLOCK_CHK_MASK) == SDHC_CLOCK_CHK_MASK)
...
#define DEFINE_SDHCI_COMMON_PROPERTIES(_state)                                                               \
    DEFINE_PROP_UINT8("endianness", _state, endianness, DEVICE_LITTLE_ENDIAN),                               \
        ...
        DEFINE_PROP_UINT8("vendor", _state, vendor,                                                          \
                          SDHCI_VENDOR_NONE), /* Capabilities registers provide information on supported     \
