...
REG32(I3C1_REG1, 0x14)
    REG_FIELD(I3C1_REG1, I2C_MODE,  0,  1)
    REG_FIELD(I3C1_REG1, SA_EN,     15, 1)
REG32(I3C2_REG0, 0x20)
REG32(I3C2_REG1, 0x24)
    REG_FIELD(I3C2_REG1, I2C_MODE,  0,  1)
    REG_FIELD(I3C2_REG1, SA_EN,     15, 1)
REG32(I3C3_REG0, 0x30)
REG32(I3C3_REG1, 0x34)
    REG_FIELD(I3C3_REG1, I2C_MODE,  0,  1)
    REG_FIELD(I3C3_REG1, SA_EN,     15, 1)
REG32(I3C4_REG0, 0x40)
REG32(I3C4_REG1, 0x44)
    REG_FIELD(I3C4_REG1, I2C_MODE,  0,  1)
    REG_FIELD(I3C4_REG1, SA_EN,     15, 1)
REG32(I3C5_REG0, 0x50)
REG32(I3C5_REG1, 0x54)
    REG_FIELD(I3C5_REG1, I2C_MODE,  0,  1)
    REG_FIELD(I3C5_REG1, SA_EN,     15, 1)
REG32(I3C6_REG0, 0x60)
REG32(I3C6_REG1, 0x64)
    REG_FIELD(I3C6_REG1, I2C_MODE,  0,  1)
    REG_FIELD(I3C6_REG1, SA_EN,     15, 1)
...
REG32(DEVICE_ADDR_TABLE_POINTER,    0x5c)
    REG_FIELD(DEVICE_ADDR_TABLE_POINTER, DEPTH, 16, 16)
    REG_FIELD(DEVICE_ADDR_TABLE_POINTER, ADDR,  0,  16)
