...
REG32(SWRESET, 0x108)
    REG_FIELD(SWRESET, SWRESETREQ, 9, 1)
REG32(GRETREG, 0x10c)
REG32(INITSVTOR0, 0x110)
    REG_FIELD(INITSVTOR0, LOCK, 0, 1)
    REG_FIELD(INITSVTOR0, VTOR, 7, 25)
...
REG32(EWCTRL, 0x124)
REG32(PWRCTRL, 0x1fc)
    REG_FIELD(PWRCTRL, PPU_ACCESS_UNLOCK, 0, 1)
    REG_FIELD(PWRCTRL, PPU_ACCESS_FILTER, 1, 1)
