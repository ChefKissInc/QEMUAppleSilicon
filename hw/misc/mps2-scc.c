...
REG32(CFGCTRL, 0xa8)
    REG_FIELD(CFGCTRL, DEVICE, 0, 12)
    REG_FIELD(CFGCTRL, RES1, 12, 8)
    REG_FIELD(CFGCTRL, FUNCTION, 20, 6)
    REG_FIELD(CFGCTRL, RES2, 26, 4)
    REG_FIELD(CFGCTRL, WRITE, 30, 1)
    REG_FIELD(CFGCTRL, START, 31, 1)
REG32(CFGSTAT, 0xac)
    REG_FIELD(CFGSTAT, DONE, 0, 1)
    REG_FIELD(CFGSTAT, ERROR, 1, 1)
REG32(DLL, 0x100)
REG32(AID, 0xFF8)
REG32(ID, 0xFFC)
