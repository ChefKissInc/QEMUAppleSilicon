...
REG_FIELD(BONGENCFG, DEBUGMODE,      0, 1)
REG_FIELD(BONGENCFG, SNOOP,          1, 1)
REG_FIELD(BONGENCFG, CPUSELFRESET,   2, 1)
REG_FIELD(BONGENCFG, BYTESWAP,       6, 1)
REG_FIELD(BONGENCFG, UNCACHED,       7, 1)
REG_FIELD(BONGENCFG, PREFETCH,       8, 1)
REG_FIELD(BONGENCFG, WRITEBEHIND,    9, 1)
REG_FIELD(BONGENCFG, PCIQUEUE,      12, 1)
...
static void bonito_reset_hold(Object *obj, ResetType type)
{
    ...
    val = REG_FIELD_DP32(val, BONGENCFG, PCIQUEUE, 1);
    val = REG_FIELD_DP32(val, BONGENCFG, WRITEBEHIND, 1);
    val = REG_FIELD_DP32(val, BONGENCFG, PREFETCH, 1);
    val = REG_FIELD_DP32(val, BONGENCFG, UNCACHED, 1);
    val = REG_FIELD_DP32(val, BONGENCFG, CPUSELFRESET, 1);
