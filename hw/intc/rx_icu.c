...
REG8(IR, 0)
  REG_FIELD(IR, IR,  0, 1)
REG8(DTCER, 0x100)
  REG_FIELD(DTCER, DTCE,  0, 1)
REG8(IER, 0x200)
REG8(SWINTR, 0x2e0)
  REG_FIELD(SWINTR, SWINT, 0, 1)
REG16(FIR, 0x2f0)
  REG_FIELD(FIR, FVCT, 0,  8)
  REG_FIELD(FIR, FIEN, 15, 1)
REG8(IPR, 0x300)
  REG_FIELD(IPR, IPR, 0, 4)
REG8(DMRSR, 0x400)
REG8(IRQCR, 0x500)
  REG_FIELD(IRQCR, IRQMD, 2, 2)
REG8(NMISR, 0x580)
  REG_FIELD(NMISR, NMIST, 0, 1)
  REG_FIELD(NMISR, LVDST, 1, 1)
  REG_FIELD(NMISR, OSTST, 2, 1)
REG8(NMIER, 0x581)
  REG_FIELD(NMIER, NMIEN, 0, 1)
  REG_FIELD(NMIER, LVDEN, 1, 1)
  REG_FIELD(NMIER, OSTEN, 2, 1)
REG8(NMICLR, 0x582)
  REG_FIELD(NMICLR, NMICLR, 0, 1)
  REG_FIELD(NMICLR, OSTCLR, 2, 1)
REG8(NMICR, 0x583)
  REG_FIELD(NMICR, NMIMD, 3, 1)
