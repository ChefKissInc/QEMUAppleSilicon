...
REG_FIELD(GICR_PROPBASER, IDBITS, 0, 5)
REG_FIELD(GICR_PROPBASER, INNERCACHE, 7, 3)
REG_FIELD(GICR_PROPBASER, SHAREABILITY, 10, 2)
REG_FIELD(GICR_PROPBASER, PHYADDR, 12, 40)
REG_FIELD(GICR_PROPBASER, OUTERCACHE, 56, 3)

REG_FIELD(GICR_PENDBASER, INNERCACHE, 7, 3)
REG_FIELD(GICR_PENDBASER, SHAREABILITY, 10, 2)
REG_FIELD(GICR_PENDBASER, PHYADDR, 16, 36)
REG_FIELD(GICR_PENDBASER, OUTERCACHE, 56, 3)
REG_FIELD(GICR_PENDBASER, PTZ, 62, 1)

#define GICR_PROPBASER_IDBITS_THRESHOLD 0xd

/* These are the GICv4 VPROPBASER and VPENDBASER layouts; v4.1 is different */
REG_FIELD(GICR_VPROPBASER, IDBITS, 0, 5)
REG_FIELD(GICR_VPROPBASER, INNERCACHE, 7, 3)
REG_FIELD(GICR_VPROPBASER, SHAREABILITY, 10, 2)
REG_FIELD(GICR_VPROPBASER, PHYADDR, 12, 40)
REG_FIELD(GICR_VPROPBASER, OUTERCACHE, 56, 3)

REG_FIELD(GICR_VPENDBASER, INNERCACHE, 7, 3)
REG_FIELD(GICR_VPENDBASER, SHAREABILITY, 10, 2)
REG_FIELD(GICR_VPENDBASER, PHYADDR, 16, 36)
REG_FIELD(GICR_VPENDBASER, OUTERCACHE, 56, 3)
REG_FIELD(GICR_VPENDBASER, DIRTY, 60, 1)
REG_FIELD(GICR_VPENDBASER, PENDINGLAST, 61, 1)
REG_FIELD(GICR_VPENDBASER, IDAI, 62, 1)
REG_FIELD(GICR_VPENDBASER, VALID, 63, 1)
...
REG_FIELD(GITS_BASER, SIZE, 0, 8)
REG_FIELD(GITS_BASER, PAGESIZE, 8, 2)
REG_FIELD(GITS_BASER, SHAREABILITY, 10, 2)
REG_FIELD(GITS_BASER, PHYADDR, 12, 36)
REG_FIELD(GITS_BASER, PHYADDRL_64K, 16, 32)
REG_FIELD(GITS_BASER, PHYADDRH_64K, 12, 4)
REG_FIELD(GITS_BASER, ENTRYSIZE, 48, 5)
REG_FIELD(GITS_BASER, OUTERCACHE, 53, 3)
REG_FIELD(GITS_BASER, TYPE, 56, 3)
REG_FIELD(GITS_BASER, INNERCACHE, 59, 3)
REG_FIELD(GITS_BASER, INDIRECT, 62, 1)
REG_FIELD(GITS_BASER, VALID, 63, 1)

REG_FIELD(GITS_CBASER, SIZE, 0, 8)
REG_FIELD(GITS_CBASER, SHAREABILITY, 10, 2)
REG_FIELD(GITS_CBASER, PHYADDR, 12, 40)
REG_FIELD(GITS_CBASER, OUTERCACHE, 53, 3)
REG_FIELD(GITS_CBASER, INNERCACHE, 59, 3)
REG_FIELD(GITS_CBASER, VALID, 63, 1)

REG_FIELD(GITS_CREADR, STALLED, 0, 1)
REG_FIELD(GITS_CREADR, OFFSET, 5, 15)

REG_FIELD(GITS_CWRITER, RETRY, 0, 1)
REG_FIELD(GITS_CWRITER, OFFSET, 5, 15)

REG_FIELD(GITS_CTLR, ENABLED, 0, 1)
REG_FIELD(GITS_CTLR, QUIESCENT, 31, 1)

REG_FIELD(GITS_TYPER, PHYSICAL, 0, 1)
REG_FIELD(GITS_TYPER, VIRTUAL, 1, 1)
REG_FIELD(GITS_TYPER, ITT_ENTRY_SIZE, 4, 4)
REG_FIELD(GITS_TYPER, IDBITS, 8, 5)
REG_FIELD(GITS_TYPER, DEVBITS, 13, 5)
REG_FIELD(GITS_TYPER, SEIS, 18, 1)
REG_FIELD(GITS_TYPER, PTA, 19, 1)
REG_FIELD(GITS_TYPER, CIDBITS, 32, 4)
REG_FIELD(GITS_TYPER, CIL, 36, 1)
REG_FIELD(GITS_TYPER, VMOVP, 37, 1)

#define GITS_IDREGS 0xFFD0

#define GITS_BASER_RO_MASK (R_GITS_BASER_ENTRYSIZE_MASK | R_GITS_BASER_TYPE_MASK)
...
REG_FIELD(MOVALL_2, RDBASE1, 16, 36)
REG_FIELD(MOVALL_3, RDBASE2, 16, 36)

/* MOVI command fields */
REG_FIELD(MOVI_0, DEVICEID, 32, 32)
REG_FIELD(MOVI_1, EVENTID, 0, 32)
REG_FIELD(MOVI_2, ICID, 0, 16)

/* INV command fields */
REG_FIELD(INV_0, DEVICEID, 32, 32)
REG_FIELD(INV_1, EVENTID, 0, 32)

/* VMAPI, VMAPTI command fields */
REG_FIELD(VMAPTI_0, DEVICEID, 32, 32)
REG_FIELD(VMAPTI_1, EVENTID, 0, 32)
REG_FIELD(VMAPTI_1, VPEID, 32, 16)
REG_FIELD(VMAPTI_2, VINTID, 0, 32) /* VMAPTI only */
REG_FIELD(VMAPTI_2, DOORBELL, 32, 32)

/* VMAPP command fields */
REG_FIELD(VMAPP_0, ALLOC, 8, 1)             /* GICv4.1 only */
REG_FIELD(VMAPP_0, PTZ, 9, 1)               /* GICv4.1 only */
REG_FIELD(VMAPP_0, VCONFADDR, 16, 36)       /* GICv4.1 only */
REG_FIELD(VMAPP_1, DEFAULT_DOORBELL, 0, 32) /* GICv4.1 only */
REG_FIELD(VMAPP_1, VPEID, 32, 16)
REG_FIELD(VMAPP_2, RDBASE, 16, 36)
REG_FIELD(VMAPP_2, V, 63, 1)
REG_FIELD(VMAPP_3, VPTSIZE, 0, 8) /* For GICv4.0, bits [7:6] are RES0 */
REG_FIELD(VMAPP_3, VPTADDR, 16, 36)

/* VMOVP command fields */
REG_FIELD(VMOVP_0, SEQNUM, 32, 16) /* not used for GITS_TYPER.VMOVP == 1 */
REG_FIELD(VMOVP_1, ITSLIST, 0, 16) /* not used for GITS_TYPER.VMOVP == 1 */
REG_FIELD(VMOVP_1, VPEID, 32, 16)
REG_FIELD(VMOVP_2, RDBASE, 16, 36)
REG_FIELD(VMOVP_2, DB, 63, 1)               /* GICv4.1 only */
REG_FIELD(VMOVP_3, DEFAULT_DOORBELL, 0, 32) /* GICv4.1 only */

/* VMOVI command fields */
REG_FIELD(VMOVI_0, DEVICEID, 32, 32)
REG_FIELD(VMOVI_1, EVENTID, 0, 32)
REG_FIELD(VMOVI_1, VPEID, 32, 16)
REG_FIELD(VMOVI_2, D, 0, 1)
REG_FIELD(VMOVI_2, DOORBELL, 32, 32)

/* VINVALL command fields */
REG_FIELD(VINVALL_1, VPEID, 32, 16)
...
REG_FIELD(ITE_L, VALID, 0, 1)
REG_FIELD(ITE_L, INTTYPE, 1, 1)
REG_FIELD(ITE_L, INTID, 2, 24)
REG_FIELD(ITE_L, ICID, 32, 16)
REG_FIELD(ITE_L, VPEID, 48, 16)
REG_FIELD(ITE_H, DOORBELL, 0, 24)
...
REG_FIELD(DTE, VALID, 0, 1)
REG_FIELD(DTE, SIZE, 1, 5)
REG_FIELD(DTE, ITTADDR, 6, 44)
...
REG_FIELD(CTE, VALID, 0, 1)
REG_FIELD(CTE, RDBASE, 1, RDBASE_PROCNUM_LENGTH)
...
REG_FIELD(VTE, VALID, 0, 1)
REG_FIELD(VTE, VPTSIZE, 1, 5)
REG_FIELD(VTE, VPTADDR, 6, 36)
REG_FIELD(VTE, RDBASE, 42, RDBASE_PROCNUM_LENGTH)
...
static inline int gicv3_redist_size(GICv3State* s)
{
     ...
     */
    if (s->cpu[0].gicr_typer & GICR_TYPER_VLPIS) { return GICV4_REDIST_SIZE; }
    else {
 ...
 * IsSpecial() function.
 */
static inline bool gicv3_intid_is_special(int intid) { return intid >= INTID_SECURE && intid <= INTID_SPURIOUS; }
...
MemTxResult gicv3_dist_read(void* opaque, hwaddr offset, uint64_t* data, unsigned size, MemTxAttrs attrs);
MemTxResult gicv3_dist_write(void* opaque, hwaddr addr, uint64_t data, unsigned size, MemTxAttrs attrs);
...
static inline uint32_t gicv3_idreg(GICv3State* s, int regoffset, uint8_t pidr0)
{
     ...
     */
    static const uint8_t gicd_ids[] = {0x44, 0x00, 0x00, 0x00, 0x92, 0xB4, 0x0B, 0x00, 0x0D, 0xF0, 0x05, 0xB1};
    uint32_t             id;

    regoffset /= 4;

    if (regoffset == 4) { return pidr0; }
...
static inline int gicv3_irq_group(GICv3State* s, GICv3CPUState* cs, int irq)
{
    ...
    if (grpbit) { return GICV3_G1NS; }
    if (s->gicd_ctlr & GICD_CTLR_DS) { return GICV3_G0; }
 ...
 */
static inline uint32_t gicv3_redist_affid(GICv3CPUState* cs) { return cs->gicr_typer >> 32; }
...
static inline void gicv3_cache_target_cpustate(GICv3State* s, int irq)
{
    ...
    int            i;
    uint32_t       tgtaff = extract64(s->gicd_irouter[irq], 0, 24) | extract64(s->gicd_irouter[irq], 32, 8) << 24;
...
static inline void gicv3_cache_all_target_cpustates(GICv3State* s)
{
    ...
    for (irq = GIC_INTERNAL; irq < GICV3_MAXIRQ; irq++) { gicv3_cache_target_cpustate(s, irq); }
}
