...
REG32(DATA, 0)
REG32(STATE, 4)
    REG_FIELD(STATE, TXFULL, 0, 1)
    REG_FIELD(STATE, RXFULL, 1, 1)
    REG_FIELD(STATE, TXOVERRUN, 2, 1)
    REG_FIELD(STATE, RXOVERRUN, 3, 1)
REG32(CTRL, 8)
    REG_FIELD(CTRL, TX_EN, 0, 1)
    REG_FIELD(CTRL, RX_EN, 1, 1)
    REG_FIELD(CTRL, TX_INTEN, 2, 1)
    REG_FIELD(CTRL, RX_INTEN, 3, 1)
    REG_FIELD(CTRL, TXO_INTEN, 4, 1)
    REG_FIELD(CTRL, RXO_INTEN, 5, 1)
    REG_FIELD(CTRL, HSTEST, 6, 1)
REG32(INTSTATUS, 0xc)
    REG_FIELD(INTSTATUS, TX, 0, 1)
    REG_FIELD(INTSTATUS, RX, 1, 1)
    REG_FIELD(INTSTATUS, TXO, 2, 1)
    REG_FIELD(INTSTATUS, RXO, 3, 1)
REG32(BAUDDIV, 0x10)
REG32(PID4, 0xFD0)
REG32(PID5, 0xFD4)
REG32(PID6, 0xFD8)
