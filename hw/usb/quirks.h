...
struct usb_device_id
{
    ...
    uint8_t  interface_protocol_used : 1, terminating_entry : 1, reserved : 6;
};

#define USB_DEVICE(vendor, product) .vendor_id = vendor, .product_id = product, .interface_protocol_used = 0,

#define USB_DEVICE_AND_INTERFACE_INFO(vend, prod, iclass, isubclass, iproto)                           \
    .vendor_id = vend, .product_id = prod, .interface_class = iclass, .interface_subclass = isubclass, \
    .interface_protocol = iproto, .interface_protocol_used = 1
...
static const struct usb_device_id usbredir_ftdi_serial_ids[] = {
    ...
    {USB_DEVICE_AND_INTERFACE_INFO(MICROCHIP_VID, MICROCHIP_USB_BOARD_PID, 0xff, 0xff, 0x00)},
