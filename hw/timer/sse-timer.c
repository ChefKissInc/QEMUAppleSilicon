...
REG32(CNTP_CTL, 0x2c)
    REG_FIELD(CNTP_CTL, ENABLE, 0, 1)
    REG_FIELD(CNTP_CTL, IMASK, 1, 1)
    REG_FIELD(CNTP_CTL, ISTATUS, 2, 1)
REG32(CNTP_AIVAL_LO, 0x40)
REG32(CNTP_AIVAL_HI, 0x44)
REG32(CNTP_AIVAL_RELOAD, 0x48)
REG32(CNTP_AIVAL_CTL, 0x4c)
    REG_FIELD(CNTP_AIVAL_CTL, EN, 0, 1)
    REG_FIELD(CNTP_AIVAL_CTL, CLR, 1, 1)
REG32(CNTP_CFG, 0x50)
    REG_FIELD(CNTP_CFG, AIVAL, 0, 4)
