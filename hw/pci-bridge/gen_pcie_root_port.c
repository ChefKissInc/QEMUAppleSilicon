...
#define GEN_PCIE_ROOT_PORT_ACS_OFFSET (GEN_PCIE_ROOT_PORT_AER_OFFSET + PCI_ERR_SIZEOF)
...
static void gen_rp_interrupts_uninit(PCIDevice* d) { msix_uninit_exclusive_bar(d); }
...
static const Property gen_rp_props[] = {
    ...
    DEFINE_PROP_SIZE("mem-reserve", GenPCIERootPort, res_reserve.mem_non_pref, -1),
    DEFINE_PROP_SIZE("pref32-reserve", GenPCIERootPort, res_reserve.mem_pref_32, -1),
    DEFINE_PROP_SIZE("pref64-reserve", GenPCIERootPort, res_reserve.mem_pref_64, -1),
...
static void gen_rp_register_types(void) { type_register_static(&gen_rp_dev_info); }
