...
OBJECT_DEFINE_SIMPLE_TYPE_WITH_INTERFACES(ResettableContainer, resettable_container, RESETTABLE_CONTAINER, OBJECT,
...
void resettable_container_remove(ResettableContainer* rc, Object* obj) { g_ptr_array_remove(rc->children, obj); }
...
static void resettable_container_child_foreach(Object* obj, ResettableChildCallback cb, void* opaque, ResetType type)
{
    ResettableContainer* rc  = RESETTABLE_CONTAINER(obj);
...
static void resettable_container_class_init(ObjectClass* klass, const void* data)
{
