...
static QapiCloneVisitor* to_qcv(Visitor* v) { return container_of(v, QapiCloneVisitor, visitor); }

static bool qapi_clone_start_struct(Visitor* v, const char* name, void** obj, size_t size, Error** errp)
{
...
static bool qapi_clone_start_list(Visitor* v, const char* name, GenericList** listp, size_t size, Error** errp)
{ return qapi_clone_start_struct(v, name, (void**)listp, size, errp); }

static GenericList* qapi_clone_next_list(Visitor* v, GenericList* tail, size_t size)
{
    QapiCloneVisitor* qcv = to_qcv(v);
...
static bool qapi_clone_start_alternate(Visitor* v, const char* name, GenericAlternate** obj, size_t size, Error** errp)
{ return qapi_clone_start_struct(v, name, (void**)obj, size, errp); }

static bool qapi_clone_type_int64(Visitor* v, const char* name, int64_t* obj, Error** errp)
{
    QapiCloneVisitor* qcv = to_qcv(v);
...
static bool qapi_clone_type_uint64(Visitor* v, const char* name, uint64_t* obj, Error** errp)
{
    QapiCloneVisitor* qcv = to_qcv(v);
...
static bool qapi_clone_type_bool(Visitor* v, const char* name, bool* obj, Error** errp)
{
    QapiCloneVisitor* qcv = to_qcv(v);
...
static bool qapi_clone_type_str(Visitor* v, const char* name, char** obj, Error** errp)
{
    QapiCloneVisitor* qcv = to_qcv(v);
...
static bool qapi_clone_type_number(Visitor* v, const char* name, double* obj, Error** errp)
{
    QapiCloneVisitor* qcv = to_qcv(v);
...
static bool qapi_clone_type_null(Visitor* v, const char* name, QNull** obj, Error** errp)
{
    QapiCloneVisitor* qcv = to_qcv(v);
...
static void qapi_clone_free(Visitor* v) { g_free(v); }
