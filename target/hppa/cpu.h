...
REG_FIELD(FPSR, ENA_I, 0, 1)
REG_FIELD(FPSR, ENA_U, 1, 1)
REG_FIELD(FPSR, ENA_O, 2, 1)
REG_FIELD(FPSR, ENA_Z, 3, 1)
REG_FIELD(FPSR, ENA_V, 4, 1)
REG_FIELD(FPSR, ENABLES, 0, 5)
REG_FIELD(FPSR, D, 5, 1)
REG_FIELD(FPSR, T, 6, 1)
REG_FIELD(FPSR, RM, 9, 2)
REG_FIELD(FPSR, CQ, 11, 11)
REG_FIELD(FPSR, CQ0_6, 15, 7)
REG_FIELD(FPSR, CQ0_4, 17, 5)
REG_FIELD(FPSR, CQ0_2, 19, 3)
REG_FIELD(FPSR, CQ0, 21, 1)
REG_FIELD(FPSR, CA, 15, 7)
REG_FIELD(FPSR, CA0, 21, 1)
REG_FIELD(FPSR, C, 26, 1)
REG_FIELD(FPSR, FLG_I, 27, 1)
REG_FIELD(FPSR, FLG_U, 28, 1)
REG_FIELD(FPSR, FLG_O, 29, 1)
REG_FIELD(FPSR, FLG_Z, 30, 1)
REG_FIELD(FPSR, FLG_V, 31, 1)
REG_FIELD(FPSR, FLAGS, 27, 5)
