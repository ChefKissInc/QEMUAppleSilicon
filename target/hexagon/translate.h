...
REG_FIELD(PROBE_PKT_SCALAR_STORE_S0, MMU_IDX,       0, 2)
REG_FIELD(PROBE_PKT_SCALAR_STORE_S0, IS_PREDICATED, 2, 1)

REG_FIELD(PROBE_PKT_SCALAR_HVX_STORES, HAS_ST0,        0, 1)
REG_FIELD(PROBE_PKT_SCALAR_HVX_STORES, HAS_ST1,        1, 1)
REG_FIELD(PROBE_PKT_SCALAR_HVX_STORES, HAS_HVX_STORES, 2, 1)
REG_FIELD(PROBE_PKT_SCALAR_HVX_STORES, S0_IS_PRED,     3, 1)
REG_FIELD(PROBE_PKT_SCALAR_HVX_STORES, S1_IS_PRED,     4, 1)
REG_FIELD(PROBE_PKT_SCALAR_HVX_STORES, MMU_IDX,        5, 2)
