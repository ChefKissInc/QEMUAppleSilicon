...
static inline bool isar_feature_aa32_aes(const ARMISARegisters* id) { return FIELD_EX32_IDREG(id, ID_ISAR5, AES) != 0; }
...
static inline bool isar_feature_aa32_rdm(const ARMISARegisters* id) { return FIELD_EX32_IDREG(id, ID_ISAR5, RDM) != 0; }
...
static inline bool isar_feature_aa32_dp(const ARMISARegisters* id) { return FIELD_EX32_IDREG(id, ID_ISAR6, DP) != 0; }

static inline bool isar_feature_aa32_fhm(const ARMISARegisters* id) { return FIELD_EX32_IDREG(id, ID_ISAR6, FHM) != 0; }

static inline bool isar_feature_aa32_sb(const ARMISARegisters* id) { return FIELD_EX32_IDREG(id, ID_ISAR6, SB) != 0; }
...
static inline bool isar_feature_aa32_ras(const ARMISARegisters* id) { return FIELD_EX32_IDREG(id, ID_PFR0, RAS) != 0; }
...
static inline bool isar_feature_aa32_pan(const ARMISARegisters* id) { return FIELD_EX32_IDREG(id, ID_MMFR3, PAN) != 0; }
...
static inline bool isar_feature_aa32_pmuv3p1(const ARMISARegisters* id)
{
    ...
    return FIELD_EX32_IDREG(id, ID_DFR0, PERFMON) >= 4 && FIELD_EX32_IDREG(id, ID_DFR0, PERFMON) != 0xf;
}

static inline bool isar_feature_aa32_pmuv3p4(const ARMISARegisters* id)
{
    /* 0xf means "non-standard IMPDEF PMU" */
    return FIELD_EX32_IDREG(id, ID_DFR0, PERFMON) >= 5 && FIELD_EX32_IDREG(id, ID_DFR0, PERFMON) != 0xf;
}

static inline bool isar_feature_aa32_pmuv3p5(const ARMISARegisters* id)
{
    /* 0xf means "non-standard IMPDEF PMU" */
    return FIELD_EX32_IDREG(id, ID_DFR0, PERFMON) >= 6 && FIELD_EX32_IDREG(id, ID_DFR0, PERFMON) != 0xf;
}

static inline bool isar_feature_aa32_hpd(const ARMISARegisters* id)
{ return FIELD_EX32_IDREG(id, ID_MMFR4, HPDS) != 0; }

static inline bool isar_feature_aa32_ac2(const ARMISARegisters* id) { return FIELD_EX32_IDREG(id, ID_MMFR4, AC2) != 0; }
...
static inline bool isar_feature_aa32_evt(const ARMISARegisters* id) { return FIELD_EX32_IDREG(id, ID_MMFR4, EVT) >= 2; }

static inline bool isar_feature_aa32_dit(const ARMISARegisters* id) { return FIELD_EX32_IDREG(id, ID_PFR0, DIT) != 0; }
...
static inline ARMPauthFeature isar_feature_pauth_feature(const ARMISARegisters* id)
{
    /*
     * Architecturally, only one of {APA,API,APA3} may be active (non-zero)
     * and the other two must be zero.  Thus we may avoid conditionals.
     */
    return (FIELD_EX64_IDREG(id, ID_AA64ISAR1, APA) | FIELD_EX64_IDREG(id, ID_AA64ISAR1, API)
...
static inline bool isar_feature_aa64_lut(const ARMISARegisters* id) { return FIELD_EX64_IDREG(id, ID_AA64ISAR2, LUT); }
...
static inline bool isar_feature_aa64_scxtnum(const ARMISARegisters* id)
{
    ...
    if (key >= 2) { return true; /* FEAT_CSV2_2 */ }
    if (key == 1) {
...
{ return FIELD_EX64_IDREG(id, ID_AA64DFR0, PMUVER) >= 4 && FIELD_EX64_IDREG(id, ID_AA64DFR0, PMUVER) != 0xf; }

static inline bool isar_feature_aa64_pmuv3p4(const ARMISARegisters* id)
{ return FIELD_EX64_IDREG(id, ID_AA64DFR0, PMUVER) >= 5 && FIELD_EX64_IDREG(id, ID_AA64DFR0, PMUVER) != 0xf; }

static inline bool isar_feature_aa64_pmuv3p5(const ARMISARegisters* id)
{ return FIELD_EX64_IDREG(id, ID_AA64DFR0, PMUVER) >= 6 && FIELD_EX64_IDREG(id, ID_AA64DFR0, PMUVER) != 0xf; }
...
static inline uint64_t make_ccsidr(CCSIDRFormat format, unsigned assoc, unsigned linesize, unsigned cachesize,
                                   uint8_t flags)
{
