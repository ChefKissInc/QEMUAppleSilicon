...
const uint64_t expand_pred_b_data[256] = {
    0x0000000000000000, 0x00000000000000ff, 0x000000000000ff00, 0x000000000000ffff, 0x0000000000ff0000,
    0x0000000000ff00ff, 0x0000000000ffff00, 0x0000000000ffffff, 0x00000000ff000000, 0x00000000ff0000ff,
    0x00000000ff00ff00, 0x00000000ff00ffff, 0x00000000ffff0000, 0x00000000ffff00ff, 0x00000000ffffff00,
    0x00000000ffffffff, 0x000000ff00000000, 0x000000ff000000ff, 0x000000ff0000ff00, 0x000000ff0000ffff,
    0x000000ff00ff0000, 0x000000ff00ff00ff, 0x000000ff00ffff00, 0x000000ff00ffffff, 0x000000ffff000000,
    0x000000ffff0000ff, 0x000000ffff00ff00, 0x000000ffff00ffff, 0x000000ffffff0000, 0x000000ffffff00ff,
    0x000000ffffffff00, 0x000000ffffffffff, 0x0000ff0000000000, 0x0000ff00000000ff, 0x0000ff000000ff00,
    0x0000ff000000ffff, 0x0000ff0000ff0000, 0x0000ff0000ff00ff, 0x0000ff0000ffff00, 0x0000ff0000ffffff,
    0x0000ff00ff000000, 0x0000ff00ff0000ff, 0x0000ff00ff00ff00, 0x0000ff00ff00ffff, 0x0000ff00ffff0000,
    0x0000ff00ffff00ff, 0x0000ff00ffffff00, 0x0000ff00ffffffff, 0x0000ffff00000000, 0x0000ffff000000ff,
    0x0000ffff0000ff00, 0x0000ffff0000ffff, 0x0000ffff00ff0000, 0x0000ffff00ff00ff, 0x0000ffff00ffff00,
    0x0000ffff00ffffff, 0x0000ffffff000000, 0x0000ffffff0000ff, 0x0000ffffff00ff00, 0x0000ffffff00ffff,
    0x0000ffffffff0000, 0x0000ffffffff00ff, 0x0000ffffffffff00, 0x0000ffffffffffff, 0x00ff000000000000,
    0x00ff0000000000ff, 0x00ff00000000ff00, 0x00ff00000000ffff, 0x00ff000000ff0000, 0x00ff000000ff00ff,
    0x00ff000000ffff00, 0x00ff000000ffffff, 0x00ff0000ff000000, 0x00ff0000ff0000ff, 0x00ff0000ff00ff00,
    0x00ff0000ff00ffff, 0x00ff0000ffff0000, 0x00ff0000ffff00ff, 0x00ff0000ffffff00, 0x00ff0000ffffffff,
    0x00ff00ff00000000, 0x00ff00ff000000ff, 0x00ff00ff0000ff00, 0x00ff00ff0000ffff, 0x00ff00ff00ff0000,
    0x00ff00ff00ff00ff, 0x00ff00ff00ffff00, 0x00ff00ff00ffffff, 0x00ff00ffff000000, 0x00ff00ffff0000ff,
    0x00ff00ffff00ff00, 0x00ff00ffff00ffff, 0x00ff00ffffff0000, 0x00ff00ffffff00ff, 0x00ff00ffffffff00,
    0x00ff00ffffffffff, 0x00ffff0000000000, 0x00ffff00000000ff, 0x00ffff000000ff00, 0x00ffff000000ffff,
    0x00ffff0000ff0000, 0x00ffff0000ff00ff, 0x00ffff0000ffff00, 0x00ffff0000ffffff, 0x00ffff00ff000000,
    0x00ffff00ff0000ff, 0x00ffff00ff00ff00, 0x00ffff00ff00ffff, 0x00ffff00ffff0000, 0x00ffff00ffff00ff,
    0x00ffff00ffffff00, 0x00ffff00ffffffff, 0x00ffffff00000000, 0x00ffffff000000ff, 0x00ffffff0000ff00,
    0x00ffffff0000ffff, 0x00ffffff00ff0000, 0x00ffffff00ff00ff, 0x00ffffff00ffff00, 0x00ffffff00ffffff,
    0x00ffffffff000000, 0x00ffffffff0000ff, 0x00ffffffff00ff00, 0x00ffffffff00ffff, 0x00ffffffffff0000,
    0x00ffffffffff00ff, 0x00ffffffffffff00, 0x00ffffffffffffff, 0xff00000000000000, 0xff000000000000ff,
    0xff0000000000ff00, 0xff0000000000ffff, 0xff00000000ff0000, 0xff00000000ff00ff, 0xff00000000ffff00,
    0xff00000000ffffff, 0xff000000ff000000, 0xff000000ff0000ff, 0xff000000ff00ff00, 0xff000000ff00ffff,
    0xff000000ffff0000, 0xff000000ffff00ff, 0xff000000ffffff00, 0xff000000ffffffff, 0xff0000ff00000000,
    0xff0000ff000000ff, 0xff0000ff0000ff00, 0xff0000ff0000ffff, 0xff0000ff00ff0000, 0xff0000ff00ff00ff,
    0xff0000ff00ffff00, 0xff0000ff00ffffff, 0xff0000ffff000000, 0xff0000ffff0000ff, 0xff0000ffff00ff00,
    0xff0000ffff00ffff, 0xff0000ffffff0000, 0xff0000ffffff00ff, 0xff0000ffffffff00, 0xff0000ffffffffff,
    0xff00ff0000000000, 0xff00ff00000000ff, 0xff00ff000000ff00, 0xff00ff000000ffff, 0xff00ff0000ff0000,
    0xff00ff0000ff00ff, 0xff00ff0000ffff00, 0xff00ff0000ffffff, 0xff00ff00ff000000, 0xff00ff00ff0000ff,
    0xff00ff00ff00ff00, 0xff00ff00ff00ffff, 0xff00ff00ffff0000, 0xff00ff00ffff00ff, 0xff00ff00ffffff00,
    0xff00ff00ffffffff, 0xff00ffff00000000, 0xff00ffff000000ff, 0xff00ffff0000ff00, 0xff00ffff0000ffff,
    0xff00ffff00ff0000, 0xff00ffff00ff00ff, 0xff00ffff00ffff00, 0xff00ffff00ffffff, 0xff00ffffff000000,
    0xff00ffffff0000ff, 0xff00ffffff00ff00, 0xff00ffffff00ffff, 0xff00ffffffff0000, 0xff00ffffffff00ff,
    0xff00ffffffffff00, 0xff00ffffffffffff, 0xffff000000000000, 0xffff0000000000ff, 0xffff00000000ff00,
    0xffff00000000ffff, 0xffff000000ff0000, 0xffff000000ff00ff, 0xffff000000ffff00, 0xffff000000ffffff,
    0xffff0000ff000000, 0xffff0000ff0000ff, 0xffff0000ff00ff00, 0xffff0000ff00ffff, 0xffff0000ffff0000,
    0xffff0000ffff00ff, 0xffff0000ffffff00, 0xffff0000ffffffff, 0xffff00ff00000000, 0xffff00ff000000ff,
    0xffff00ff0000ff00, 0xffff00ff0000ffff, 0xffff00ff00ff0000, 0xffff00ff00ff00ff, 0xffff00ff00ffff00,
    0xffff00ff00ffffff, 0xffff00ffff000000, 0xffff00ffff0000ff, 0xffff00ffff00ff00, 0xffff00ffff00ffff,
    0xffff00ffffff0000, 0xffff00ffffff00ff, 0xffff00ffffffff00, 0xffff00ffffffffff, 0xffffff0000000000,
    0xffffff00000000ff, 0xffffff000000ff00, 0xffffff000000ffff, 0xffffff0000ff0000, 0xffffff0000ff00ff,
    0xffffff0000ffff00, 0xffffff0000ffffff, 0xffffff00ff000000, 0xffffff00ff0000ff, 0xffffff00ff00ff00,
    0xffffff00ff00ffff, 0xffffff00ffff0000, 0xffffff00ffff00ff, 0xffffff00ffffff00, 0xffffff00ffffffff,
    0xffffffff00000000, 0xffffffff000000ff, 0xffffffff0000ff00, 0xffffffff0000ffff, 0xffffffff00ff0000,
    0xffffffff00ff00ff, 0xffffffff00ffff00, 0xffffffff00ffffff, 0xffffffffff000000, 0xffffffffff0000ff,
    0xffffffffff00ff00, 0xffffffffff00ffff, 0xffffffffffff0000, 0xffffffffffff00ff, 0xffffffffffffff00,
    0xffffffffffffffff,
};
...
void HELPER(sve2_sqrdmlah_b)(void* vd, void* vn, void* vm, void* va, uint32_t desc)
{
    intptr_t i, opr_sz = simd_oprsz(desc);
    int8_t * d = vd, *n = vn, *m = vm, *a = va;

    for (i = 0; i < opr_sz; ++i) { d[i] = do_sqrdmlah_b(n[i], m[i], a[i], false, true); }
}

void HELPER(sve2_sqrdmlsh_b)(void* vd, void* vn, void* vm, void* va, uint32_t desc)
{
    intptr_t i, opr_sz = simd_oprsz(desc);
    int8_t * d = vd, *n = vn, *m = vm, *a = va;

    for (i = 0; i < opr_sz; ++i) { d[i] = do_sqrdmlah_b(n[i], m[i], a[i], true, true); }
}
...
void HELPER(sve2_sqdmulh_b)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz; ++i) { d[i] = do_sqrdmlah_b(n[i], m[i], 0, false, false); }
}
...
void HELPER(sve2_sqrdmulh_b)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz; ++i) { d[i] = do_sqrdmlah_b(n[i], m[i], 0, false, true); }
}

/* Signed saturating rounding doubling multiply-accumulate high half, 16-bit */
int16_t do_sqrdmlah_h(int16_t src1, int16_t src2, int16_t src3, bool neg, bool round, uint32_t* sat)
{
...
uint32_t HELPER(neon_qrdmlah_s16)(CPUARMState* env, uint32_t src1, uint32_t src2, uint32_t src3)
{
    uint32_t* sat = &env->vfp.qc[0];
    uint16_t  e1  = do_sqrdmlah_h(src1, src2, src3, false, true, sat);
    uint16_t  e2  = do_sqrdmlah_h(src1 >> 16, src2 >> 16, src3 >> 16, false, true, sat);
    return deposit32(e1, 16, 16, e2);
}

void HELPER(gvec_qrdmlah_s16)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 2; ++i) { d[i] = do_sqrdmlah_h(n[i], m[i], d[i], false, true, vq); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

uint32_t HELPER(neon_qrdmlsh_s16)(CPUARMState* env, uint32_t src1, uint32_t src2, uint32_t src3)
{
    uint32_t* sat = &env->vfp.qc[0];
    uint16_t  e1  = do_sqrdmlah_h(src1, src2, src3, true, true, sat);
    uint16_t  e2  = do_sqrdmlah_h(src1 >> 16, src2 >> 16, src3 >> 16, true, true, sat);
    return deposit32(e1, 16, 16, e2);
}

void HELPER(gvec_qrdmlsh_s16)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    uintptr_t opr_sz = simd_oprsz(desc);
    int16_t*  d      = vd;
    int16_t*  n      = vn;
    ...
    for (i = 0; i < opr_sz / 2; ++i) { d[i] = do_sqrdmlah_h(n[i], m[i], d[i], true, true, vq); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(neon_sqdmulh_h)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    intptr_t i, opr_sz = simd_oprsz(desc);
    int16_t *d = vd, *n = vn, *m = vm;

    for (i = 0; i < opr_sz / 2; ++i) { d[i] = do_sqrdmlah_h(n[i], m[i], 0, false, false, vq); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(neon_sqrdmulh_h)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    intptr_t i, opr_sz = simd_oprsz(desc);
    int16_t *d = vd, *n = vn, *m = vm;

    for (i = 0; i < opr_sz / 2; ++i) { d[i] = do_sqrdmlah_h(n[i], m[i], 0, false, true, vq); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(neon_sqdmulh_idx_h)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    ...
    for (i = 0; i < elements; i += 16 / 2) {
        int16_t mm = m[i];
        for (j = 0; j < eltspersegment; ++j) { d[i + j] = do_sqrdmlah_h(n[i + j], mm, 0, false, false, vq); }
    }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(neon_sqrdmulh_idx_h)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    intptr_t i, j, opr_sz = simd_oprsz(desc);
    int      idx = simd_data(desc);
    int16_t *d = vd, *n = vn, *m = (int16_t*)vm + H2(idx);
    ...
    for (i = 0; i < elements; i += 16 / 2) {
        int16_t mm = m[i];
        for (j = 0; j < eltspersegment; ++j) { d[i + j] = do_sqrdmlah_h(n[i + j], mm, 0, false, true, vq); }
    }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(neon_sqrdmlah_idx_h)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    intptr_t i, j, opr_sz = simd_oprsz(desc);
    int      idx = simd_data(desc);
    int16_t *d = vd, *n = vn, *m = (int16_t*)vm + H2(idx);
    ...
    for (i = 0; i < elements; i += 16 / 2) {
        int16_t mm = m[i];
        for (j = 0; j < eltspersegment; ++j) { d[i + j] = do_sqrdmlah_h(n[i + j], mm, d[i + j], false, true, vq); }
    }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(neon_sqrdmlsh_idx_h)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    intptr_t i, j, opr_sz = simd_oprsz(desc);
    int      idx = simd_data(desc);
    int16_t *d = vd, *n = vn, *m = (int16_t*)vm + H2(idx);
    ...
    for (i = 0; i < elements; i += 16 / 2) {
        int16_t mm = m[i];
        for (j = 0; j < eltspersegment; ++j) { d[i + j] = do_sqrdmlah_h(n[i + j], mm, d[i + j], true, true, vq); }
    }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(sve2_sqrdmlah_h)(void* vd, void* vn, void* vm, void* va, uint32_t desc)
{
    intptr_t i, opr_sz = simd_oprsz(desc);
    int16_t *d = vd, *n = vn, *m = vm, *a = va;
    uint32_t discard;

    for (i = 0; i < opr_sz / 2; ++i) { d[i] = do_sqrdmlah_h(n[i], m[i], a[i], false, true, &discard); }
}

void HELPER(sve2_sqrdmlsh_h)(void* vd, void* vn, void* vm, void* va, uint32_t desc)
{
    intptr_t i, opr_sz = simd_oprsz(desc);
    int16_t *d = vd, *n = vn, *m = vm, *a = va;
    uint32_t discard;

    for (i = 0; i < opr_sz / 2; ++i) { d[i] = do_sqrdmlah_h(n[i], m[i], a[i], true, true, &discard); }
}
...
void HELPER(sve2_sqdmulh_h)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 2; ++i) { d[i] = do_sqrdmlah_h(n[i], m[i], 0, false, false, &discard); }
}
...
void HELPER(sve2_sqrdmulh_h)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 2; ++i) { d[i] = do_sqrdmlah_h(n[i], m[i], 0, false, true, &discard); }
}
...
void HELPER(sve2_sqdmulh_idx_h)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 2; i += 16 / 2) {
        int16_t mm = m[i];
        for (j = 0; j < 16 / 2; ++j) { d[i + j] = do_sqrdmlah_h(n[i + j], mm, 0, false, false, &discard); }
    }
}
...
void HELPER(sve2_sqrdmulh_idx_h)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 2; i += 16 / 2) {
        int16_t mm = m[i];
        for (j = 0; j < 16 / 2; ++j) { d[i + j] = do_sqrdmlah_h(n[i + j], mm, 0, false, true, &discard); }
    }
}

/* Signed saturating rounding doubling multiply-accumulate high half, 32-bit */
int32_t do_sqrdmlah_s(int32_t src1, int32_t src2, int32_t src3, bool neg, bool round, uint32_t* sat)
{
    /* Simplify similarly to do_sqrdmlah_b above.  */
...
uint32_t HELPER(neon_qrdmlah_s32)(CPUARMState* env, int32_t src1, int32_t src2, int32_t src3)
{
    uint32_t* sat = &env->vfp.qc[0];
    return do_sqrdmlah_s(src1, src2, src3, false, true, sat);
}

void HELPER(gvec_qrdmlah_s32)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    uintptr_t opr_sz = simd_oprsz(desc);
    int32_t*  d      = vd;
    int32_t*  n      = vn;
    ...
    for (i = 0; i < opr_sz / 4; ++i) { d[i] = do_sqrdmlah_s(n[i], m[i], d[i], false, true, vq); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

uint32_t HELPER(neon_qrdmlsh_s32)(CPUARMState* env, int32_t src1, int32_t src2, int32_t src3)
{
    uint32_t* sat = &env->vfp.qc[0];
    return do_sqrdmlah_s(src1, src2, src3, true, true, sat);
}

void HELPER(gvec_qrdmlsh_s32)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    uintptr_t opr_sz = simd_oprsz(desc);
    int32_t*  d      = vd;
    int32_t*  n      = vn;
    ...
    for (i = 0; i < opr_sz / 4; ++i) { d[i] = do_sqrdmlah_s(n[i], m[i], d[i], true, true, vq); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(neon_sqdmulh_s)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    intptr_t i, opr_sz = simd_oprsz(desc);
    int32_t *d = vd, *n = vn, *m = vm;

    for (i = 0; i < opr_sz / 4; ++i) { d[i] = do_sqrdmlah_s(n[i], m[i], 0, false, false, vq); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(neon_sqrdmulh_s)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    intptr_t i, opr_sz = simd_oprsz(desc);
    int32_t *d = vd, *n = vn, *m = vm;

    for (i = 0; i < opr_sz / 4; ++i) { d[i] = do_sqrdmlah_s(n[i], m[i], 0, false, true, vq); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(neon_sqdmulh_idx_s)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    intptr_t i, j, opr_sz = simd_oprsz(desc);
    int      idx = simd_data(desc);
    ...
    for (i = 0; i < elements; i += 16 / 4) {
        int32_t mm = m[i];
        for (j = 0; j < eltspersegment; ++j) { d[i + j] = do_sqrdmlah_s(n[i + j], mm, 0, false, false, vq); }
    }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(neon_sqrdmulh_idx_s)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    intptr_t i, j, opr_sz = simd_oprsz(desc);
    int      idx = simd_data(desc);
    int32_t *d = vd, *n = vn, *m = (int32_t*)vm + H4(idx);
    ...
    for (i = 0; i < elements; i += 16 / 4) {
        int32_t mm = m[i];
        for (j = 0; j < eltspersegment; ++j) { d[i + j] = do_sqrdmlah_s(n[i + j], mm, 0, false, true, vq); }
    }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(neon_sqrdmlah_idx_s)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    intptr_t i, j, opr_sz = simd_oprsz(desc);
    int      idx = simd_data(desc);
    int32_t *d = vd, *n = vn, *m = (int32_t*)vm + H4(idx);
    ...
    for (i = 0; i < elements; i += 16 / 4) {
        int32_t mm = m[i];
        for (j = 0; j < eltspersegment; ++j) { d[i + j] = do_sqrdmlah_s(n[i + j], mm, d[i + j], false, true, vq); }
    }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(neon_sqrdmlsh_idx_s)(void* vd, void* vn, void* vm, void* vq, uint32_t desc)
{
    intptr_t i, j, opr_sz = simd_oprsz(desc);
    int      idx = simd_data(desc);
    int32_t *d = vd, *n = vn, *m = (int32_t*)vm + H4(idx);
    ...
    for (i = 0; i < elements; i += 16 / 4) {
        int32_t mm = m[i];
        for (j = 0; j < eltspersegment; ++j) { d[i + j] = do_sqrdmlah_s(n[i + j], mm, d[i + j], true, true, vq); }
    }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(sve2_sqrdmlah_s)(void* vd, void* vn, void* vm, void* va, uint32_t desc)
{
    intptr_t i, opr_sz = simd_oprsz(desc);
    int32_t *d = vd, *n = vn, *m = vm, *a = va;
    uint32_t discard;

    for (i = 0; i < opr_sz / 4; ++i) { d[i] = do_sqrdmlah_s(n[i], m[i], a[i], false, true, &discard); }
}

void HELPER(sve2_sqrdmlsh_s)(void* vd, void* vn, void* vm, void* va, uint32_t desc)
{
    intptr_t i, opr_sz = simd_oprsz(desc);
    int32_t *d = vd, *n = vn, *m = vm, *a = va;
    uint32_t discard;

    for (i = 0; i < opr_sz / 4; ++i) { d[i] = do_sqrdmlah_s(n[i], m[i], a[i], true, true, &discard); }
}
...
void HELPER(sve2_sqdmulh_s)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 4; ++i) { d[i] = do_sqrdmlah_s(n[i], m[i], 0, false, false, &discard); }
}
...
void HELPER(sve2_sqrdmulh_s)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 4; ++i) { d[i] = do_sqrdmlah_s(n[i], m[i], 0, false, true, &discard); }
}
...
void HELPER(sve2_sqdmulh_idx_s)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 4; i += 16 / 4) {
        int32_t mm = m[i];
        for (j = 0; j < 16 / 4; ++j) { d[i + j] = do_sqrdmlah_s(n[i + j], mm, 0, false, false, &discard); }
    }
}
...
void HELPER(sve2_sqrdmulh_idx_s)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 4; i += 16 / 4) {
        int32_t mm = m[i];
        for (j = 0; j < 16 / 4; ++j) { d[i + j] = do_sqrdmlah_s(n[i + j], mm, 0, false, true, &discard); }
    }
}
...
void HELPER(sve2_sqrdmlah_d)(void* vd, void* vn, void* vm, void* va, uint32_t desc)
{
    intptr_t i, opr_sz = simd_oprsz(desc);
    int64_t *d = vd, *n = vn, *m = vm, *a = va;

    for (i = 0; i < opr_sz / 8; ++i) { d[i] = do_sqrdmlah_d(n[i], m[i], a[i], false, true); }
}

void HELPER(sve2_sqrdmlsh_d)(void* vd, void* vn, void* vm, void* va, uint32_t desc)
{
    intptr_t i, opr_sz = simd_oprsz(desc);
    int64_t *d = vd, *n = vn, *m = vm, *a = va;

    for (i = 0; i < opr_sz / 8; ++i) { d[i] = do_sqrdmlah_d(n[i], m[i], a[i], true, true); }
}
...
void HELPER(sve2_sqdmulh_d)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 8; ++i) { d[i] = do_sqrdmlah_d(n[i], m[i], 0, false, false); }
}
...
void HELPER(sve2_sqrdmulh_d)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 8; ++i) { d[i] = do_sqrdmlah_d(n[i], m[i], 0, false, true); }
}
...
void HELPER(sve2_sqdmulh_idx_d)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 8; i += 16 / 8) {
        int64_t mm = m[i];
        for (j = 0; j < 16 / 8; ++j) { d[i + j] = do_sqrdmlah_d(n[i + j], mm, 0, false, false); }
    }
}
...
void HELPER(sve2_sqrdmulh_idx_d)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 8; i += 16 / 8) {
        int64_t mm = m[i];
        for (j = 0; j < 16 / 8; ++j) { d[i + j] = do_sqrdmlah_d(n[i + j], mm, 0, false, true); }
    }
}
...
#define DO_DOT(NAME, TYPED, TYPEN, TYPEM)                                                          \
    ...
    {                                                                                              \
        ...
        for (i = 0; i < opr_sz / sizeof(TYPED); ++i) {                                             \
            d[i] = (a[i] + (TYPED)n[i * 4 + 0] * m[i * 4 + 0] + (TYPED)n[i * 4 + 1] * m[i * 4 + 1] \
                    + (TYPED)n[i * 4 + 2] * m[i * 4 + 2] + (TYPED)n[i * 4 + 3] * m[i * 4 + 3]);    \
        }                                                                                          \
        clear_tail(d, opr_sz, simd_maxsz(desc));                                                   \
    }
...
#define DO_DOT_IDX(NAME, TYPED, TYPEN, TYPEM, HD)                                                              \
    ...
    {                                                                                                          \
        ...
        do {                                                                                                   \
            ...
            do {                                                                                               \
                d[i] = (a[i] + n[i * 4 + 0] * m0 + n[i * 4 + 1] * m1 + n[i * 4 + 2] * m2 + n[i * 4 + 3] * m3); \
            }                                                                                                  \
            while (++i < segend);                                                                              \
...
#define DO_DOT(NAME, TYPED, TYPEN, TYPEM)                                                            \
    ...
    {                                                                                                \
        ...
        TYPEM*   m = vm;                                                                             \
        for (i = 0; i < opr_sz / sizeof(TYPED); ++i) {                                               \
            d[i] = (a[i] + (TYPED)n[i * 2 + 0] * m[i * 2 + 0] + (TYPED)n[i * 2 + 1] * m[i * 2 + 1]); \
        }                                                                                            \
        clear_tail(d, opr_sz, simd_maxsz(desc));                                                     \
    }
...
void HELPER(gvec_fcaddh)(void* vd, void* vn, void* vm, float_status* fpst, uint32_t desc)
{
    uintptr_t opr_sz  = simd_oprsz(desc);
    float16*  d       = vd;
    float16*  n       = vn;
...
void HELPER(gvec_fcadds)(void* vd, void* vn, void* vm, float_status* fpst, uint32_t desc)
{
    uintptr_t opr_sz  = simd_oprsz(desc);
    float32*  d       = vd;
    float32*  n       = vn;
...
void HELPER(gvec_fcaddd)(void* vd, void* vn, void* vm, float_status* fpst, uint32_t desc)
{
    uintptr_t opr_sz  = simd_oprsz(desc);
    float64*  d       = vd;
    float64*  n       = vn;
...
void HELPER(gvec_fcmlah)(void* vd, void* vn, void* vm, void* va, float_status* fpst, uint32_t desc)
{
    uintptr_t opr_sz = simd_oprsz(desc);
...
void HELPER(gvec_fcmlah_idx)(void* vd, void* vn, void* vm, void* va, float_status* fpst, uint32_t desc)
{
    uintptr_t opr_sz = simd_oprsz(desc);
    float16 * d = vd, *n = vn, *m = vm, *a = va;
    intptr_t  flip           = extract32(desc, SIMD_DATA_SHIFT, 1);
...
void HELPER(gvec_fcmlas)(void* vd, void* vn, void* vm, void* va, float_status* fpst, uint32_t desc)
{
    uintptr_t opr_sz = simd_oprsz(desc);
...
void HELPER(gvec_fcmlas_idx)(void* vd, void* vn, void* vm, void* va, float_status* fpst, uint32_t desc)
{
    uintptr_t opr_sz = simd_oprsz(desc);
    float32 * d = vd, *n = vn, *m = vm, *a = va;
    intptr_t  flip           = extract32(desc, SIMD_DATA_SHIFT, 1);
...
void HELPER(gvec_fcmlad)(void* vd, void* vn, void* vm, void* va, float_status* fpst, uint32_t desc)
{
    uintptr_t opr_sz = simd_oprsz(desc);
 ...
 */
static uint16_t float16_ceq(float16 op1, float16 op2, float_status* stat) { return -float16_eq_quiet(op1, op2, stat); }

static uint32_t float32_ceq(float32 op1, float32 op2, float_status* stat) { return -float32_eq_quiet(op1, op2, stat); }

static uint64_t float64_ceq(float64 op1, float64 op2, float_status* stat) { return -float64_eq_quiet(op1, op2, stat); }

static uint16_t float16_cge(float16 op1, float16 op2, float_status* stat) { return -float16_le(op2, op1, stat); }

static uint32_t float32_cge(float32 op1, float32 op2, float_status* stat) { return -float32_le(op2, op1, stat); }

static uint64_t float64_cge(float64 op1, float64 op2, float_status* stat) { return -float64_le(op2, op1, stat); }

static uint16_t float16_cgt(float16 op1, float16 op2, float_status* stat) { return -float16_lt(op2, op1, stat); }

static uint32_t float32_cgt(float32 op1, float32 op2, float_status* stat) { return -float32_lt(op2, op1, stat); }

static uint64_t float64_cgt(float64 op1, float64 op2, float_status* stat) { return -float64_lt(op2, op1, stat); }
...
#define DO_2OP(NAME, FUNC, TYPE)                                                \
    ...
    {                                                                           \
        ...
        TYPE *   d = vd, *n = vn;                                               \
        for (i = 0; i < oprsz / sizeof(TYPE); i++) { d[i] = FUNC(n[i], stat); } \
...
#define WRAP_CMP0_FWD(FN, CMPOP, TYPE)                                                                         \
    static TYPE TYPE##_##FN##0(TYPE op, float_status * stat) { return TYPE##_##CMPOP(op, TYPE##_zero, stat); }

#define WRAP_CMP0_REV(FN, CMPOP, TYPE)                                                                         \
    static TYPE TYPE##_##FN##0(TYPE op, float_status * stat) { return TYPE##_##CMPOP(TYPE##_zero, op, stat); }

#define DO_2OP_CMP0(FN, CMPOP, DIRN)                                                                               \
    WRAP_CMP0_##DIRN(FN, CMPOP, float16) WRAP_CMP0_##DIRN(FN, CMPOP, float32) WRAP_CMP0_##DIRN(FN, CMPOP, float64) \
        DO_2OP(gvec_f##FN##0_h, float16_##FN##0, float16) DO_2OP(gvec_f##FN##0_s, float32_##FN##0, float32)        \
...
static float16 float16_ftsmul(float16 op1, uint16_t op2, float_status* stat)
{
    ...
    if (!float16_is_any_nan(result)) { result = float16_set_sign(result, op2 & 1); }
    return result;
}
...
static float32 float32_ftsmul(float32 op1, uint32_t op2, float_status* stat)
{
    ...
    if (!float32_is_any_nan(result)) { result = float32_set_sign(result, op2 & 1); }
    return result;
}
...
static float64 float64_ftsmul(float64 op1, uint64_t op2, float_status* stat)
{
    ...
    if (!float64_is_any_nan(result)) { result = float64_set_sign(result, op2 & 1); }
    return result;
}
...
static float16 float16_recps_nf(float16 op1, float16 op2, float_status* stat)
{
    ...
    if ((float16_is_infinity(op1) && float16_is_zero(op2)) || (float16_is_infinity(op2) && float16_is_zero(op1))) {
        return float16_two;
    }
...
static float32 float32_recps_nf(float32 op1, float32 op2, float_status* stat)
{
    ...
    if ((float32_is_infinity(op1) && float32_is_zero(op2)) || (float32_is_infinity(op2) && float32_is_zero(op1))) {
        return float32_two;
    }
...
#define DO_3OP(NAME, FUNC, TYPE)                                                       \
    void HELPER(NAME)(void* vd, void* vn, void* vm, float_status* stat, uint32_t desc) \
    {                                                                                  \
        intptr_t i, oprsz = simd_oprsz(desc);                                          \
        TYPE *   d = vd, *n = vn, *m = vm;                                             \
        for (i = 0; i < oprsz / sizeof(TYPE); i++) { d[i] = FUNC(n[i], m[i], stat); }  \
        clear_tail(d, oprsz, simd_maxsz(desc));                                        \
    }
...
static float16 float16_muladd_nf(float16 dest, float16 op1, float16 op2, float_status* stat)
{ return float16_add(dest, float16_mul(op1, op2, stat), stat); }

static float32 float32_muladd_nf(float32 dest, float32 op1, float32 op2, float_status* stat)
{ return float32_add(dest, float32_mul(op1, op2, stat), stat); }

static float16 float16_mulsub_nf(float16 dest, float16 op1, float16 op2, float_status* stat)
{ return float16_sub(dest, float16_mul(op1, op2, stat), stat); }

static float32 float32_mulsub_nf(float32 dest, float32 op1, float32 op2, float_status* stat)
{ return float32_sub(dest, float32_mul(op1, op2, stat), stat); }

/* Fused versions; these have the semantics Neon VFMA/VFMS want */
static float16 float16_muladd_f(float16 dest, float16 op1, float16 op2, float_status* stat)
{ return float16_muladd(op1, op2, dest, 0, stat); }

static bfloat16 bfloat16_muladd_f(bfloat16 dest, bfloat16 op1, bfloat16 op2, float_status* stat)
{ return bfloat16_muladd(op1, op2, dest, 0, stat); }

static float32 float32_muladd_f(float32 dest, float32 op1, float32 op2, float_status* stat)
{ return float32_muladd(op1, op2, dest, 0, stat); }

static float64 float64_muladd_f(float64 dest, float64 op1, float64 op2, float_status* stat)
{ return float64_muladd(op1, op2, dest, 0, stat); }

static float16 float16_mulsub_f(float16 dest, float16 op1, float16 op2, float_status* stat)
{ return float16_muladd(float16_chs(op1), op2, dest, 0, stat); }

static bfloat16 bfloat16_mulsub_f(bfloat16 dest, bfloat16 op1, bfloat16 op2, float_status* stat)
{ return bfloat16_muladd(bfloat16_chs(op1), op2, dest, 0, stat); }

static float32 float32_mulsub_f(float32 dest, float32 op1, float32 op2, float_status* stat)
{ return float32_muladd(float32_chs(op1), op2, dest, 0, stat); }

static float64 float64_mulsub_f(float64 dest, float64 op1, float64 op2, float_status* stat)
{ return float64_muladd(float64_chs(op1), op2, dest, 0, stat); }

static float16 float16_ah_mulsub_f(float16 dest, float16 op1, float16 op2, float_status* stat)
{ return float16_muladd(op1, op2, dest, float_muladd_negate_product, stat); }

static bfloat16 bfloat16_ah_mulsub_f(bfloat16 dest, bfloat16 op1, bfloat16 op2, float_status* stat)
{ return bfloat16_muladd(op1, op2, dest, float_muladd_negate_product, stat); }

static float32 float32_ah_mulsub_f(float32 dest, float32 op1, float32 op2, float_status* stat)
{ return float32_muladd(op1, op2, dest, float_muladd_negate_product, stat); }

static float64 float64_ah_mulsub_f(float64 dest, float64 op1, float64 op2, float_status* stat)
...
#define DO_MULADD(NAME, FUNC, TYPE)                                                         \
    ...
    {                                                                                       \
        intptr_t i, oprsz = simd_oprsz(desc);                                               \
        TYPE *   d = vd, *n = vn, *m = vm;                                                  \
        for (i = 0; i < oprsz / sizeof(TYPE); i++) { d[i] = FUNC(d[i], n[i], m[i], stat); } \
        clear_tail(d, oprsz, simd_maxsz(desc));                                             \
    }
...
#define DO_MUL_IDX(NAME, TYPE, H)                                       \
    ...
    {                                                                   \
        ...
        for (i = 0; i < oprsz / sizeof(TYPE); i += segment) {           \
            TYPE mm = m[H(i + idx)];                                    \
            for (j = 0; j < segment; j++) { d[i + j] = n[i + j] * mm; } \
        }                                                               \
        clear_tail(d, oprsz, simd_maxsz(desc));                         \
    }
...
#define DO_MLA_IDX(NAME, TYPE, OP, H)                                               \
    ...
    {                                                                               \
        ...
        for (i = 0; i < oprsz / sizeof(TYPE); i += segment) {                       \
            TYPE mm = m[H(i + idx)];                                                \
            for (j = 0; j < segment; j++) { d[i + j] = a[i + j] OP n[i + j] * mm; } \
        }                                                                           \
        clear_tail(d, oprsz, simd_maxsz(desc));                                     \
    }
...
#define DO_FMUL_IDX(NAME, ADD, MUL, TYPE, H)                                                           \
    ...
    {                                                                                                  \
        ...
        for (i = 0; i < oprsz / sizeof(TYPE); i += segment) {                                          \
            TYPE mm = m[H(i + idx)];                                                                   \
            for (j = 0; j < segment; j++) { d[i + j] = ADD(d[i + j], MUL(n[i + j], mm, stat), stat); } \
        }                                                                                              \
        clear_tail(d, oprsz, simd_maxsz(desc));                                                        \
    }
...
#define DO_FMLA_IDX(NAME, TYPE, H, NEGX, NEGF)                                                                     \
    void HELPER(NAME)(void* vd, void* vn, void* vm, void* va, float_status* stat, uint32_t desc)                   \
    {                                                                                                              \
        intptr_t i, j, oprsz = simd_oprsz(desc);                                                                   \
        intptr_t segment = MIN(16, oprsz) / sizeof(TYPE);                                                          \
        intptr_t idx     = simd_data(desc);                                                                        \
        ...
        for (i = 0; i < oprsz / sizeof(TYPE); i += segment) {                                                      \
            TYPE mm = m[H(i + idx)];                                                                               \
            for (j = 0; j < segment; j++) { d[i + j] = TYPE##_muladd(n[i + j] ^ NEGX, mm, a[i + j], NEGF, stat); } \
        }                                                                                                          \
        clear_tail(d, oprsz, simd_maxsz(desc));                                                                    \
    }
...
void HELPER(gvec_uqadd_d)(void* vd, void* vq, void* vn, void* vm, uint32_t desc)
{
    intptr_t  i, oprsz = simd_oprsz(desc);
...
void HELPER(gvec_uqsub_d)(void* vd, void* vq, void* vn, void* vm, uint32_t desc)
{
    intptr_t  i, oprsz = simd_oprsz(desc);
    uint64_t *d = vd, *n = vn, *m = vm;
    bool      q = false;
...
void HELPER(gvec_sqadd_d)(void* vd, void* vq, void* vn, void* vm, uint32_t desc)
{
    intptr_t i, oprsz = simd_oprsz(desc);
    int64_t *d = vd, *n = vn, *m = vm;
    bool     q = false;
...
void HELPER(gvec_sqsub_d)(void* vd, void* vq, void* vn, void* vm, uint32_t desc)
{
    intptr_t i, oprsz = simd_oprsz(desc);
    int64_t *d = vd, *n = vn, *m = vm;
    bool     q = false;
...
void HELPER(gvec_usqadd_d)(void* vd, void* vq, void* vn, void* vm, uint32_t desc)
{
    intptr_t  i, oprsz = simd_oprsz(desc);
    uint64_t *d = vd, *n = vn, *m = vm;
    bool      q = false;
...
void HELPER(gvec_suqadd_d)(void* vd, void* vq, void* vn, void* vm, uint32_t desc)
{
    intptr_t  i, oprsz = simd_oprsz(desc);
    uint64_t *d = vd, *n = vn, *m = vm;
    bool      q = false;
...
#define DO_SRA(NAME, TYPE)                                                    \
    ...
    {                                                                         \
        ...
        TYPE *   d = vd, *n = vn;                                             \
        for (i = 0; i < oprsz / sizeof(TYPE); i++) { d[i] += n[i] >> shift; } \
        clear_tail(d, oprsz, simd_maxsz(desc));                               \
    }
...
#define DO_SLI(NAME, TYPE)                                                                                            \
    ...
    {                                                                                                                 \
        ...
        int      shift = simd_data(desc);                                                                             \
        TYPE *   d = vd, *n = vn;                                                                                     \
        for (i = 0; i < oprsz / sizeof(TYPE); i++) { d[i] = deposit64(d[i], shift, sizeof(TYPE) * 8 - shift, n[i]); } \
        clear_tail(d, oprsz, simd_maxsz(desc));                                                                       \
    }
...
static void do_fmlal(float32* d, void* vn, void* vm, CPUARMState* env, uint32_t desc, ARMFPStatusFlavour fpst_idx,
...
void HELPER(gvec_fmlal_a32)(void* vd, void* vn, void* vm, CPUARMState* env, uint32_t desc)
{
...
void HELPER(gvec_fmlal_a64)(void* vd, void* vn, void* vm, CPUARMState* env, uint32_t desc)
{
    bool     is_s = extract32(desc, SIMD_DATA_SHIFT, 1);
    uint64_t negx = 0;
    int      negf = 0;
    ...
    if (is_s) {
        if (env->vfp.fpcr & FPCR_AH) { negf = float_muladd_negate_product; }
        else {
...
void HELPER(sve2_fmlal_zzzw_s)(void* vd, void* vn, void* vm, void* va, CPUARMState* env, uint32_t desc)
{
    intptr_t      i, oprsz = simd_oprsz(desc);
    bool          is_s   = extract32(desc, SIMD_DATA_SHIFT, 1);
...
static void do_fmlal_idx(float32* d, void* vn, void* vm, CPUARMState* env, uint32_t desc, ARMFPStatusFlavour fpst_idx,
                         uint64_t negx, int negf)
{
    float_status* fpst = &env->vfp.fp_status[fpst_idx];
    bool          fz16 = env->vfp.fpcr & FPCR_FZ16;
...
void HELPER(gvec_fmlal_idx_a32)(void* vd, void* vn, void* vm, CPUARMState* env, uint32_t desc)
{
    bool     is_s = extract32(desc, SIMD_DATA_SHIFT, 1);
    uint64_t negx = is_s ? 0x8000800080008000ull : 0;
...
void HELPER(gvec_fmlal_idx_a64)(void* vd, void* vn, void* vm, CPUARMState* env, uint32_t desc)
{
    bool     is_s = extract32(desc, SIMD_DATA_SHIFT, 1);
    uint64_t negx = 0;
    int      negf = 0;
...
void HELPER(sve2_fmlal_zzxw_s)(void* vd, void* vn, void* vm, void* va, CPUARMState* env, uint32_t desc)
{
    intptr_t      i, j, oprsz = simd_oprsz(desc);
    bool          is_s   = extract32(desc, SIMD_DATA_SHIFT, 1);
    intptr_t      sel    = extract32(desc, SIMD_DATA_SHIFT + 1, 1) * sizeof(float16);
    ...
    for (i = 0; i < oprsz; i += 16) {
        ...
        for (j = 0; j < 16; j += sizeof(float32)) {
            ...
            *(float32*)(vd + H1_4(i + j)) = float32_muladd(nn, mm, aa, negf, status);
        }
    }
}
...
void HELPER(gvec_pmul_b)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 8; ++i) { d[i] = clmul_8x8_low(n[i], m[i]); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}
...
void HELPER(sve2_pmull_h)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 8; ++i) { d[i] = clmul_8x4_even(n[i] >> shift, m[i] >> shift); }
}
...
void HELPER(sve2_pmull_d)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 8; ++i) { d[i] = clmul_32(n[2 * i + sel], m[2 * i + sel]); }
}
#endif
...
#define DO_ABD(NAME, TYPE)                                                                              \
    ...
    {                                                                                                   \
        ...
        TYPE *   d = vd, *n = vn, *m = vm;                                                              \
                                                                                                        \
        for (i = 0; i < opr_sz / sizeof(TYPE); ++i) { d[i] = n[i] < m[i] ? m[i] - n[i] : n[i] - m[i]; } \
        clear_tail(d, opr_sz, simd_maxsz(desc));                                                        \
    }
...
#define DO_3OP_PAIR(NAME, FUNC, TYPE, H)                                                                   \
    ...
    {                                                                                                      \
        ...
        TYPE *       d = vd, *n = vn, *m = vm;                                                             \
        if (unlikely(d == m)) { m = memcpy(&scratch, m, oprsz); }                                          \
        for (intptr_t i = 0; i < half; ++i) { d[H(i)] = FUNC(n[H(i * 2)], n[H(i * 2 + 1)], stat); }        \
        for (intptr_t i = 0; i < half; ++i) { d[H(i + half)] = FUNC(m[H(i * 2)], m[H(i * 2 + 1)], stat); } \
        clear_tail(d, oprsz, simd_maxsz(desc));                                                            \
    }
...
#define DO_3OP_PAIR(NAME, FUNC, TYPE, H)                                                             \
    ...
    {                                                                                                \
        ...
        TYPE *       d = vd, *n = vn, *m = vm;                                                       \
        if (unlikely(d == m)) { m = memcpy(&scratch, m, oprsz); }                                    \
        for (intptr_t i = 0; i < half; ++i) { d[H(i)] = FUNC(n[H(i * 2)], n[H(i * 2 + 1)]); }        \
        for (intptr_t i = 0; i < half; ++i) { d[H(i + half)] = FUNC(m[H(i * 2)], m[H(i * 2 + 1)]); } \
        clear_tail(d, oprsz, simd_maxsz(desc));                                                      \
    }
...
#define DO_VCVT_FIXED(NAME, FUNC, TYPE)                                                \
    ...
    {                                                                                  \
        ...
        for (i = 0; i < oprsz / sizeof(TYPE); i++) { d[i] = FUNC(n[i], shift, fpst); } \
        clear_tail(d, oprsz, simd_maxsz(desc));                                        \
    }
...
#define DO_VCVT_RMODE(NAME, FUNC, TYPE)                                            \
    ...
    {                                                                              \
        ...
        for (i = 0; i < oprsz / sizeof(TYPE); i++) { d[i] = FUNC(n[i], 0, fpst); } \
...
#define DO_VRINT_RMODE(NAME, FUNC, TYPE)                                        \
    ...
    {                                                                           \
        ...
        TYPE *   d = vd, *n = vn;                                               \
        set_float_rounding_mode(rmode, fpst);                                   \
        for (i = 0; i < oprsz / sizeof(TYPE); i++) { d[i] = FUNC(n[i], fpst); } \
        set_float_rounding_mode(prev_rmode, fpst);                              \
        clear_tail(d, oprsz, simd_maxsz(desc));                                 \
    }
...
void HELPER(simd_tblx)(void* vd, void* vm, CPUARMState* env, uint32_t desc)
{
    ...
    for (size_t i = 0; i < oprsz; ++i) {
        ...
        if (index < table_len) {
             ...
             */
            const uint8_t* table = (const uint8_t*)aa64_vfp_qreg(env, (rn + (index >> 4)) % 32);
...
void HELPER(gvec_smulh_b)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz; ++i) { d[i] = ((int32_t)n[i] * m[i]) >> 8; }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}
...
void HELPER(gvec_smulh_h)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 2; ++i) { d[i] = ((int32_t)n[i] * m[i]) >> 16; }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}
...
void HELPER(gvec_smulh_s)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 4; ++i) { d[i] = ((int64_t)n[i] * m[i]) >> 32; }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}
...
void HELPER(gvec_smulh_d)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 8; ++i) { muls64(&discard, &d[i], n[i], m[i]); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}
...
void HELPER(gvec_umulh_b)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz; ++i) { d[i] = ((uint32_t)n[i] * m[i]) >> 8; }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}
...
void HELPER(gvec_umulh_h)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 2; ++i) { d[i] = ((uint32_t)n[i] * m[i]) >> 16; }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}
...
void HELPER(gvec_umulh_s)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 4; ++i) { d[i] = ((uint64_t)n[i] * m[i]) >> 32; }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}
...
void HELPER(gvec_umulh_d)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 8; ++i) { mulu64(&discard, &d[i], n[i], m[i]); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}
...
void HELPER(gvec_xar_d)(void* vd, void* vn, void* vm, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz; ++i) { d[i] = ror64(n[i] ^ m[i], shr); }
...
static uint32_t do_smmla_b(uint32_t sum, void* vn, void* vm)
{
    ...
    for (intptr_t k = 0; k < 8; ++k) { sum += n[H1(k)] * m[H1(k)]; }
    return sum;
}
...
#define DO_MMLA_B(NAME, INNER) \
    void HELPER(NAME)(void* vd, void* vn, void* vm, void* va, uint32_t desc) { do_mmla_b(vd, vn, vm, va, desc, INNER); }
...
float32 bfdotadd_ebf(float32 sum, uint32_t e1, uint32_t e2, float_status* fpst, float_status* fpst_odd)
{
    ...
    /* C.f. FPProcessNaNs4 */
    if (float32_is_any_nan(s1r) || float32_is_any_nan(s1c) || float32_is_any_nan(s2r) || float32_is_any_nan(s2c)) {
        if (float32_is_signaling_nan(s1r, fpst)) { t32 = s1r; }
...
void HELPER(gvec_bfdot)(void* vd, void* vn, void* vm, void* va, CPUARMState* env, uint32_t desc)
{
    intptr_t     i, opr_sz = simd_oprsz(desc);
    float32 *    d = vd, *a = va;
    uint32_t *   n = vn, *m = vm;
    ...
    if (is_ebf(env, &fpst, &fpst_odd)) {
        for (i = 0; i < opr_sz / 4; ++i) { d[i] = bfdotadd_ebf(a[i], n[i], m[i], &fpst, &fpst_odd); }
    }
    else {
        for (i = 0; i < opr_sz / 4; ++i) { d[i] = bfdotadd(a[i], n[i], m[i], &fpst); }
    }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(gvec_bfdot_idx)(void* vd, void* vn, void* vm, void* va, CPUARMState* env, uint32_t desc)
{
    intptr_t     i, j, opr_sz = simd_oprsz(desc);
    intptr_t     index          = simd_data(desc);
    intptr_t     elements       = opr_sz / 4;
    ...
    if (is_ebf(env, &fpst, &fpst_odd)) {
        for (i = 0; i < elements; i += eltspersegment) {
            ...
            for (j = i; j < i + eltspersegment; j++) { d[j] = bfdotadd_ebf(a[j], n[j], m_idx, &fpst, &fpst_odd); }
        }
    }
    else {
        for (i = 0; i < elements; i += eltspersegment) {
            ...
            for (j = i; j < i + eltspersegment; j++) { d[j] = bfdotadd(a[j], n[j], m_idx, &fpst); }
        }
    }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

void HELPER(sme2_bfvdot_idx)(void* vd, void* vn, void* vm, void* va, CPUARMState* env, uint32_t desc)
{
    intptr_t     i, j, opr_sz = simd_oprsz(desc);
    ...
    if (is_ebf(env, &fpst, &fpst_odd)) {
        for (i = 0; i < elements; i += eltspersegment) {
            ...
            for (j = 0; j < eltspersegment; j++) {
                uint32_t nn  = (n0[H2(2 * (i + j) + sel)]) | (n1[H2(2 * (i + j) + sel)] << 16);
                d[i + H4(j)] = bfdotadd_ebf(a[i + H4(j)], nn, m_idx, &fpst, &fpst_odd);
            }
        }
    }
    else {
...
void HELPER(gvec_bfmmla)(void* vd, void* vn, void* vm, void* va, CPUARMState* env, uint32_t desc)
{
...
static void do_bfmlal(float32* d, bfloat16* n, bfloat16* m, float32* a, float_status* stat, uint32_t desc, int negx,
                      int negf)
{
    intptr_t i, opr_sz = simd_oprsz(desc);
...
void HELPER(gvec_bfmlal)(void* vd, void* vn, void* vm, void* va, float_status* stat, uint32_t desc)
{ do_bfmlal(vd, vn, vm, va, stat, desc, 0, 0); }

void HELPER(gvec_bfmlsl)(void* vd, void* vn, void* vm, void* va, float_status* stat, uint32_t desc)
{ do_bfmlal(vd, vn, vm, va, stat, desc, 0x8000, 0); }

void HELPER(gvec_ah_bfmlsl)(void* vd, void* vn, void* vm, void* va, float_status* stat, uint32_t desc)
{ do_bfmlal(vd, vn, vm, va, stat, desc, 0, float_muladd_negate_product); }

static void do_bfmlal_idx(float32* d, bfloat16* n, bfloat16* m, float32* a, float_status* stat, uint32_t desc, int negx,
                          int negf)
{
    intptr_t i, j, opr_sz = simd_oprsz(desc);
    intptr_t sel            = extract32(desc, SIMD_DATA_SHIFT, 1);
...
void HELPER(gvec_bfmlal_idx)(void* vd, void* vn, void* vm, void* va, float_status* stat, uint32_t desc)
{ do_bfmlal_idx(vd, vn, vm, va, stat, desc, 0, 0); }

void HELPER(gvec_bfmlsl_idx)(void* vd, void* vn, void* vm, void* va, float_status* stat, uint32_t desc)
{ do_bfmlal_idx(vd, vn, vm, va, stat, desc, 0x8000, 0); }

void HELPER(gvec_ah_bfmlsl_idx)(void* vd, void* vn, void* vm, void* va, float_status* stat, uint32_t desc)
...
void HELPER(gvec_cnt_b)(void* vd, void* vn, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz; ++i) { d[i] = ctpop8(n[i]); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}
...
void HELPER(gvec_rbit_b)(void* vd, void* vn, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 8; ++i) { d[i] = revbit64(bswap64(n[i])); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}
...
void HELPER(gvec_urecpe_s)(void* vd, void* vn, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 4; ++i) { d[i] = helper_recpe_u32(n[i]); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}
...
void HELPER(gvec_ursqrte_s)(void* vd, void* vn, uint32_t desc)
{
    ...
    for (i = 0; i < opr_sz / 4; ++i) { d[i] = helper_rsqrte_u32(n[i]); }
    clear_tail(d, opr_sz, simd_maxsz(desc));
}

static inline void do_lut_b(void* zd, uint64_t* indexes, uint64_t* table, unsigned elements, unsigned segbase,
                            unsigned dstride, unsigned isize, unsigned tsize, unsigned nreg)
{
...
static inline void do_lut_h(void* zd, uint64_t* indexes, uint64_t* table, unsigned elements, unsigned segbase,
                            unsigned dstride, unsigned isize, unsigned tsize, unsigned nreg)
{
    for (unsigned r = 0; r < nreg; ++r) {
...
static inline void do_lut_s(void* zd, uint64_t* indexes, uint32_t* table, unsigned elements, unsigned segbase,
                            unsigned dstride, unsigned isize, unsigned tsize, unsigned nreg)
{
    for (unsigned r = 0; r < nreg; ++r) {
...
#define DO_SME2_LUT(ISIZE, NREG, SUFF, ESIZE)                                                        \
    void helper_sme2_luti##ISIZE##_##NREG##SUFF(void* zd, void* zn, CPUARMState* env, uint32_t desc) \
    {                                                                                                \
        ...
        do_lut_##SUFF(zd, indexes.d, (void*)env->za_state.zt0, elements, segment * NREG * elements,  \
