...
{
    if (arm_current_el(env) == 1 && (arm_hcr_el2_eff(env) & HCR_TTLB)) { return CP_ACCESS_TRAP_EL2; }
    return CP_ACCESS_OK;
}

/* Check for traps from EL1 due to HCR_EL2.TTLB or TTLBIS. */
static CPAccessResult access_ttlbis(CPUARMState* env, const ARMCPRegInfo* ri, bool isread)
{
    if (arm_current_el(env) == 1 && (arm_hcr_el2_eff(env) & (HCR_TTLB | HCR_TTLBIS))) { return CP_ACCESS_TRAP_EL2; }
    return CP_ACCESS_OK;
}

/* Check for traps from EL1 due to HCR_EL2.TTLB or TTLBOS. */
static CPAccessResult access_ttlbos(CPUARMState* env, const ARMCPRegInfo* ri, bool isread)
{
    if (arm_current_el(env) == 1 && (arm_hcr_el2_eff(env) & (HCR_TTLB | HCR_TTLBOS))) { return CP_ACCESS_TRAP_EL2; }
    return CP_ACCESS_OK;
}

/* IS variants of TLB operations must affect all cores */
static void tlbiall_is_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
...
static void tlbiasid_is_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs = env_cpu(env);
...
static void tlbimva_is_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs = env_cpu(env);
...
static void tlbimvaa_is_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs = env_cpu(env);
...
static void tlbiall_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    /* Invalidate all (TLBIALL) */
    CPUState* cs = env_cpu(env);

    if (tlb_force_broadcast(env)) { tlb_flush_all_cpus_synced(cs); }
    else {
        tlb_flush(cs);
    }
}

static void tlbimva_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    /* Invalidate single TLB entry by MVA and ASID (TLBIMVA) */
    CPUState* cs = env_cpu(env);

    value &= TARGET_PAGE_MASK;
    if (tlb_force_broadcast(env)) { tlb_flush_page_all_cpus_synced(cs, value); }
    else {
        tlb_flush_page(cs, value);
    }
}

static void tlbiasid_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
...
static void tlbimvaa_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
...
static void tlbimva_hyp_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs       = env_cpu(env);
...
static void tlbiall_nsnh_is_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs = env_cpu(env);
...
static void tlbiall_hyp_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs = env_cpu(env);
...
static void tlbiall_hyp_is_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs = env_cpu(env);

    tlb_flush_by_mmuidx_all_cpus_synced(cs, ARMMMUIdxBit_E2 | ARMMMUIdxBit_GE2);
}
...
static int tlbbits_for_regime(CPUARMState* env, ARMMMUIdx mmu_idx, uint64_t addr)
{
...
static int vae1_tlbbits(CPUARMState* env, uint64_t addr)
{
    ...
    if ((hcr & (HCR_E2H | HCR_TGE)) == (HCR_E2H | HCR_TGE)) { mmu_idx = ARMMMUIdx_E20_0; }
    else {
...
static int vae2_tlbbits(CPUARMState* env, uint64_t addr)
{
     ...
     * only has one.
     */
    if (hcr & HCR_E2H) { mmu_idx = guarded ? ARMMMUIdx_GE20_2 : ARMMMUIdx_E20_2; }
    else {
...
static void tlbi_aa64_vmalle1is_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs   = env_cpu(env);
...
static void tlbi_aa64_vmalle1_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    ...
    if (tlb_force_broadcast(env)) { tlb_flush_by_mmuidx_all_cpus_synced(cs, mask); }
    else {
...
{
    return (ARMMMUIdxBit_E20_0 | ARMMMUIdxBit_E20_2 | ARMMMUIdxBit_E20_2_PAN | ARMMMUIdxBit_E2 | ARMMMUIdxBit_GE20_2
            | ARMMMUIdxBit_GE20_2_PAN | ARMMMUIdxBit_GE2);
}

static void tlbi_aa64_alle1_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs   = env_cpu(env);
...
static void tlbi_aa64_alle2_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs   = env_cpu(env);
...
static void tlbi_aa64_alle3_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
...
static void tlbi_aa64_alle1is_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs   = env_cpu(env);
    int       mask = alle1_tlbmask(env);
...
static void tlbi_aa64_alle2is_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs   = env_cpu(env);
    int       mask = e2_tlbmask(env);
...
static void tlbi_aa64_alle3is_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs = env_cpu(env);
...
static void tlbi_aa64_vae3_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    /*
...
static int ipas2e1_tlbmask(CPUARMState* env, int64_t value)
{
     ...
     */
    return (value >= 0 && cpu_isar_feature(aa64_sel2, env_archcpu(env)) && arm_is_secure_below_el3(env) ?
                ARMMMUIdxBit_Stage2_S :
                ARMMMUIdxBit_Stage2);
}

static void tlbi_aa64_ipas2e1_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs       = env_cpu(env);
...
static TLBIRange tlbi_aa64_get_range(CPUARMState* env, ARMMMUIdx mmuidx, uint64_t value)
{
    ...
    if (param.select) { ret.base = sextract64(value, 0, 37); }
    else {
...
static void do_rvae_write(CPUARMState* env, uint64_t value, int idxmap, bool synced)
{
    ...
    if (synced) { tlb_flush_range_by_mmuidx_all_cpus_synced(env_cpu(env), range.base, range.length, idxmap, bits); }
    else {
        tlb_flush_range_by_mmuidx(env_cpu(env), range.base, range.length, idxmap, bits);
    }
}

static void tlbi_aa64_rvae1_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    /*
    ...
    do_rvae_write(env, value, vae1_tlbmask(env), tlb_force_broadcast(env));
}

static void tlbi_aa64_rvae1is_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    /*
...
static void tlbi_aa64_rvae2_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    /*
    ...
    do_rvae_write(env, value, vae2_tlbmask(env), tlb_force_broadcast(env));
}

static void tlbi_aa64_rvae2is_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    /*
...
static void tlbi_aa64_rvae3_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    /*
...
{ do_rvae_write(env, value, ipas2e1_tlbmask(env, value), tlb_force_broadcast(env)); }

static void tlbi_aa64_ripas2e1is_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
...
static const ARMCPRegInfo tlbios_reginfo[] = {
    ...
    {.name   = "TLBI_IPAS2E1OS",
     ...
     .opc2   = 0,
     .access = PL2_W,
     .type   = ARM_CP_NOP | ARM_CP_ADD_TLBI_NXS},
    {.name   = "TLBI_RIPAS2E1OS",
     .state  = ARM_CP_STATE_AA64,
     .opc0   = 1,
     .opc1   = 4,
     .crn    = 8,
...
static void tlbi_aa64_paall_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs = env_cpu(env);
...
static void tlbi_aa64_paallos_write(CPUARMState* env, const ARMCPRegInfo* ri, uint64_t value)
{
    CPUState* cs = env_cpu(env);
...
void define_tlb_insn_regs(ARMCPU* cpu)
{
    ...
    if (!arm_feature(env, ARM_FEATURE_V7)) { define_arm_cp_regs(cpu, tlbi_not_v7_cp_reginfo); }
    else {
        define_arm_cp_regs(cpu, tlbi_v7_cp_reginfo);
    }
    if (arm_feature(env, ARM_FEATURE_V7MP)) { define_arm_cp_regs(cpu, tlbi_v7mp_cp_reginfo); }
    if (arm_feature(env, ARM_FEATURE_V8)) { define_arm_cp_regs(cpu, tlbi_v8_cp_reginfo); }
    /*
     ...
     */
    if (arm_feature(env, ARM_FEATURE_EL2)) { define_arm_cp_regs(cpu, tlbi_el2_cp_reginfo); }
    if (arm_feature(env, ARM_FEATURE_EL3)) { define_arm_cp_regs(cpu, tlbi_el3_cp_reginfo); }
    if (cpu_isar_feature(aa64_tlbirange, cpu)) { define_arm_cp_regs(cpu, tlbirange_reginfo); }
    if (cpu_isar_feature(aa64_tlbios, cpu)) { define_arm_cp_regs(cpu, tlbios_reginfo); }
    if (cpu_isar_feature(aa64_rme, cpu)) { define_arm_cp_regs(cpu, tlbi_rme_reginfo); }
}
