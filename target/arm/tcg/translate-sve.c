...
typedef void GVecGen2sFn(unsigned, uint32_t, uint32_t, TCGv_i64, uint32_t, uint32_t);

typedef void gen_helper_gvec_flags_3(TCGv_i32, TCGv_ptr, TCGv_ptr, TCGv_ptr, TCGv_i32);
typedef void gen_helper_gvec_flags_4(TCGv_i32, TCGv_ptr, TCGv_ptr, TCGv_ptr, TCGv_ptr, TCGv_i32);

typedef void gen_helper_gvec_mem(TCGv_env, TCGv_ptr, TCGv_i64, TCGv_i64);
typedef void gen_helper_gvec_mem_scatter(TCGv_env, TCGv_ptr, TCGv_ptr, TCGv_ptr, TCGv_i64, TCGv_i64);
...
static inline int expand_imm_sh8s(DisasContext* s, int x) { return (int8_t)x << (x & 0x100 ? 8 : 0); }

static inline int expand_imm_sh8u(DisasContext* s, int x) { return (uint8_t)x << (x & 0x100 ? 8 : 0); }
...
static bool gen_gvec_ool_zz(DisasContext* s, gen_helper_gvec_2* fn, int rd, int rn, int data)
{
    if (fn == NULL) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_2_ool(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), vsz, vsz, data, fn);
    }
    return true;
}

static bool gen_gvec_fpst_zz(DisasContext* s, gen_helper_gvec_2_ptr* fn, int rd, int rn, int data,
                             ARMFPStatusFlavour flavour)
{
    ...
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_2_ptr(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), status, vsz, vsz, data, fn);
    }
    return true;
}

static bool gen_gvec_fpst_ah_arg_zz(DisasContext* s, gen_helper_gvec_2_ptr* fn, arg_rr_esz* a, int data)
{ return gen_gvec_fpst_zz(s, fn, a->rd, a->rn, data, select_ah_fpst(s, a->esz)); }

/* Invoke an out-of-line helper on 3 Zregs. */
static bool gen_gvec_ool_zzz(DisasContext* s, gen_helper_gvec_3* fn, int rd, int rn, int rm, int data)
{
    if (fn == NULL) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_3_ool(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), vec_full_reg_offset(s, rm), vsz, vsz,
                           data, fn);
    }
    return true;
}

static bool gen_gvec_ool_arg_zzz(DisasContext* s, gen_helper_gvec_3* fn, arg_rrr_esz* a, int data)
{ return gen_gvec_ool_zzz(s, fn, a->rd, a->rn, a->rm, data); }

/* Invoke an out-of-line helper on 3 Zregs, plus float_status. */
static bool gen_gvec_fpst_zzz(DisasContext* s, gen_helper_gvec_3_ptr* fn, int rd, int rn, int rm, int data,
                              ARMFPStatusFlavour flavour)
{
    if (fn == NULL) { return false; }
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_3_ptr(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), vec_full_reg_offset(s, rm), status,
                           vsz, vsz, data, fn);
    }
    return true;
}

static bool gen_gvec_fpst_arg_zzz(DisasContext* s, gen_helper_gvec_3_ptr* fn, arg_rrr_esz* a, int data)
{
    /* These insns use MO_8 to encode BFloat16 */
    if (a->esz == MO_8 && !dc_isar_feature(aa64_sve_b16b16, s)) { return false; }
    return gen_gvec_fpst_zzz(s, fn, a->rd, a->rn, a->rm, data, a->esz == MO_16 ? FPST_A64_F16 : FPST_A64);
}

static bool gen_gvec_fpst_ah_arg_zzz(DisasContext* s, gen_helper_gvec_3_ptr* fn, arg_rrr_esz* a, int data)
{ return gen_gvec_fpst_zzz(s, fn, a->rd, a->rn, a->rm, data, select_ah_fpst(s, a->esz)); }

/* Invoke an out-of-line helper on 4 Zregs. */
static bool gen_gvec_ool_zzzz(DisasContext* s, gen_helper_gvec_4* fn, int rd, int rn, int rm, int ra, int data)
{
    if (fn == NULL) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_4_ool(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), vec_full_reg_offset(s, rm),
                           vec_full_reg_offset(s, ra), vsz, vsz, data, fn);
    }
    return true;
}

static bool gen_gvec_ool_arg_zzzz(DisasContext* s, gen_helper_gvec_4* fn, arg_rrrr_esz* a, int data)
{ return gen_gvec_ool_zzzz(s, fn, a->rd, a->rn, a->rm, a->ra, data); }

static bool gen_gvec_ool_arg_zzxz(DisasContext* s, gen_helper_gvec_4* fn, arg_rrxr_esz* a)
{ return gen_gvec_ool_zzzz(s, fn, a->rd, a->rn, a->rm, a->ra, a->index); }

/* Invoke an out-of-line helper on 4 Zregs, plus a pointer. */
static bool gen_gvec_ptr_zzzz(DisasContext* s, gen_helper_gvec_4_ptr* fn, int rd, int rn, int rm, int ra, int data,
                              TCGv_ptr ptr)
{
    if (fn == NULL) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_4_ptr(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), vec_full_reg_offset(s, rm),
                           vec_full_reg_offset(s, ra), ptr, vsz, vsz, data, fn);
    }
    return true;
}

static bool gen_gvec_fpst_zzzz(DisasContext* s, gen_helper_gvec_4_ptr* fn, int rd, int rn, int rm, int ra, int data,
                               ARMFPStatusFlavour flavour)
{
    TCGv_ptr status = fpstatus_ptr(flavour);
...
static bool gen_gvec_env_zzzz(DisasContext* s, gen_helper_gvec_4_ptr* fn, int rd, int rn, int rm, int ra, int data)
{ return gen_gvec_ptr_zzzz(s, fn, rd, rn, rm, ra, data, tcg_env); }

static bool gen_gvec_env_arg_zzzz(DisasContext* s, gen_helper_gvec_4_ptr* fn, arg_rrrr_esz* a, int data)
{ return gen_gvec_env_zzzz(s, fn, a->rd, a->rn, a->rm, a->ra, data); }

static bool gen_gvec_env_arg_zzxz(DisasContext* s, gen_helper_gvec_4_ptr* fn, arg_rrxr_esz* a)
{ return gen_gvec_env_zzzz(s, fn, a->rd, a->rn, a->rm, a->ra, a->index); }

/* Invoke an out-of-line helper on 4 Zregs, 1 Preg, plus fpst. */
static bool gen_gvec_fpst_zzzzp(DisasContext* s, gen_helper_gvec_5_ptr* fn, int rd, int rn, int rm, int ra, int pg,
                                int data, ARMFPStatusFlavour flavour)
{
    ...
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_5_ptr(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), vec_full_reg_offset(s, rm),
                           vec_full_reg_offset(s, ra), pred_full_reg_offset(s, pg), status, vsz, vsz, data, fn);
    }
    return true;
}

/* Invoke an out-of-line helper on 2 Zregs and a predicate. */
static bool gen_gvec_ool_zzp(DisasContext* s, gen_helper_gvec_3* fn, int rd, int rn, int pg, int data)
{
    if (fn == NULL) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_3_ool(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), pred_full_reg_offset(s, pg), vsz,
                           vsz, data, fn);
    }
    return true;
}

static bool gen_gvec_ool_arg_zpz(DisasContext* s, gen_helper_gvec_3* fn, arg_rpr_esz* a, int data)
{ return gen_gvec_ool_zzp(s, fn, a->rd, a->rn, a->pg, data); }

static bool gen_gvec_ool_arg_zpzi(DisasContext* s, gen_helper_gvec_3* fn, arg_rpri_esz* a)
{ return gen_gvec_ool_zzp(s, fn, a->rd, a->rn, a->pg, a->imm); }

static bool gen_gvec_fpst_zzp(DisasContext* s, gen_helper_gvec_3_ptr* fn, int rd, int rn, int pg, int data,
                              ARMFPStatusFlavour flavour)
{
    if (fn == NULL) { return false; }
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_3_ptr(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), pred_full_reg_offset(s, pg), status,
                           vsz, vsz, data, fn);
    }
    return true;
}

static bool gen_gvec_fpst_arg_zpz(DisasContext* s, gen_helper_gvec_3_ptr* fn, arg_rpr_esz* a, int data,
                                  ARMFPStatusFlavour flavour)
{ return gen_gvec_fpst_zzp(s, fn, a->rd, a->rn, a->pg, data, flavour); }

/* Invoke an out-of-line helper on 3 Zregs and a predicate. */
static bool gen_gvec_ool_zzzp(DisasContext* s, gen_helper_gvec_4* fn, int rd, int rn, int rm, int pg, int data)
{
    if (fn == NULL) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_4_ool(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), vec_full_reg_offset(s, rm),
                           pred_full_reg_offset(s, pg), vsz, vsz, data, fn);
    }
    return true;
}

static bool gen_gvec_ool_arg_zpzz(DisasContext* s, gen_helper_gvec_4* fn, arg_rprr_esz* a, int data)
{ return gen_gvec_ool_zzzp(s, fn, a->rd, a->rn, a->rm, a->pg, data); }

/* Invoke an out-of-line helper on 3 Zregs and a predicate. */
static bool gen_gvec_fpst_zzzp(DisasContext* s, gen_helper_gvec_4_ptr* fn, int rd, int rn, int rm, int pg, int data,
                               ARMFPStatusFlavour flavour)
{
    if (fn == NULL) { return false; }
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_4_ptr(vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), vec_full_reg_offset(s, rm),
                           pred_full_reg_offset(s, pg), status, vsz, vsz, data, fn);
    }
    return true;
}

static bool gen_gvec_fpst_arg_zpzz(DisasContext* s, gen_helper_gvec_4_ptr* fn, arg_rprr_esz* a)
{
    /* These insns use MO_8 to encode BFloat16. */
    if (a->esz == MO_8 && !dc_isar_feature(aa64_sve_b16b16, s)) { return false; }
    return gen_gvec_fpst_zzzp(s, fn, a->rd, a->rn, a->rm, a->pg, 0, a->esz == MO_16 ? FPST_A64_F16 : FPST_A64);
}

/* Invoke a vector expander on two Zregs and an immediate.  */
static bool gen_gvec_fn_zzi(DisasContext* s, GVecGen2iFn* gvec_fn, int esz, int rd, int rn, uint64_t imm)
{
    if (gvec_fn == NULL) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        gvec_fn(esz, vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), imm, vsz, vsz);
    }
    return true;
}

static bool gen_gvec_fn_arg_zzi(DisasContext* s, GVecGen2iFn* gvec_fn, arg_rri_esz* a)
{
    if (a->esz < 0) {
...
static bool gen_gvec_fn_zzz(DisasContext* s, GVecGen3Fn* gvec_fn, int esz, int rd, int rn, int rm)
{
    if (gvec_fn == NULL) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        gvec_fn(esz, vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), vec_full_reg_offset(s, rm), vsz, vsz);
    }
    return true;
}

static bool gen_gvec_fn_arg_zzz(DisasContext* s, GVecGen3Fn* fn, arg_rrr_esz* a)
{ return gen_gvec_fn_zzz(s, fn, a->esz, a->rd, a->rn, a->rm); }

/* Invoke a vector expander on four Zregs.  */
static bool gen_gvec_fn_arg_zzzz(DisasContext* s, GVecGen4Fn* gvec_fn, arg_rrrr_esz* a)
{
    if (gvec_fn == NULL) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        gvec_fn(a->esz, vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), vec_full_reg_offset(s, a->rm),
...
static bool do_mov_z(DisasContext* s, int rd, int rn)
{
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_mov(MO_8, vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn), vsz, vsz);
    }
    return true;
}
...
static bool gen_gvec_fn_ppp(DisasContext* s, GVecGen3Fn* gvec_fn, int rd, int rn, int rm)
{
    if (sve_access_check(s)) {
        unsigned psz = pred_gvec_reg_size(s);
        gvec_fn(MO_64, pred_full_reg_offset(s, rd), pred_full_reg_offset(s, rn), pred_full_reg_offset(s, rm), psz, psz);
    }
    return true;
}
...
static bool do_mov_p(DisasContext* s, int rd, int rn)
{
    if (sve_access_check(s)) {
        unsigned psz = pred_gvec_reg_size(s);
        tcg_gen_gvec_mov(MO_8, pred_full_reg_offset(s, rd), pred_full_reg_offset(s, rn), psz, psz);
    }
    return true;
}
...
const uint64_t pred_esz_masks[5] = {
    0xffffffffffffffffull, 0x5555555555555555ull, 0x1111111111111111ull, 0x0101010101010101ull, 0x0001000100010001ull,
};
...
{
    if (a->esz < 0 || !dc_isar_feature(aa64_sve2, s)) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        gen_gvec_xar(a->esz, vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn),
...
static void gen_bsl(unsigned vece, uint32_t d, uint32_t n, uint32_t m, uint32_t a, uint32_t oprsz, uint32_t maxsz)
{
...
static void gen_bsl1n_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m, TCGv_vec k)
{
    tcg_gen_not_vec(vece, n, n);
    tcg_gen_bitsel_vec(vece, d, k, n, m);
}

static void gen_bsl1n(unsigned vece, uint32_t d, uint32_t n, uint32_t m, uint32_t a, uint32_t oprsz, uint32_t maxsz)
{
...
static void gen_bsl2n_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m, TCGv_vec k)
{
    tcg_gen_not_vec(vece, m, m);
    tcg_gen_bitsel_vec(vece, d, k, n, m);
}

static void gen_bsl2n(unsigned vece, uint32_t d, uint32_t n, uint32_t m, uint32_t a, uint32_t oprsz, uint32_t maxsz)
{
    static const GVecGen4 op = {
        .fni8       = gen_bsl2n_i64,
        .fniv       = gen_bsl2n_vec,
...
static void gen_nbsl_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m, TCGv_vec k)
{
    tcg_gen_bitsel_vec(vece, d, k, n, m);
    tcg_gen_not_vec(vece, d, d);
}

static void gen_nbsl(unsigned vece, uint32_t d, uint32_t n, uint32_t m, uint32_t a, uint32_t oprsz, uint32_t maxsz)
{
    static const GVecGen4 op = {
        .fni8       = gen_nbsl_i64,
        .fniv       = gen_nbsl_vec,
...
{
    static gen_helper_gvec_4* const fns[4] = {gen_helper_sve_sel_zpzz_b, gen_helper_sve_sel_zpzz_h,
...
#define DO_ZPZZ(NAME, FEAT, name)                                                \
    static gen_helper_gvec_4* const name##_zpzz_fns[4] = {                       \
        gen_helper_##name##_zpzz_b,                                              \
        gen_helper_##name##_zpzz_h,                                              \
        gen_helper_##name##_zpzz_s,                                              \
        gen_helper_##name##_zpzz_d,                                              \
    };                                                                           \
    TRANS_FEAT(NAME, FEAT, gen_gvec_ool_arg_zpzz, name##_zpzz_fns[a->esz], a, 0)
...
static gen_helper_gvec_4* const sdiv_fns[4] = {NULL, NULL, gen_helper_sve_sdiv_zpzz_s, gen_helper_sve_sdiv_zpzz_d};
TRANS_FEAT(SDIV_zpzz, aa64_sve, gen_gvec_ool_arg_zpzz, sdiv_fns[a->esz], a, 0)

static gen_helper_gvec_4* const udiv_fns[4] = {NULL, NULL, gen_helper_sve_udiv_zpzz_s, gen_helper_sve_udiv_zpzz_d};
...
static gen_helper_gvec_3* const fabs_ah_fns[4] = {
    NULL,
    gen_helper_sve_ah_fabs_h,
    gen_helper_sve_ah_fabs_s,
    gen_helper_sve_ah_fabs_d,
};
TRANS_FEAT(FABS, aa64_sve, gen_gvec_ool_arg_zpz, s->fpcr_ah ? fabs_ah_fns[a->esz] : fabs_fns[a->esz], a, 0)
...
static gen_helper_gvec_3* const fneg_ah_fns[4] = {
    NULL,
    gen_helper_sve_ah_fneg_h,
    gen_helper_sve_ah_fneg_s,
    gen_helper_sve_ah_fneg_d,
};
TRANS_FEAT(FNEG, aa64_sve, gen_gvec_ool_arg_zpz, s->fpcr_ah ? fneg_ah_fns[a->esz] : fneg_fns[a->esz], a, 0)
...
static gen_helper_gvec_3* const sxth_fns[4] = {NULL, NULL, gen_helper_sve_sxth_s, gen_helper_sve_sxth_d};
TRANS_FEAT(SXTH, aa64_sve, gen_gvec_ool_arg_zpz, sxth_fns[a->esz], a, 0)

static gen_helper_gvec_3* const uxth_fns[4] = {NULL, NULL, gen_helper_sve_uxth_s, gen_helper_sve_uxth_d};
TRANS_FEAT(UXTH, aa64_sve, gen_gvec_ool_arg_zpz, uxth_fns[a->esz], a, 0)

TRANS_FEAT(SXTW, aa64_sve, gen_gvec_ool_arg_zpz, a->esz == 3 ? gen_helper_sve_sxtw_d : NULL, a, 0)
TRANS_FEAT(UXTW, aa64_sve, gen_gvec_ool_arg_zpz, a->esz == 3 ? gen_helper_sve_uxtw_d : NULL, a, 0)

static gen_helper_gvec_3* const addqv_fns[4] = {
    gen_helper_sve2p1_addqv_b,
    gen_helper_sve2p1_addqv_h,
    gen_helper_sve2p1_addqv_s,
    gen_helper_sve2p1_addqv_d,
};
TRANS_FEAT(ADDQV, aa64_sme2p1_or_sve2p1, gen_gvec_ool_arg_zpz, addqv_fns[a->esz], a, 0)

static gen_helper_gvec_3* const smaxqv_fns[4] = {
    gen_helper_sve2p1_smaxqv_b,
    gen_helper_sve2p1_smaxqv_h,
    gen_helper_sve2p1_smaxqv_s,
    gen_helper_sve2p1_smaxqv_d,
};
TRANS_FEAT(SMAXQV, aa64_sme2p1_or_sve2p1, gen_gvec_ool_arg_zpz, smaxqv_fns[a->esz], a, 0)

static gen_helper_gvec_3* const sminqv_fns[4] = {
    gen_helper_sve2p1_sminqv_b,
    gen_helper_sve2p1_sminqv_h,
    gen_helper_sve2p1_sminqv_s,
    gen_helper_sve2p1_sminqv_d,
};
TRANS_FEAT(SMINQV, aa64_sme2p1_or_sve2p1, gen_gvec_ool_arg_zpz, sminqv_fns[a->esz], a, 0)

static gen_helper_gvec_3* const umaxqv_fns[4] = {
    gen_helper_sve2p1_umaxqv_b,
    gen_helper_sve2p1_umaxqv_h,
    gen_helper_sve2p1_umaxqv_s,
    gen_helper_sve2p1_umaxqv_d,
};
TRANS_FEAT(UMAXQV, aa64_sme2p1_or_sve2p1, gen_gvec_ool_arg_zpz, umaxqv_fns[a->esz], a, 0)

static gen_helper_gvec_3* const uminqv_fns[4] = {
    gen_helper_sve2p1_uminqv_b,
    gen_helper_sve2p1_uminqv_h,
    gen_helper_sve2p1_uminqv_s,
    gen_helper_sve2p1_uminqv_d,
};
TRANS_FEAT(UMINQV, aa64_sme2p1_or_sve2p1, gen_gvec_ool_arg_zpz, uminqv_fns[a->esz], a, 0)
...
static bool  do_vpz_ool(DisasContext* s, arg_rpr_esz* a, gen_helper_gvec_reduc* fn)
{
    unsigned vsz = vec_full_reg_size(s);
    TCGv_ptr t_zn, t_pg;
    TCGv_i32 desc;
    ...
    if (fn == NULL) { return false; }
    if (!sve_access_check(s)) { return true; }
...
static gen_helper_gvec_reduc* const saddv_fns[4] = {gen_helper_sve_saddv_b, gen_helper_sve_saddv_h,
 ...
 */
static bool do_movz_zpz(DisasContext* s, int rd, int rn, int pg, int esz, bool invert)
{
    static gen_helper_gvec_3* const fns[4] = {
        gen_helper_sve_movz_b,
        gen_helper_sve_movz_h,
        gen_helper_sve_movz_s,
        gen_helper_sve_movz_d,
    };
    return gen_gvec_ool_zzp(s, fns[esz], rd, rn, pg, invert);
}

static bool do_shift_zpzi(DisasContext* s, arg_rpri_esz* a, bool asr, gen_helper_gvec_3* const fns[4])
{
    int max;
...
static gen_helper_gvec_3* const asr_zpzi_fns[4] = {
    gen_helper_sve_asr_zpzi_b,
    gen_helper_sve_asr_zpzi_h,
    gen_helper_sve_asr_zpzi_s,
...
static gen_helper_gvec_3* const lsl_zpzi_fns[4] = {
    gen_helper_sve_lsl_zpzi_b,
    gen_helper_sve_lsl_zpzi_h,
    gen_helper_sve_lsl_zpzi_s,
...
static gen_helper_gvec_3* const asrd_fns[4] = {
    gen_helper_sve_asrd_b,
    gen_helper_sve_asrd_h,
    gen_helper_sve_asrd_s,
...
static gen_helper_gvec_3* const sqshl_zpzi_fns[4] = {
    gen_helper_sve2_sqshl_zpzi_b,
    gen_helper_sve2_sqshl_zpzi_h,
    gen_helper_sve2_sqshl_zpzi_s,
    gen_helper_sve2_sqshl_zpzi_d,
};
TRANS_FEAT(SQSHL_zpzi, aa64_sve2, gen_gvec_ool_arg_zpzi, a->esz < 0 ? NULL : sqshl_zpzi_fns[a->esz], a)

static gen_helper_gvec_3* const uqshl_zpzi_fns[4] = {
    gen_helper_sve2_uqshl_zpzi_b,
    gen_helper_sve2_uqshl_zpzi_h,
    gen_helper_sve2_uqshl_zpzi_s,
    gen_helper_sve2_uqshl_zpzi_d,
};
TRANS_FEAT(UQSHL_zpzi, aa64_sve2, gen_gvec_ool_arg_zpzi, a->esz < 0 ? NULL : uqshl_zpzi_fns[a->esz], a)

static gen_helper_gvec_3* const srshr_fns[4] = {
    gen_helper_sve2_srshr_b,
    gen_helper_sve2_srshr_h,
    gen_helper_sve2_srshr_s,
    gen_helper_sve2_srshr_d,
};
TRANS_FEAT(SRSHR, aa64_sve2, gen_gvec_ool_arg_zpzi, a->esz < 0 ? NULL : srshr_fns[a->esz], a)

static gen_helper_gvec_3* const urshr_fns[4] = {
    gen_helper_sve2_urshr_b,
    gen_helper_sve2_urshr_h,
    gen_helper_sve2_urshr_s,
    gen_helper_sve2_urshr_d,
};
TRANS_FEAT(URSHR, aa64_sve2, gen_gvec_ool_arg_zpzi, a->esz < 0 ? NULL : urshr_fns[a->esz], a)

static gen_helper_gvec_3* const sqshlu_fns[4] = {
    gen_helper_sve2_sqshlu_b,
    gen_helper_sve2_sqshlu_h,
    gen_helper_sve2_sqshlu_s,
    gen_helper_sve2_sqshlu_d,
};
TRANS_FEAT(SQSHLU, aa64_sve2, gen_gvec_ool_arg_zpzi, a->esz < 0 ? NULL : sqshlu_fns[a->esz], a)
...
#define DO_ZPZW(NAME, name)                                                                                     \
    static gen_helper_gvec_4* const name##_zpzw_fns[4] = {                                                      \
        gen_helper_sve_##name##_zpzw_b, gen_helper_sve_##name##_zpzw_h, gen_helper_sve_##name##_zpzw_s, NULL};  \
    TRANS_FEAT(NAME##_zpzw, aa64_sve, gen_gvec_ool_arg_zpzz, a->esz < 0 ? NULL : name##_zpzw_fns[a->esz], a, 0)
...
static bool do_shift_imm(DisasContext* s, arg_rri_esz* a, bool asr,
                         void (*gvec_fn)(unsigned, uint32_t, uint32_t, int64_t, uint32_t, uint32_t))
{
    if (a->esz < 0) {
        /* Invalid tsz encoding -- see tszimm_esz. */
        return false;
    ...
    if (sve_access_check(s)) {
        ...
        if (a->imm >= 8 << a->esz) {
            if (asr) { a->imm = (8 << a->esz) - 1; }
            else {
                do_dupi_z(s, a->rd, 0);
                return true;
            }
        }
        gvec_fn(a->esz, vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), a->imm, vsz, vsz);
    }
    return true;
}
...
#define DO_ZZW(NAME, name)                                                                                             \
    static gen_helper_gvec_3* const name##_zzw_fns[4] = {gen_helper_sve_##name##_zzw_b, gen_helper_sve_##name##_zzw_h, \
                                                         gen_helper_sve_##name##_zzw_s, NULL};                         \
    TRANS_FEAT(NAME, aa64_sve, gen_gvec_ool_arg_zzz, name##_zzw_fns[a->esz], a, 0)
...
static bool do_zpzzz_ool(DisasContext* s, arg_rprrr_esz* a, gen_helper_gvec_5* fn)
{
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_5_ool(vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->ra), vec_full_reg_offset(s, a->rn),
                           vec_full_reg_offset(s, a->rm), pred_full_reg_offset(s, a->pg), vsz, vsz, 0, fn);
    }
    return true;
}

static gen_helper_gvec_5* const mla_fns[4] = {
    gen_helper_sve_mla_b,
    gen_helper_sve_mla_h,
    gen_helper_sve_mla_s,
    gen_helper_sve_mla_d,
};
TRANS_FEAT(MLA, aa64_sve, do_zpzzz_ool, a, mla_fns[a->esz])

static gen_helper_gvec_5* const mls_fns[4] = {
    gen_helper_sve_mls_b,
    gen_helper_sve_mls_h,
    gen_helper_sve_mls_s,
...
static bool do_index(DisasContext* s, int esz, int rd, TCGv_i64 start, TCGv_i64 incr)
{
    unsigned vsz;
    TCGv_i32 desc;
    TCGv_ptr t_zd;
    ...
    if (esz == 3) { gen_helper_sve_index_d(t_zd, start, incr, desc); }
    else {
...
TRANS_FEAT(INDEX_ii, aa64_sve, do_index, a->esz, a->rd, tcg_constant_i64(a->imm1), tcg_constant_i64(a->imm2))
TRANS_FEAT(INDEX_ir, aa64_sve, do_index, a->esz, a->rd, tcg_constant_i64(a->imm), cpu_reg(s, a->rm))
TRANS_FEAT(INDEX_ri, aa64_sve, do_index, a->esz, a->rd, cpu_reg(s, a->rn), tcg_constant_i64(a->imm))
TRANS_FEAT(INDEX_rr, aa64_sve, do_index, a->esz, a->rd, cpu_reg(s, a->rn), cpu_reg(s, a->rm))
...
{
    if (!dc_isar_feature(aa64_sve, s)) { return false; }
    if (sve_access_check(s)) {
...
{
    if (!dc_isar_feature(aa64_sme, s)) { return false; }
...
TRANS_FEAT_NONSTREAMING(FEXPA, aa64_sve, gen_gvec_ool_zz, fexpa_fns[a->esz], a->rd, a->rn, s->fpcr_ah)
...
TRANS_FEAT_NONSTREAMING(FTSSEL, aa64_sve, gen_gvec_ool_arg_zzz, ftssel_fns[a->esz], a, s->fpcr_ah)

/*
 *** SVE Predicate Logical Operations Group
 */

static bool do_pppp_flags(DisasContext* s, arg_rprr_s* a, const GVecGen4* gvec_op)
{
    if (!sve_access_check(s)) { return true; }
...
static void gen_and_pg_vec(unsigned vece, TCGv_vec pd, TCGv_vec pn, TCGv_vec pm, TCGv_vec pg)
{
...
static bool trans_AND_pppp(DisasContext* s, arg_rprr_s* a)
{
    ...
    if (!a->s) {
        if (a->rn == a->rm) {
            if (a->pg == a->rn) { return do_mov_p(s, a->rd, a->rn); }
...
static void gen_bic_pg_vec(unsigned vece, TCGv_vec pd, TCGv_vec pn, TCGv_vec pm, TCGv_vec pg)
{
...
static bool trans_BIC_pppp(DisasContext* s, arg_rprr_s* a)
{
    ...
    if (!dc_isar_feature(aa64_sve, s)) { return false; }
    if (!a->s && a->pg == a->rn) { return gen_gvec_fn_ppp(s, tcg_gen_gvec_andc, a->rd, a->rn, a->rm); }
    return do_pppp_flags(s, a, &op);
}
...
static void gen_eor_pg_vec(unsigned vece, TCGv_vec pd, TCGv_vec pn, TCGv_vec pm, TCGv_vec pg)
{
...
static bool trans_EOR_pppp(DisasContext* s, arg_rprr_s* a)
{
    ...
    if (!a->s && a->pg == a->rm) { return gen_gvec_fn_ppp(s, tcg_gen_gvec_andc, a->rd, a->pg, a->rn); }
    return do_pppp_flags(s, a, &op);
}

static bool trans_SEL_pppp(DisasContext* s, arg_rprr_s* a)
{
    if (a->s || !dc_isar_feature(aa64_sve, s)) { return false; }
    if (sve_access_check(s)) {
        unsigned psz = pred_gvec_reg_size(s);
        tcg_gen_gvec_bitsel(MO_8, pred_full_reg_offset(s, a->rd), pred_full_reg_offset(s, a->pg),
                            pred_full_reg_offset(s, a->rn), pred_full_reg_offset(s, a->rm), psz, psz);
    }
    return true;
}
...
static void gen_orr_pg_vec(unsigned vece, TCGv_vec pd, TCGv_vec pn, TCGv_vec pm, TCGv_vec pg)
{
...
static bool trans_ORR_pppp(DisasContext* s, arg_rprr_s* a)
{
    ...
    if (!dc_isar_feature(aa64_sve, s)) { return false; }
    if (!a->s && a->pg == a->rn && a->rn == a->rm) { return do_mov_p(s, a->rd, a->rn); }
    return do_pppp_flags(s, a, &op);
}
...
static void gen_orn_pg_vec(unsigned vece, TCGv_vec pd, TCGv_vec pn, TCGv_vec pm, TCGv_vec pg)
{
...
static void gen_nor_pg_vec(unsigned vece, TCGv_vec pd, TCGv_vec pn, TCGv_vec pm, TCGv_vec pg)
{
    tcg_gen_or_vec(vece, pd, pn, pm);
...
static void gen_nand_pg_vec(unsigned vece, TCGv_vec pd, TCGv_vec pn, TCGv_vec pm, TCGv_vec pg)
{
    tcg_gen_and_vec(vece, pd, pn, pm);
    tcg_gen_andc_vec(vece, pd, pg, pd);
}
...
static bool do_predset(DisasContext* s, int esz, int rd, int pat, bool setflag)
{
    ...
    if (numelem == 0) {
        ...
        if (setsz % 64) { lastword &= MAKE_64BIT_MASK(0, setsz % 64); }
    }
    ...
    for (i = 0; i < QEMU_ALIGN_DOWN(setsz, 8); i += 8) { tcg_gen_st_i64(t, tcg_env, ofs + i); }
    if (lastword != word) {
        tcg_gen_movi_i64(t, lastword);
    ...
    if (i < fullsz) {
        ...
        for (; i < fullsz; i += 8) { tcg_gen_st_i64(t, tcg_env, ofs + i); }
    }
...
{
    if (!dc_isar_feature(aa64_sme2_or_sve2p1, s)) { return false; }
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_dup_imm(MO_64, pred_full_reg_offset(s, a->rd), 8, size_for_gvec(pred_full_reg_size(s)), val);
    }
    return true;
}

/* Note pat == 31 is #all, to set all elements.  */
TRANS_FEAT_NONSTREAMING(SETFFR, aa64_sve, do_predset, 0, FFR_PRED_NUM, 31, false)
...
static bool do_pfirst_pnext(DisasContext* s, arg_rr_esz* a, void (*gen_fn)(TCGv_i32, TCGv_ptr, TCGv_ptr, TCGv_i32))
{
    if (!sve_access_check(s)) { return true; }
...
static void do_sat_addsub_32(TCGv_i64 reg, TCGv_i64 val, bool u, bool d)
{
    ...
    if (u) { tcg_gen_ext32u_i64(reg, reg); }
    else {
...
static void do_sat_addsub_vec(DisasContext* s, int esz, int rd, int rn, TCGv_i64 val, bool u, bool d)
{
    unsigned vsz = vec_full_reg_size(s);
    TCGv_ptr dptr, nptr;
    TCGv_i32 t32, desc;
    ...
    switch (esz) {
        case MO_8:
            ...
            if (d) { tcg_gen_neg_i32(t32, t32); }
            if (u) { gen_helper_sve_uqaddi_b(dptr, nptr, t32, desc); }
            else {
        ...
        case MO_16:
            ...
            tcg_gen_extrl_i64_i32(t32, val);
            if (d) { tcg_gen_neg_i32(t32, t32); }
            if (u) { gen_helper_sve_uqaddi_h(dptr, nptr, t32, desc); }
            else {
        ...
        case MO_32:
            ...
            if (d) { tcg_gen_neg_i64(t64, val); }
            else {
                tcg_gen_mov_i64(t64, val);
            }
            if (u) { gen_helper_sve_uqaddi_s(dptr, nptr, t64, desc); }
            else {
        ...
        case MO_64:
            if (u) {
                if (d) { gen_helper_sve_uqsubi_d(dptr, nptr, val, desc); }
                else {
...
static bool trans_SINCDEC_r_32(DisasContext* s, arg_incdec_cnt* a)
{
    ...
    /* Use normal 64-bit arithmetic to detect 32-bit overflow.  */
    if (inc == 0) {
        if (a->u) { tcg_gen_ext32u_i64(reg, reg); }
        else {
            tcg_gen_ext32s_i64(reg, reg);
        }
    }
...
static bool trans_SINCDEC_r_64(DisasContext* s, arg_incdec_cnt* a)
{
    ...
    if (inc != 0) { do_sat_addsub_64(reg, tcg_constant_i64(inc), a->u, a->d); }
    return true;
}

static bool trans_INCDEC_v(DisasContext* s, arg_incdec2_cnt* a)
{
    if (a->esz == 0 || !dc_isar_feature(aa64_sve, s)) { return false; }
    ...
    if (inc != 0) {
        if (sve_access_check(s)) {
            tcg_gen_gvec_adds(a->esz, vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn),
                              tcg_constant_i64(a->d ? -inc : inc), fullsz, fullsz);
        }
    }
    else {
...
static bool trans_SINCDEC_v(DisasContext* s, arg_incdec2_cnt* a)
{
    ...
    if (inc != 0) {
        if (sve_access_check(s)) { do_sat_addsub_vec(s, a->esz, a->rd, a->rn, tcg_constant_i64(inc), a->u, a->d); }
    }
    else {
        do_mov_z(s, a->rd, a->rn);
    }
...
{
    uint64_t imm;
    if (!logic_imm_decode_wmask(&imm, extract32(a->dbm, 12, 1), extract32(a->dbm, 0, 6), extract32(a->dbm, 6, 6))) {
        return false;
    }
...
static bool trans_DUPM(DisasContext* s, arg_DUPM* a)
{
    ...
    if (sve_access_check(s)) { do_dupi_z(s, a->rd, imm); }
    return true;
}
 ...
 */
static void do_cpy_m(DisasContext* s, int esz, int rd, int rn, int pg, TCGv_i64 val)
{
    typedef void          gen_cpy(TCGv_ptr, TCGv_ptr, TCGv_ptr, TCGv_i64, TCGv_i32);
    static gen_cpy* const fns[4] = {
        gen_helper_sve_cpy_m_b,
        gen_helper_sve_cpy_m_h,
        gen_helper_sve_cpy_m_s,
...
{
    if (!dc_isar_feature(aa64_sve, s)) { return false; }
    if (sve_access_check(s)) { do_cpy_m(s, a->esz, a->rd, a->rn, a->pg, tcg_constant_i64(a->imm)); }
    return true;
}
...
static bool trans_CPY_z_i(DisasContext* s, arg_CPY_z_i* a)
{
    static gen_helper_gvec_2i* const fns[4] = {
        gen_helper_sve_cpy_z_b,
        gen_helper_sve_cpy_z_h,
        gen_helper_sve_cpy_z_s,
    ...
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_2i_ool(vec_full_reg_offset(s, a->rd), pred_full_reg_offset(s, a->pg), tcg_constant_i64(a->imm),
                            vsz, vsz, 0, fns[a->esz]);
    }
    return true;
}
...
static bool do_EXT(DisasContext* s, int rd, int rn, int rm, int imm)
{
     ...
     */
    if (m != d && n_ofs == size_for_gvec(n_ofs) && n_siz == size_for_gvec(n_siz) && (d != n || n_siz <= n_ofs)) {
        tcg_gen_gvec_mov(0, d, n + n_ofs, n_siz, n_siz);
        if (n_ofs != 0) { tcg_gen_gvec_mov(0, d + n_siz, m, n_ofs, n_ofs); }
    }
    else {
...
static bool trans_EXTQ(DisasContext* s, arg_EXTQ* a)
{
    ...
    if (!dc_isar_feature(aa64_sme2p1_or_sve2p1, s)) { return false; }
    if (!sve_access_check(s)) { return true; }
...
static bool trans_DUP_s(DisasContext* s, arg_DUP_s* a)
{
    ...
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_dup_i64(a->esz, vec_full_reg_offset(s, a->rd), vsz, vsz, cpu_reg_sp(s, a->rn));
    }
    return true;
}
...
static bool trans_DUPQ(DisasContext* s, arg_DUPQ* a)
{
    ...
    for (unsigned i = 0; i < vl; i += 16) { tcg_gen_gvec_dup_mem(a->esz, dofs + i, nofs + i, 16, 16); }
    return true;
}
...
static void do_insr_i64(DisasContext* s, arg_rrr_esz* a, TCGv_i64 val)
{
    ...
    static gen_insr* const fns[4] = {
        gen_helper_sve_insr_b,
        gen_helper_sve_insr_h,
        gen_helper_sve_insr_s,
...
{
    if (!dc_isar_feature(aa64_sve, s)) { return false; }
    if (sve_access_check(s)) { do_insr_i64(s, a, cpu_reg(s, a->rm)); }
    return true;
}

static gen_helper_gvec_2* const rev_fns[4] = {gen_helper_sve_rev_b, gen_helper_sve_rev_h, gen_helper_sve_rev_s,
                                              gen_helper_sve_rev_d};
TRANS_FEAT(REV_v, aa64_sve, gen_gvec_ool_zz, rev_fns[a->esz], a->rd, a->rn, 0)

static gen_helper_gvec_3* const sve_tbl_fns[4] = {gen_helper_sve_tbl_b, gen_helper_sve_tbl_h, gen_helper_sve_tbl_s,
                                                  gen_helper_sve_tbl_d};
TRANS_FEAT(TBL, aa64_sve, gen_gvec_ool_arg_zzz, sve_tbl_fns[a->esz], a, 0)

static gen_helper_gvec_4* const sve2_tbl_fns[4] = {gen_helper_sve2_tbl_b, gen_helper_sve2_tbl_h, gen_helper_sve2_tbl_s,
                                                   gen_helper_sve2_tbl_d};
TRANS_FEAT(TBL_sve2, aa64_sve2, gen_gvec_ool_zzzz, sve2_tbl_fns[a->esz], a->rd, a->rn, (a->rn + 1) % 32, a->rm, 0)

static gen_helper_gvec_3* const tblq_fns[4] = {gen_helper_sve2p1_tblq_b, gen_helper_sve2p1_tblq_h,
                                               gen_helper_sve2p1_tblq_s, gen_helper_sve2p1_tblq_d};
TRANS_FEAT(TBLQ, aa64_sme2p1_or_sve2p1, gen_gvec_ool_arg_zzz, tblq_fns[a->esz], a, 0)

static gen_helper_gvec_3* const tbx_fns[4] = {gen_helper_sve2_tbx_b, gen_helper_sve2_tbx_h, gen_helper_sve2_tbx_s,
                                              gen_helper_sve2_tbx_d};
TRANS_FEAT(TBX, aa64_sve2, gen_gvec_ool_arg_zzz, tbx_fns[a->esz], a, 0)

static gen_helper_gvec_3* const tbxq_fns[4] = {gen_helper_sve2p1_tbxq_b, gen_helper_sve2p1_tbxq_h,
                                               gen_helper_sve2p1_tbxq_s, gen_helper_sve2p1_tbxq_d};
TRANS_FEAT(TBXQ, aa64_sme2p1_or_sve2p1, gen_gvec_ool_arg_zzz, tbxq_fns[a->esz], a, 0)

static bool trans_PMOV_pv(DisasContext* s, arg_PMOV_pv* a)
{
    static gen_helper_gvec_2* const fns[4] = {NULL, gen_helper_pmov_pv_h, gen_helper_pmov_pv_s, gen_helper_pmov_pv_d};
    ...
    vl = vec_full_reg_size(s);
    if (a->esz != MO_8) {
        tcg_gen_gvec_2_ool(pred_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), vl, vl, a->imm, fns[a->esz]);
        return true;
    }
...
{
    static gen_helper_gvec_2* const fns[4] = {NULL, gen_helper_pmov_vp_h, gen_helper_pmov_vp_s, gen_helper_pmov_vp_d};
    unsigned                        vl;
    ...
    if (a->esz == MO_8) {
         ...
         */
        tcg_gen_gvec_mov(MO_64, vec_full_reg_offset(s, a->rd), pred_full_reg_offset(s, a->rn), size_for_gvec(vl / 8),
                         vl);
    }
    else {
        tcg_gen_gvec_2_ool(vec_full_reg_offset(s, a->rd), pred_full_reg_offset(s, a->rn), vl, vl, a->imm, fns[a->esz]);
    }
    return true;
}
...
static bool trans_UNPK(DisasContext* s, arg_UNPK* a)
{
    ...
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_2_ool(vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn) + (a->h ? vsz / 2 : 0), vsz,
                           vsz, 0, fns[a->esz][a->u]);
    }
    return true;
}
...
static bool do_perm_pred3(DisasContext* s, arg_rrr_esz* a, bool high_odd, gen_helper_gvec_3* fn)
{
    if (!sve_access_check(s)) { return true; }
...
static bool do_perm_pred2(DisasContext* s, arg_rr_esz* a, bool high_odd, gen_helper_gvec_2* fn)
{
    if (!sve_access_check(s)) { return true; }
...
static bool do_interleave_q(DisasContext* s, gen_helper_gvec_3* fn, arg_rrr_esz* a, int data)
{
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        if (vsz < 32) { unallocated_encoding(s); }
        else {
            tcg_gen_gvec_3_ool(vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn),
                               vec_full_reg_offset(s, a->rm), vsz, vsz, data, fn);
        }
    }
    return true;
}
...
static gen_helper_gvec_3* const zip_fns[4] = {
    gen_helper_sve_zip_b,
    gen_helper_sve_zip_h,
    gen_helper_sve_zip_s,
    gen_helper_sve_zip_d,
};
TRANS_FEAT(ZIP1_z, aa64_sve, gen_gvec_ool_arg_zzz, zip_fns[a->esz], a, 0)
TRANS_FEAT(ZIP2_z, aa64_sve, gen_gvec_ool_arg_zzz, zip_fns[a->esz], a, vec_full_reg_size(s) / 2)

TRANS_FEAT_NONSTREAMING(ZIP1_q, aa64_sve_f64mm, do_interleave_q, gen_helper_sve2_zip_q, a, 0)
TRANS_FEAT_NONSTREAMING(ZIP2_q, aa64_sve_f64mm, do_interleave_q, gen_helper_sve2_zip_q, a,
                        QEMU_ALIGN_DOWN(vec_full_reg_size(s), 32) / 2)

static gen_helper_gvec_3* const zipq_fns[4] = {
    gen_helper_sve2p1_zipq_b,
    gen_helper_sve2p1_zipq_h,
    gen_helper_sve2p1_zipq_s,
    gen_helper_sve2p1_zipq_d,
};
TRANS_FEAT(ZIPQ1, aa64_sme2p1_or_sve2p1, gen_gvec_ool_arg_zzz, zipq_fns[a->esz], a, 0)
TRANS_FEAT(ZIPQ2, aa64_sme2p1_or_sve2p1, gen_gvec_ool_arg_zzz, zipq_fns[a->esz], a, 16 / 2)

static gen_helper_gvec_3* const uzp_fns[4] = {
    gen_helper_sve_uzp_b,
    gen_helper_sve_uzp_h,
    gen_helper_sve_uzp_s,
    gen_helper_sve_uzp_d,
};
TRANS_FEAT(UZP1_z, aa64_sve, gen_gvec_ool_arg_zzz, uzp_fns[a->esz], a, 0)
TRANS_FEAT(UZP2_z, aa64_sve, gen_gvec_ool_arg_zzz, uzp_fns[a->esz], a, 1 << a->esz)

TRANS_FEAT_NONSTREAMING(UZP1_q, aa64_sve_f64mm, do_interleave_q, gen_helper_sve2_uzp_q, a, 0)
TRANS_FEAT_NONSTREAMING(UZP2_q, aa64_sve_f64mm, do_interleave_q, gen_helper_sve2_uzp_q, a, 16)

static gen_helper_gvec_3* const uzpq_fns[4] = {
    gen_helper_sve2p1_uzpq_b,
    gen_helper_sve2p1_uzpq_h,
    gen_helper_sve2p1_uzpq_s,
    gen_helper_sve2p1_uzpq_d,
};
TRANS_FEAT(UZPQ1, aa64_sme2p1_or_sve2p1, gen_gvec_ool_arg_zzz, uzpq_fns[a->esz], a, 0)
TRANS_FEAT(UZPQ2, aa64_sme2p1_or_sve2p1, gen_gvec_ool_arg_zzz, uzpq_fns[a->esz], a, 1 << a->esz)

static gen_helper_gvec_3* const trn_fns[4] = {
    gen_helper_sve_trn_b,
    gen_helper_sve_trn_h,
    gen_helper_sve_trn_s,
    gen_helper_sve_trn_d,
};

TRANS_FEAT(TRN1_z, aa64_sve, gen_gvec_ool_arg_zzz, trn_fns[a->esz], a, 0)
TRANS_FEAT(TRN2_z, aa64_sve, gen_gvec_ool_arg_zzz, trn_fns[a->esz], a, 1 << a->esz)

TRANS_FEAT_NONSTREAMING(TRN1_q, aa64_sve_f64mm, do_interleave_q, gen_helper_sve2_trn_q, a, 0)
TRANS_FEAT_NONSTREAMING(TRN2_q, aa64_sve_f64mm, do_interleave_q, gen_helper_sve2_trn_q, a, 16)

/*
 *** SVE Permute Vector - Predicated Group
 */

static gen_helper_gvec_3* const compact_fns[4] = {NULL, NULL, gen_helper_sve_compact_s, gen_helper_sve_compact_d};
TRANS_FEAT_NONSTREAMING(COMPACT, aa64_sve, gen_gvec_ool_arg_zpz, compact_fns[a->esz], a, 0)
...
static void incr_last_active(DisasContext* s, TCGv_i32 last, int esz)
{
    ...
    if (is_power_of_2(vsz)) { tcg_gen_andi_i32(last, last, vsz - 1); }
    else {
...
static TCGv_i64 load_esz(TCGv_ptr base, int ofs, int esz)
{
    ...
    switch (esz) {
        case 0 : tcg_gen_ld8u_i64(r, base, ofs); break;
        case 1 : tcg_gen_ld16u_i64(r, base, ofs); break;
        case 2 : tcg_gen_ld32u_i64(r, base, ofs); break;
        case 3 : tcg_gen_ld_i64(r, base, ofs); break;
        default: assert_not_reached();
    }
    return r;
}
...
static TCGv_i64 load_last_active(DisasContext* s, TCGv_i32 last, int rm, int esz)
{
    ...
    if (esz < 3) { tcg_gen_xori_i32(last, last, 8 - (1 << esz)); }
#endif
...
static bool do_clast_vector(DisasContext* s, arg_rprr_esz* a, bool before)
{
    ...
    if (!before) { incr_last_active(s, last, esz); }
...
static void do_clast_scalar(DisasContext* s, int esz, int pg, int rm, bool before, TCGv_i64 reg_val)
{
    ...
    tcg_gen_movcond_i64(TCG_COND_GE, reg_val, cmp, tcg_constant_i64(0), ele, reg_val);
}
...
static bool do_clast_general(DisasContext* s, arg_rpr_esz* a, bool before)
{
    ...
    reg = cpu_reg(s, a->rd);
    switch (a->esz) {
        case 0 : tcg_gen_ext8u_i64(reg, reg); break;
        case 1 : tcg_gen_ext16u_i64(reg, reg); break;
        case 2 : tcg_gen_ext32u_i64(reg, reg); break;
        case 3 : break;
        default: assert_not_reached();
    }
...
static TCGv_i64 do_last_scalar(DisasContext* s, int esz, int pg, int rm, bool before)
{
    TCGv_i32 last = tcg_temp_new_i32();

    find_last_active(s, last, esz, pg);
    if (before) { wrap_last_active(s, last, esz); }
    else {
...
{
    if (!dc_isar_feature(aa64_sve, s)) { return false; }
    if (sve_access_check(s)) { do_cpy_m(s, a->esz, a->rd, a->rd, a->pg, cpu_reg_sp(s, a->rn)); }
    return true;
}
...
TRANS_FEAT(REVW, aa64_sve, gen_gvec_ool_arg_zpz, a->esz == 3 ? gen_helper_sve_revw_d : NULL, a, 0)

TRANS_FEAT(REVD, aa64_sme, gen_gvec_ool_arg_zpz, gen_helper_sme_revd_q, a, 0)

TRANS_FEAT(SPLICE, aa64_sve, gen_gvec_ool_arg_zpzz, gen_helper_sve_splice, a, a->esz)

TRANS_FEAT(SPLICE_sve2, aa64_sve2, gen_gvec_ool_zzzp, gen_helper_sve_splice, a->rd, a->rn, (a->rn + 1) % 32, a->pg,
           a->esz)
...
static bool do_ppzz_flags(DisasContext* s, arg_rprr_esz* a, gen_helper_gvec_flags_4* gen_fn)
{
    TCGv_ptr pd, zn, zm, pg;
    unsigned vsz;
    TCGv_i32 t;

    if (gen_fn == NULL) { return false; }
    if (!sve_access_check(s)) { return true; }
...
#define DO_PPZZ(NAME, name)                                                      \
    static gen_helper_gvec_flags_4* const name##_ppzz_fns[4] = {                 \
        gen_helper_sve_##name##_ppzz_b,                                          \
        gen_helper_sve_##name##_ppzz_h,                                          \
        gen_helper_sve_##name##_ppzz_s,                                          \
        gen_helper_sve_##name##_ppzz_d,                                          \
    };                                                                           \
    TRANS_FEAT(NAME##_ppzz, aa64_sve, do_ppzz_flags, a, name##_ppzz_fns[a->esz])
...
#define DO_PPZW(NAME, name)                                                                                    \
    static gen_helper_gvec_flags_4* const name##_ppzw_fns[4] = {                                               \
        gen_helper_sve_##name##_ppzw_b, gen_helper_sve_##name##_ppzw_h, gen_helper_sve_##name##_ppzw_s, NULL}; \
    TRANS_FEAT(NAME##_ppzw, aa64_sve, do_ppzz_flags, a, name##_ppzw_fns[a->esz])
...
static bool do_ppzi_flags(DisasContext* s, arg_rpri_esz* a, gen_helper_gvec_flags_3* gen_fn)
{
    TCGv_ptr pd, zn, pg;
    unsigned vsz;
    TCGv_i32 t;
...
#define DO_PPZI(NAME, name)                                                      \
    static gen_helper_gvec_flags_3* const name##_ppzi_fns[4] = {                 \
        gen_helper_sve_##name##_ppzi_b,                                          \
        gen_helper_sve_##name##_ppzi_h,                                          \
        gen_helper_sve_##name##_ppzi_s,                                          \
        gen_helper_sve_##name##_ppzi_d,                                          \
    };                                                                           \
    TRANS_FEAT(NAME##_ppzi, aa64_sve, do_ppzi_flags, a, name##_ppzi_fns[a->esz])
...
static bool do_brk3(DisasContext* s, arg_rprr_s* a, gen_helper_gvec_4* fn, gen_helper_gvec_flags_4* fn_s)
{
    if (!sve_access_check(s)) { return true; }
...
static bool do_brk2(DisasContext* s, arg_rpr_s* a, gen_helper_gvec_3* fn, gen_helper_gvec_flags_3* fn_s)
{
    if (!sve_access_check(s)) { return true; }
...
TRANS_FEAT(BRKPA, aa64_sve, do_brk3, a, gen_helper_sve_brkpa, gen_helper_sve_brkpas)
TRANS_FEAT(BRKPB, aa64_sve, do_brk3, a, gen_helper_sve_brkpb, gen_helper_sve_brkpbs)

TRANS_FEAT(BRKA_m, aa64_sve, do_brk2, a, gen_helper_sve_brka_m, gen_helper_sve_brkas_m)
TRANS_FEAT(BRKB_m, aa64_sve, do_brk2, a, gen_helper_sve_brkb_m, gen_helper_sve_brkbs_m)

TRANS_FEAT(BRKA_z, aa64_sve, do_brk2, a, gen_helper_sve_brka_z, gen_helper_sve_brkas_z)
TRANS_FEAT(BRKB_z, aa64_sve, do_brk2, a, gen_helper_sve_brkb_z, gen_helper_sve_brkbs_z)

TRANS_FEAT(BRKN, aa64_sve, do_brk2, a, gen_helper_sve_brkn, gen_helper_sve_brkns)
...
{
    if (!dc_isar_feature(aa64_sve, s)) { return false; }
    if (sve_access_check(s)) { do_cntp(s, cpu_reg(s, a->rd), a->esz, a->rn, a->pg); }
    return true;
}
...
static bool trans_CNTP_c(DisasContext* s, arg_CNTP_c* a)
{
    ...
    if (dc_isar_feature(aa64_sve2p1, s)) {
        ...
        if (!sme_sm_enabled_check(s)) { return true; }
    }
    else {
        return false;
    }
    ...
    tcg_gen_ld16u_i32(t_png, tcg_env, pred_full_reg_offset(s, a->rn) ^ (HOST_BIG_ENDIAN ? 6 : 0));
...
static bool trans_INCDECP_r(DisasContext* s, arg_incdec_pred* a)
{
    ...
    if (sve_access_check(s)) {
        ...
        if (a->d) { tcg_gen_sub_i64(reg, reg, val); }
        else {
            tcg_gen_add_i64(reg, reg, val);
        }
    }
...
static bool trans_INCDECP_z(DisasContext* s, arg_incdec2_pred* a)
{
    ...
    if (sve_access_check(s)) {
        ...
        do_cntp(s, val, a->esz, a->pg, a->pg);
        gvec_fn(a->esz, vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), val, vsz, vsz);
    }
    return true;
}
...
static bool  do_WHILE(DisasContext* s, arg_while* a, bool lt, int scale, int data, gen_while_fn* fn)
{
...
TRANS_FEAT(WHILE_lt, aa64_sve, do_WHILE, a, true, 0, 0, gen_helper_sve_whilel)
TRANS_FEAT(WHILE_gt, aa64_sve2, do_WHILE, a, false, 0, 0, gen_helper_sve_whileg)

TRANS_FEAT(WHILE_lt_pair, aa64_sme2_or_sve2p1, do_WHILE, a, true, 1, 0, gen_helper_sve_while2l)
TRANS_FEAT(WHILE_gt_pair, aa64_sme2_or_sve2p1, do_WHILE, a, false, 1, 0, gen_helper_sve_while2g)

TRANS_FEAT(WHILE_lt_cnt2, aa64_sme2_or_sve2p1, do_WHILE, a, true, 1, 1, gen_helper_sve_whilecl)
TRANS_FEAT(WHILE_lt_cnt4, aa64_sme2_or_sve2p1, do_WHILE, a, true, 2, 2, gen_helper_sve_whilecl)
TRANS_FEAT(WHILE_gt_cnt2, aa64_sme2_or_sve2p1, do_WHILE, a, false, 1, 1, gen_helper_sve_whilecg)
TRANS_FEAT(WHILE_gt_cnt4, aa64_sme2_or_sve2p1, do_WHILE, a, false, 2, 2, gen_helper_sve_whilecg)
...
static bool trans_WHILE_ptr(DisasContext* s, arg_WHILE_ptr* a)
{
    ...
    if (!dc_isar_feature(aa64_sve2, s)) { return false; }
    if (!sve_access_check(s)) { return true; }
...
static bool trans_SUBR_zzi(DisasContext* s, arg_rri_esz* a)
{
    ...
    static const GVecGen2s op[4]        = {{.fni8         = tcg_gen_vec_sub8_i64,
    ...
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_2s(vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), vsz, vsz,
                        tcg_constant_i64(a->imm), &op[a->esz]);
    }
    return true;
}
...
{
    if (sve_access_check(s)) { do_sat_addsub_vec(s, a->esz, a->rd, a->rn, tcg_constant_i64(a->imm), u, d); }
    return true;
}
...
static bool do_zzi_ool(DisasContext* s, arg_rri_esz* a, gen_helper_gvec_2i* fn)
{
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_2i_ool(vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), tcg_constant_i64(a->imm), vsz,
                            vsz, 0, fn);
    }
    return true;
}
...
#define DO_ZZI(NAME, name)                                               \
    static gen_helper_gvec_2i* const name##i_fns[4] = {                  \
        gen_helper_sve_##name##i_b,                                      \
        gen_helper_sve_##name##i_h,                                      \
        gen_helper_sve_##name##i_s,                                      \
        gen_helper_sve_##name##i_d,                                      \
    };                                                                   \
...
static gen_helper_gvec_4* const dot_fns[2][2] = {{gen_helper_gvec_sdot_4b, gen_helper_gvec_sdot_4h},
                                                 {gen_helper_gvec_udot_4b, gen_helper_gvec_udot_4h}};
TRANS_FEAT(DOT_zzzz, aa64_sve, gen_gvec_ool_zzzz, dot_fns[a->u][a->sz], a->rd, a->rn, a->rm, a->ra, 0)

/*
 * SVE Multiply - Indexed
 */

TRANS_FEAT(SDOT_zzxw_4s, aa64_sve, gen_gvec_ool_arg_zzxz, gen_helper_gvec_sdot_idx_4b, a)
TRANS_FEAT(SDOT_zzxw_4d, aa64_sve, gen_gvec_ool_arg_zzxz, gen_helper_gvec_sdot_idx_4h, a)
TRANS_FEAT(UDOT_zzxw_4s, aa64_sve, gen_gvec_ool_arg_zzxz, gen_helper_gvec_udot_idx_4b, a)
TRANS_FEAT(UDOT_zzxw_4d, aa64_sve, gen_gvec_ool_arg_zzxz, gen_helper_gvec_udot_idx_4h, a)

TRANS_FEAT(SUDOT_zzxw_4s, aa64_sve_i8mm, gen_gvec_ool_arg_zzxz, gen_helper_gvec_sudot_idx_4b, a)
TRANS_FEAT(USDOT_zzxw_4s, aa64_sve_i8mm, gen_gvec_ool_arg_zzxz, gen_helper_gvec_usdot_idx_4b, a)

TRANS_FEAT(SDOT_zzxw_2s, aa64_sme2_or_sve2p1, gen_gvec_ool_arg_zzxz, gen_helper_gvec_sdot_idx_2h, a)
TRANS_FEAT(UDOT_zzxw_2s, aa64_sme2_or_sve2p1, gen_gvec_ool_arg_zzxz, gen_helper_gvec_udot_idx_2h, a)

#define DO_SVE2_RRX(NAME, FUNC) TRANS_FEAT(NAME, aa64_sve, gen_gvec_ool_zzz, FUNC, a->rd, a->rn, a->rm, a->index)
...
#define DO_SVE2_RRX_TB(NAME, FUNC, TOP)                                                            \
    TRANS_FEAT(NAME, aa64_sve, gen_gvec_ool_zzz, FUNC, a->rd, a->rn, a->rm, (a->index << 1) | TOP)
...
#define DO_SVE2_RRXR(NAME, FUNC) TRANS_FEAT(NAME, aa64_sve2, gen_gvec_ool_arg_zzxz, FUNC, a)
...
#define DO_SVE2_RRXR_TB(NAME, FUNC, TOP)                                                                    \
    TRANS_FEAT(NAME, aa64_sve2, gen_gvec_ool_zzzz, FUNC, a->rd, a->rn, a->rm, a->ra, (a->index << 1) | TOP)
...
#define DO_SVE2_RRXR_ROT(NAME, FUNC)                                                                           \
    TRANS_FEAT(NAME, aa64_sve2, gen_gvec_ool_zzzz, FUNC, a->rd, a->rn, a->rm, a->ra, (a->index << 2) | a->rot)
...
static bool do_fmla_zzxz(DisasContext* s, arg_rrxr_esz* a, gen_helper_gvec_4_ptr* fn)
{
    /* These insns use MO_8 to encode BFloat16 */
    if (a->esz == MO_8 && !dc_isar_feature(aa64_sve_b16b16, s)) { return false; }
    return gen_gvec_fpst_zzzz(s, fn, a->rd, a->rn, a->rm, a->ra, a->index, a->esz == MO_16 ? FPST_A64_F16 : FPST_A64);
}

static gen_helper_gvec_4_ptr* const fmla_idx_fns[4] = {gen_helper_gvec_bfmla_idx, gen_helper_gvec_fmla_idx_h,
...
TRANS_FEAT(FMLS_zzxz, aa64_sve, do_fmla_zzxz, a, fmls_idx_fns[a->esz][s->fpcr_ah])
...
static gen_helper_gvec_3_ptr* const fmul_idx_fns[4] = {
    gen_helper_gvec_fmul_idx_b16,
    gen_helper_gvec_fmul_idx_h,
    gen_helper_gvec_fmul_idx_s,
    gen_helper_gvec_fmul_idx_d,
};
TRANS_FEAT(FMUL_zzx, aa64_sve, gen_gvec_fpst_zzz, fmul_idx_fns[a->esz], a->rd, a->rn, a->rm, a->index,
...
typedef void gen_helper_fp_reduce(TCGv_i64, TCGv_ptr, TCGv_ptr, TCGv_ptr, TCGv_i32);

static bool do_reduce(DisasContext* s, arg_rpr_esz* a, gen_helper_fp_reduce* fn)
{
    unsigned vsz, p2vsz;
    TCGv_i32 t_desc;
...
#define DO_VPZ_AH(NAME, name)                                                                         \
    ...
    static gen_helper_fp_reduce* const name##_ah_fns[4] = {                                           \
        NULL,                                                                                         \
        gen_helper_sve_ah_##name##_h,                                                                 \
        gen_helper_sve_ah_##name##_s,                                                                 \
        gen_helper_sve_ah_##name##_d,                                                                 \
    };                                                                                                \
    TRANS_FEAT(NAME, aa64_sve, do_reduce, a, s->fpcr_ah ? name##_ah_fns[a->esz] : name##_fns[a->esz])
...
static gen_helper_gvec_3_ptr* const faddqv_fns[4] = {
    NULL,
    gen_helper_sve2p1_faddqv_h,
    gen_helper_sve2p1_faddqv_s,
    gen_helper_sve2p1_faddqv_d,
};
TRANS_FEAT(FADDQV, aa64_sme2p1_or_sve2p1, gen_gvec_fpst_arg_zpz, faddqv_fns[a->esz], a, 0,
           a->esz == MO_16 ? FPST_A64_F16 : FPST_A64)

static gen_helper_gvec_3_ptr* const fmaxnmqv_fns[4] = {
    NULL,
    gen_helper_sve2p1_fmaxnmqv_h,
    gen_helper_sve2p1_fmaxnmqv_s,
    gen_helper_sve2p1_fmaxnmqv_d,
};
TRANS_FEAT(FMAXNMQV, aa64_sme2p1_or_sve2p1, gen_gvec_fpst_arg_zpz, fmaxnmqv_fns[a->esz], a, 0,
           a->esz == MO_16 ? FPST_A64_F16 : FPST_A64)

static gen_helper_gvec_3_ptr* const fminnmqv_fns[4] = {
    NULL,
    gen_helper_sve2p1_fminnmqv_h,
    gen_helper_sve2p1_fminnmqv_s,
    gen_helper_sve2p1_fminnmqv_d,
};
TRANS_FEAT(FMINNMQV, aa64_sme2p1_or_sve2p1, gen_gvec_fpst_arg_zpz, fminnmqv_fns[a->esz], a, 0,
           a->esz == MO_16 ? FPST_A64_F16 : FPST_A64)

static gen_helper_gvec_3_ptr* const fmaxqv_fns[4] = {
    NULL,
    gen_helper_sve2p1_fmaxqv_h,
    gen_helper_sve2p1_fmaxqv_s,
    gen_helper_sve2p1_fmaxqv_d,
};
static gen_helper_gvec_3_ptr* const fmaxqv_ah_fns[4] = {
    NULL,
    gen_helper_sve2p1_ah_fmaxqv_h,
    gen_helper_sve2p1_ah_fmaxqv_s,
    gen_helper_sve2p1_ah_fmaxqv_d,
};
TRANS_FEAT(FMAXQV, aa64_sme2p1_or_sve2p1, gen_gvec_fpst_arg_zpz, (s->fpcr_ah ? fmaxqv_ah_fns : fmaxqv_fns)[a->esz], a,
           0, a->esz == MO_16 ? FPST_A64_F16 : FPST_A64)

static gen_helper_gvec_3_ptr* const fminqv_fns[4] = {
    NULL,
    gen_helper_sve2p1_fminqv_h,
    gen_helper_sve2p1_fminqv_s,
    gen_helper_sve2p1_fminqv_d,
};
static gen_helper_gvec_3_ptr* const fminqv_ah_fns[4] = {
    NULL,
    gen_helper_sve2p1_ah_fminqv_h,
    gen_helper_sve2p1_ah_fminqv_s,
    gen_helper_sve2p1_ah_fminqv_d,
};
TRANS_FEAT(FMINQV, aa64_sme2p1_or_sve2p1, gen_gvec_fpst_arg_zpz, (s->fpcr_ah ? fminqv_ah_fns : fminqv_fns)[a->esz], a,
           0, a->esz == MO_16 ? FPST_A64_F16 : FPST_A64)
...
TRANS_FEAT(FRECPE, aa64_sve, gen_gvec_fpst_ah_arg_zz,
           s->fpcr_ah&& dc_isar_feature(aa64_rpres, s) ? frecpe_rpres_fns[a->esz] : frecpe_fns[a->esz], a, 0)
...
TRANS_FEAT(FRSQRTE, aa64_sve, gen_gvec_fpst_ah_arg_zz,
           s->fpcr_ah&& dc_isar_feature(aa64_rpres, s) ? frsqrte_rpres_fns[a->esz] : frsqrte_fns[a->esz], a, 0)

/*
 *** SVE Floating Point Compare with Zero Group
 */

static bool do_ppz_fp(DisasContext* s, arg_rpr_esz* a, gen_helper_gvec_3_ptr* fn)
{
    if (fn == NULL) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz    = vec_full_reg_size(s);
        ...
        tcg_gen_gvec_3_ptr(pred_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn),
                           pred_full_reg_offset(s, a->pg), status, vsz, vsz, 0, fn);
    }
    return true;
}
...
TRANS_FEAT_NONSTREAMING(FTMAD, aa64_sve, gen_gvec_fpst_zzz, ftmad_fns[a->esz], a->rd, a->rn, a->rm,
                        a->imm | (s->fpcr_ah << 3), a->esz == MO_16 ? FPST_A64_F16 : FPST_A64)
...
{
    typedef void           fadda_fn(TCGv_i64, TCGv_i64, TCGv_ptr, TCGv_ptr, TCGv_ptr, TCGv_i32);
...
#define DO_FP3(NAME, name)                                                                                         \
    static gen_helper_gvec_3_ptr* const name##_fns[4] = {gen_helper_gvec_##name##_b16, gen_helper_gvec_##name##_h, \
                                                         gen_helper_gvec_##name##_s, gen_helper_gvec_##name##_d};  \
    TRANS_FEAT(NAME, aa64_sve, gen_gvec_fpst_arg_zzz, name##_fns[a->esz], a, 0)

#define DO_FP3_AH(NAME, name)                                                                                          \
    static gen_helper_gvec_3_ptr* const name##_fns[4] = {NULL, gen_helper_gvec_##name##_h, gen_helper_gvec_##name##_s, \
                                                         gen_helper_gvec_##name##_d};                                  \
    static gen_helper_gvec_3_ptr* const name##_ah_fns[4] = {                                                           \
        NULL, gen_helper_gvec_ah_##name##_h, gen_helper_gvec_ah_##name##_s, gen_helper_gvec_ah_##name##_d};            \
    TRANS_FEAT(NAME, aa64_sve, gen_gvec_fpst_ah_arg_zzz, s->fpcr_ah ? name##_ah_fns[a->esz] : name##_fns[a->esz], a, 0)
...
static gen_helper_gvec_3_ptr* const ftsmul_fns[4] = {NULL, gen_helper_gvec_ftsmul_h, gen_helper_gvec_ftsmul_s,
                                                     gen_helper_gvec_ftsmul_d};
TRANS_FEAT_NONSTREAMING(FTSMUL, aa64_sve, gen_gvec_fpst_arg_zzz, ftsmul_fns[a->esz], a, 0)
...
#define DO_ZPZZ_FP(NAME, FEAT, name)                                                                              \
    static gen_helper_gvec_4_ptr* const name##_zpzz_fns[4] = {NULL, gen_helper_##name##_h, gen_helper_##name##_s, \
                                                              gen_helper_##name##_d};                             \
...
#define DO_ZPZZ_AH_FP(NAME, FEAT, name, ah_name)                                                                      \
    static gen_helper_gvec_4_ptr* const name##_zpzz_fns[4]    = {NULL, gen_helper_##name##_h, gen_helper_##name##_s,  \
                                                                 gen_helper_##name##_d};                              \
    static gen_helper_gvec_4_ptr* const name##_ah_zpzz_fns[4] = {NULL, gen_helper_##ah_name##_h,                      \
                                                                 gen_helper_##ah_name##_s, gen_helper_##ah_name##_d}; \
    TRANS_FEAT(NAME, FEAT, gen_gvec_fpst_arg_zpzz, s->fpcr_ah ? name##_ah_zpzz_fns[a->esz] : name##_zpzz_fns[a->esz], a)

/* Similar, but for insns where sz == 0 encodes bfloat16 */
#define DO_ZPZZ_FP_B16(NAME, FEAT, name)                                                                      \
    static gen_helper_gvec_4_ptr* const name##_zpzz_fns[4] = {gen_helper_##name##_b16, gen_helper_##name##_h, \
...
#define DO_ZPZZ_AH_FP_B16(NAME, FEAT, name, ah_name)                                                                   \
    static gen_helper_gvec_4_ptr* const name##_zpzz_fns[4]    = {gen_helper_##name##_b16, gen_helper_##name##_h,       \
                                                                 gen_helper_##name##_s, gen_helper_##name##_d};        \
    static gen_helper_gvec_4_ptr* const name##_ah_zpzz_fns[4] = {gen_helper_##ah_name##_b16, gen_helper_##ah_name##_h, \
                                                                 gen_helper_##ah_name##_s, gen_helper_##ah_name##_d};  \
    TRANS_FEAT(NAME, FEAT, gen_gvec_fpst_arg_zpzz, s->fpcr_ah ? name##_ah_zpzz_fns[a->esz] : name##_zpzz_fns[a->esz], a)
...
typedef void gen_helper_sve_fp2scalar(TCGv_ptr, TCGv_ptr, TCGv_ptr, TCGv_i64, TCGv_ptr, TCGv_i32);

static void do_fp_scalar(DisasContext* s, int zd, int zn, int pg, bool is_fp16, TCGv_i64 scalar,
...
static bool do_fp_imm(DisasContext* s, arg_rpri_esz* a, uint64_t imm, gen_helper_sve_fp2scalar* fn)
{
    if (fn == NULL) { return false; }
    if (sve_access_check(s)) { do_fp_scalar(s, a->rd, a->rn, a->pg, a->esz == MO_16, tcg_constant_i64(imm), fn); }
    return true;
}

#define DO_FP_IMM(NAME, name, const0, const1)                                                                           \
    static gen_helper_sve_fp2scalar* const name##_fns[4]      = {NULL, gen_helper_sve_##name##_h,                       \
    ...
    TRANS_FEAT(NAME##_zpzi, aa64_sve, do_fp_imm, a, name##_const[a->esz][a->imm], name##_fns[a->esz])

#define DO_FP_AH_IMM(NAME, name, const0, const1)                                                                      \
    static gen_helper_sve_fp2scalar* const name##_fns[4]    = {NULL, gen_helper_sve_##name##_h,                       \
                                                               gen_helper_sve_##name##_s, gen_helper_sve_##name##_d}; \
    static gen_helper_sve_fp2scalar* const name##_ah_fns[4] = {                                                       \
        NULL, gen_helper_sve_ah_##name##_h, gen_helper_sve_ah_##name##_s, gen_helper_sve_ah_##name##_d};              \
    static uint64_t const name##_const[4][2] = {                                                                      \
        {-1, -1},                                                                                                     \
        {float16_##const0, float16_##const1},                                                                         \
        {float32_##const0, float32_##const1},                                                                         \
    ...
    TRANS_FEAT(NAME##_zpzi, aa64_sve, do_fp_imm, a, name##_const[a->esz][a->imm],                                     \
...
static bool do_fp_cmp(DisasContext* s, arg_rprr_esz* a, gen_helper_gvec_4_ptr* fn)
{
    if (fn == NULL) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz    = vec_full_reg_size(s);
        TCGv_ptr status = fpstatus_ptr(a->esz == MO_16 ? FPST_A64_F16 : FPST_A64);
        tcg_gen_gvec_4_ptr(pred_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), vec_full_reg_offset(s, a->rm),
                           pred_full_reg_offset(s, a->pg), status, vsz, vsz, 0, fn);
    }
    return true;
}
...
#define DO_FPCMP(NAME, name)                                                                                         \
    static gen_helper_gvec_4_ptr* const name##_fns[4] = {NULL, gen_helper_sve_##name##_h, gen_helper_sve_##name##_s, \
                                                         gen_helper_sve_##name##_d};                                 \
...
TRANS_FEAT(FCADD, aa64_sve, gen_gvec_fpst_zzzp, fcadd_fns[a->esz], a->rd, a->rn, a->rm, a->pg,
           a->rot | (s->fpcr_ah << 1), a->esz == MO_16 ? FPST_A64_F16 : FPST_A64)

static bool do_fmla_zpzzz(DisasContext* s, arg_rprrr_esz* a, gen_helper_gvec_5_ptr* fn)
{
    /* These insns use MO_8 to encode BFloat16 */
    if (a->esz == MO_8 && !dc_isar_feature(aa64_sve_b16b16, s)) { return false; }
    return gen_gvec_fpst_zzzzp(s, fn, a->rd, a->rn, a->rm, a->ra, a->pg, 0, a->esz == MO_16 ? FPST_A64_F16 : FPST_A64);
}

#define DO_FMLA(NAME, name, ah_name)                                                                                \
    static gen_helper_gvec_5_ptr* const name##_fns[4]    = {gen_helper_sve_##name##_b16, gen_helper_sve_##name##_h, \
                                                            gen_helper_sve_##name##_s, gen_helper_sve_##name##_d};  \
    static gen_helper_gvec_5_ptr* const name##_ah_fns[4] = {                                                        \
        gen_helper_sve_##ah_name##_b16, gen_helper_sve_##ah_name##_h, gen_helper_sve_##ah_name##_s,                 \
        gen_helper_sve_##ah_name##_d};                                                                              \
    TRANS_FEAT(NAME, aa64_sve, do_fmla_zpzzz, a, s->fpcr_ah ? name##_ah_fns[a->esz] : name##_fns[a->esz])
...
TRANS_FEAT(FCMLA_zpzzz, aa64_sve, gen_gvec_fpst_zzzzp, fcmla_fns[a->esz], a->rd, a->rn, a->rm, a->ra, a->pg,
           a->rot | (s->fpcr_ah << 2), a->esz == MO_16 ? FPST_A64_F16 : FPST_A64)

static gen_helper_gvec_4_ptr* const fcmla_idx_fns[4] = {NULL, gen_helper_gvec_fcmlah_idx, gen_helper_gvec_fcmlas_idx,
                                                        NULL};
TRANS_FEAT(FCMLA_zzxz, aa64_sve, gen_gvec_fpst_zzzz, fcmla_idx_fns[a->esz], a->rd, a->rn, a->rm, a->ra,
           a->index * 4 + a->rot, a->esz == MO_16 ? FPST_A64_F16 : FPST_A64)

/*
 *** SVE Floating Point Unary Operations Predicated Group
 */

TRANS_FEAT(FCVT_sh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_sh, a, 0, FPST_A64)
TRANS_FEAT(FCVT_hs, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_hs, a, 0, FPST_A64_F16)

TRANS_FEAT(BFCVT, aa64_sve_bf16, gen_gvec_fpst_arg_zpz, gen_helper_sve_bfcvt, a, 0, s->fpcr_ah ? FPST_AH : FPST_A64)

TRANS_FEAT(FCVT_dh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_dh, a, 0, FPST_A64)
TRANS_FEAT(FCVT_hd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_hd, a, 0, FPST_A64_F16)
TRANS_FEAT(FCVT_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_ds, a, 0, FPST_A64)
TRANS_FEAT(FCVT_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_sd, a, 0, FPST_A64)

TRANS_FEAT(FCVTZS_hh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_hh, a, 0, FPST_A64_F16)
TRANS_FEAT(FCVTZU_hh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_hh, a, 0, FPST_A64_F16)
TRANS_FEAT(FCVTZS_hs, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_hs, a, 0, FPST_A64_F16)
TRANS_FEAT(FCVTZU_hs, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_hs, a, 0, FPST_A64_F16)
TRANS_FEAT(FCVTZS_hd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_hd, a, 0, FPST_A64_F16)
TRANS_FEAT(FCVTZU_hd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_hd, a, 0, FPST_A64_F16)

TRANS_FEAT(FCVTZS_ss, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_ss, a, 0, FPST_A64)
TRANS_FEAT(FCVTZU_ss, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_ss, a, 0, FPST_A64)
TRANS_FEAT(FCVTZS_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_sd, a, 0, FPST_A64)
TRANS_FEAT(FCVTZU_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_sd, a, 0, FPST_A64)
TRANS_FEAT(FCVTZS_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_ds, a, 0, FPST_A64)
TRANS_FEAT(FCVTZU_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_ds, a, 0, FPST_A64)

TRANS_FEAT(FCVTZS_dd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_dd, a, 0, FPST_A64)
TRANS_FEAT(FCVTZU_dd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_dd, a, 0, FPST_A64)

static gen_helper_gvec_3_ptr* const frint_fns[] = {NULL, gen_helper_sve_frint_h, gen_helper_sve_frint_s,
                                                   gen_helper_sve_frint_d};
TRANS_FEAT(FRINTI, aa64_sve, gen_gvec_fpst_arg_zpz, frint_fns[a->esz], a, 0, a->esz == MO_16 ? FPST_A64_F16 : FPST_A64)

static gen_helper_gvec_3_ptr* const frintx_fns[] = {NULL, gen_helper_sve_frintx_h, gen_helper_sve_frintx_s,
                                                    gen_helper_sve_frintx_d};
TRANS_FEAT(FRINTX, aa64_sve, gen_gvec_fpst_arg_zpz, frintx_fns[a->esz], a, 0,
           a->esz == MO_16 ? FPST_A64_F16 : FPST_A64);

static bool do_frint_mode(DisasContext* s, arg_rpr_esz* a, ARMFPRounding mode, gen_helper_gvec_3_ptr* fn)
{
    unsigned vsz;
    TCGv_i32 tmode;
    TCGv_ptr status;
    ...
    tcg_gen_gvec_3_ptr(vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), pred_full_reg_offset(s, a->pg),
                       status, vsz, vsz, 0, fn);
...
TRANS_FEAT(FRINTN, aa64_sve, do_frint_mode, a, FPROUNDING_TIEEVEN, frint_fns[a->esz])
TRANS_FEAT(FRINTP, aa64_sve, do_frint_mode, a, FPROUNDING_POSINF, frint_fns[a->esz])
TRANS_FEAT(FRINTM, aa64_sve, do_frint_mode, a, FPROUNDING_NEGINF, frint_fns[a->esz])
TRANS_FEAT(FRINTZ, aa64_sve, do_frint_mode, a, FPROUNDING_ZERO, frint_fns[a->esz])
TRANS_FEAT(FRINTA, aa64_sve, do_frint_mode, a, FPROUNDING_TIEAWAY, frint_fns[a->esz])
...
TRANS_FEAT(FRECPX, aa64_sve, gen_gvec_fpst_arg_zpz, frecpx_fns[a->esz], a, 0, select_ah_fpst(s, a->esz))
...
TRANS_FEAT(FSQRT, aa64_sve, gen_gvec_fpst_arg_zpz, fsqrt_fns[a->esz], a, 0, a->esz == MO_16 ? FPST_A64_F16 : FPST_A64)

TRANS_FEAT(SCVTF_hh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_hh, a, 0, FPST_A64_F16)
TRANS_FEAT(SCVTF_sh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_sh, a, 0, FPST_A64_F16)
TRANS_FEAT(SCVTF_dh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_dh, a, 0, FPST_A64_F16)

TRANS_FEAT(SCVTF_ss, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_ss, a, 0, FPST_A64)
TRANS_FEAT(SCVTF_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_ds, a, 0, FPST_A64)

TRANS_FEAT(SCVTF_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_sd, a, 0, FPST_A64)
TRANS_FEAT(SCVTF_dd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_dd, a, 0, FPST_A64)

TRANS_FEAT(UCVTF_hh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_hh, a, 0, FPST_A64_F16)
TRANS_FEAT(UCVTF_sh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_sh, a, 0, FPST_A64_F16)
TRANS_FEAT(UCVTF_dh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_dh, a, 0, FPST_A64_F16)

TRANS_FEAT(UCVTF_ss, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_ss, a, 0, FPST_A64)
TRANS_FEAT(UCVTF_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_ds, a, 0, FPST_A64)
TRANS_FEAT(UCVTF_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_sd, a, 0, FPST_A64)

TRANS_FEAT(UCVTF_dd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_dd, a, 0, FPST_A64)
...
void gen_sve_ldr(DisasContext* s, TCGv_ptr base, int vofs, int len, int rn, int imm, MemOp align)
{
    ...
    if (nparts <= 4) {
        ...
        for (i = 0; i < len_align; i += 16) {
            tcg_gen_qemu_ld_i128(t16, clean_addr, midx, MO_LE | MO_128 | MO_ATOM_NONE | align);
            tcg_gen_extr_i128_i64(t0, t1, t16);
            tcg_gen_st_i64(t0, base, vofs + i);
            tcg_gen_st_i64(t1, base, vofs + i + 8);
            tcg_gen_addi_i64(clean_addr, clean_addr, 16);
        }
        if (len_align) { align = MO_UNALN; }
    }
    else {
    ...
    if (len_remain >= 8) {
        t0 = tcg_temp_new_i64();
        tcg_gen_qemu_ld_i64(t0, clean_addr, midx, MO_LEUQ | MO_ATOM_NONE | align);
        align = MO_UNALN;
        tcg_gen_st_i64(t0, base, vofs + len_align);
        len_remain -= 8;
        len_align  += 8;
        if (len_remain) { tcg_gen_addi_i64(clean_addr, clean_addr, 8); }
    }
    if (len_remain) {
        t0 = tcg_temp_new_i64();
        switch (len_remain) {
            case 2:
            case 4:
            case 8: tcg_gen_qemu_ld_i64(t0, clean_addr, midx, MO_LE | ctz32(len_remain) | MO_ATOM_NONE | align); break;

            case 6:
                t1 = tcg_temp_new_i64();
                tcg_gen_qemu_ld_i64(t0, clean_addr, midx, MO_LEUL | MO_ATOM_NONE | align);
...
void gen_sve_str(DisasContext* s, TCGv_ptr base, int vofs, int len, int rn, int imm, MemOp align)
{
    int       len_align  = QEMU_ALIGN_DOWN(len, 16);
    int       len_remain = len % 16;
    int       nparts     = len / 16 + ctpop8(len_remain);
    ...
    if (nparts <= 4) {
        ...
        for (i = 0; i < len_align; i += 16) {
            ...
            tcg_gen_qemu_st_i128(t16, clean_addr, midx, MO_LE | MO_128 | MO_ATOM_NONE | align);
            tcg_gen_addi_i64(clean_addr, clean_addr, 16);
        }
        if (len_align) { align = MO_UNALN; }
    }
        ...
        tcg_gen_qemu_st_i128(t16, clean_addr, midx, MO_LE | MO_128 | MO_ATOM_NONE);
        tcg_gen_addi_i64(clean_addr, clean_addr, 16);
    ...
    if (len_remain >= 8) {
        ...
        tcg_gen_qemu_st_i64(t0, clean_addr, midx, MO_LEUQ | MO_ATOM_NONE | align);
        align       = MO_UNALN;
        len_remain -= 8;
        len_align  += 8;
        if (len_remain) { tcg_gen_addi_i64(clean_addr, clean_addr, 8); }
    ...
    if (len_remain) {
        ...
        switch (len_remain) {
            case 2:
            case 4:
            case 8: tcg_gen_qemu_st_i64(t0, clean_addr, midx, MO_LE | ctz32(len_remain) | MO_ATOM_NONE | align); break;

            case 6:
                tcg_gen_qemu_st_i64(t0, clean_addr, midx, MO_LEUL | MO_ATOM_NONE | align);
                tcg_gen_addi_i64(clean_addr, clean_addr, 4);
...
static bool trans_LDR_zri(DisasContext* s, arg_rri* a)
{
    ...
    if (sve_access_check(s)) {
        ...
        gen_sve_ldr(s, tcg_env, off, size, a->rn, a->imm * size, s->align_mem ? MO_ALIGN_16 : MO_UNALN);
    }
    return true;
}
...
static bool trans_LDR_pri(DisasContext* s, arg_rri* a)
{
    ...
    if (sve_access_check(s)) {
        ...
        gen_sve_ldr(s, tcg_env, off, size, a->rn, a->imm * size, s->align_mem ? MO_ALIGN_2 : MO_UNALN);
    }
    return true;
}
...
static bool trans_STR_zri(DisasContext* s, arg_rri* a)
{
    ...
    if (sve_access_check(s)) {
        int size = vec_full_reg_size(s);
        int off  = vec_full_reg_offset(s, a->rd);
        gen_sve_str(s, tcg_env, off, size, a->rn, a->imm * size, s->align_mem ? MO_ALIGN_16 : MO_UNALN);
    }
    return true;
}
...
static bool trans_STR_pri(DisasContext* s, arg_rri* a)
{
    ...
    if (sve_access_check(s)) {
        int size = pred_full_reg_size(s);
        int off  = pred_full_reg_offset(s, a->rd);
        gen_sve_str(s, tcg_env, off, size, a->rn, a->imm * size, s->align_mem ? MO_ALIGN_2 : MO_UNALN);
    }
    return true;
}
...
uint64_t make_svemte_desc(DisasContext* s, unsigned vsz, uint32_t nregs, uint32_t msz, bool is_write, uint32_t data)
{
    uint32_t sizem1;
    uint64_t desc = 0;
...
static void do_mem_zpa(DisasContext* s, int zt, int pg, TCGv_i64 addr, int dtype, uint32_t nregs, bool is_write,
                       gen_helper_gvec_mem* fn)
{
     ...
     */
    desc = make_svemte_desc(s, vec_full_reg_size(s), nregs, dtype_msz(dtype), is_write, zt);
    t_pg = tcg_temp_new_ptr();
...
static gen_helper_gvec_mem* const ldr_fns[2][2][19][4] = {
    {
        ...
        {
            {gen_helper_sve_ld1bb_r, gen_helper_sve_ld2bb_r, gen_helper_sve_ld3bb_r, gen_helper_sve_ld4bb_r},
            {gen_helper_sve_ld1bhu_r, NULL, NULL, NULL},
            {gen_helper_sve_ld1bsu_r, NULL, NULL, NULL},
            {gen_helper_sve_ld1bdu_r, NULL, NULL, NULL},

            {gen_helper_sve_ld1sds_le_r, NULL, NULL, NULL},
            {gen_helper_sve_ld1hh_le_r, gen_helper_sve_ld2hh_le_r, gen_helper_sve_ld3hh_le_r,
            ...
            {gen_helper_sve_ld1ss_le_r, gen_helper_sve_ld2ss_le_r, gen_helper_sve_ld3ss_le_r,
            ...
            {gen_helper_sve_ld1dd_le_r, gen_helper_sve_ld2dd_le_r, gen_helper_sve_ld3dd_le_r,
             gen_helper_sve_ld4dd_le_r},

            {gen_helper_sve_ld1squ_le_r, NULL, NULL, NULL},
            {gen_helper_sve_ld1dqu_le_r, NULL, NULL, NULL},
            {NULL, gen_helper_sve_ld2qq_le_r, gen_helper_sve_ld3qq_le_r, gen_helper_sve_ld4qq_le_r},
        },
        ...
        /* mte inactive, big-endian */
        {
            ...
            {gen_helper_sve_ld1hh_be_r, gen_helper_sve_ld2hh_be_r, gen_helper_sve_ld3hh_be_r,
            ...
            {gen_helper_sve_ld1ss_be_r, gen_helper_sve_ld2ss_be_r, gen_helper_sve_ld3ss_be_r,
            ...
            {gen_helper_sve_ld1bss_r, NULL, NULL, NULL},
            {gen_helper_sve_ld1bhs_r, NULL, NULL, NULL},
            {gen_helper_sve_ld1dd_be_r, gen_helper_sve_ld2dd_be_r, gen_helper_sve_ld3dd_be_r,
             gen_helper_sve_ld4dd_be_r},

            {gen_helper_sve_ld1squ_be_r, NULL, NULL, NULL},
            {gen_helper_sve_ld1dqu_be_r, NULL, NULL, NULL},
            {NULL, gen_helper_sve_ld2qq_be_r, gen_helper_sve_ld3qq_be_r, gen_helper_sve_ld4qq_be_r},
        },
    },

    {
        ...
        {
            {gen_helper_sve_ld1bb_r_mte, gen_helper_sve_ld2bb_r_mte, gen_helper_sve_ld3bb_r_mte,
            ...
            {gen_helper_sve_ld1hh_le_r_mte, gen_helper_sve_ld2hh_le_r_mte, gen_helper_sve_ld3hh_le_r_mte,
            ...
            {gen_helper_sve_ld1ss_le_r_mte, gen_helper_sve_ld2ss_le_r_mte, gen_helper_sve_ld3ss_le_r_mte,
            ...
            {gen_helper_sve_ld1dd_le_r_mte, gen_helper_sve_ld2dd_le_r_mte, gen_helper_sve_ld3dd_le_r_mte,
             gen_helper_sve_ld4dd_le_r_mte},

            {gen_helper_sve_ld1squ_le_r_mte, NULL, NULL, NULL},
            {gen_helper_sve_ld1dqu_le_r_mte, NULL, NULL, NULL},
            {NULL, gen_helper_sve_ld2qq_le_r_mte, gen_helper_sve_ld3qq_le_r_mte, gen_helper_sve_ld4qq_le_r_mte},
        },
        ...
        /* mte active, big-endian */
        {
            ...
            {gen_helper_sve_ld1hh_be_r_mte, gen_helper_sve_ld2hh_be_r_mte, gen_helper_sve_ld3hh_be_r_mte,
            ...
            {gen_helper_sve_ld1ss_be_r_mte, gen_helper_sve_ld2ss_be_r_mte, gen_helper_sve_ld3ss_be_r_mte,
            ...
            {gen_helper_sve_ld1bss_r_mte, NULL, NULL, NULL},
            {gen_helper_sve_ld1bhs_r_mte, NULL, NULL, NULL},
            {gen_helper_sve_ld1dd_be_r_mte, gen_helper_sve_ld2dd_be_r_mte, gen_helper_sve_ld3dd_be_r_mte,
             gen_helper_sve_ld4dd_be_r_mte},

            {gen_helper_sve_ld1squ_be_r_mte, NULL, NULL, NULL},
            {gen_helper_sve_ld1dqu_be_r_mte, NULL, NULL, NULL},
            {NULL, gen_helper_sve_ld2qq_be_r_mte, gen_helper_sve_ld3qq_be_r_mte, gen_helper_sve_ld4qq_be_r_mte},
        },
    },
};

static void do_ld_zpa(DisasContext* s, int zt, int pg, TCGv_i64 addr, int dtype, int nreg)
{
    gen_helper_gvec_mem* fn = ldr_fns[s->mte_active[0]][s->be_data == MO_BE][dtype][nreg];
...
static bool trans_LD_zprr(DisasContext* s, arg_rprr_load* a)
{
    ...
    switch (a->dtype) {
        ...
        case 16:
        case 17:
            if (!dc_isar_feature(aa64_sve2p1, s)) { return false; }
            s->is_nonstreaming = true;
            break;
        case 18:
            if (!dc_isar_feature(aa64_sme2p1_or_sve2p1, s)) { return false; }
...
static bool trans_LD_zpri(DisasContext* s, arg_rpri_load* a)
{
    ...
    if (sve_access_check(s)) {
        ...
        tcg_gen_addi_i64(addr, cpu_reg_sp(s, a->rn), (a->imm * elements * (a->nreg + 1)) << dtype_msz(a->dtype));
        do_ld_zpa(s, a->rd, a->pg, addr, a->dtype, a->nreg);
    }
    return true;
}
...
static bool trans_LDFF1_zprr(DisasContext* s, arg_rprr_load* a)
{
    static gen_helper_gvec_mem* const fns[2][2][16] = {
        {/* mte inactive, little-endian */
         {gen_helper_sve_ldff1bb_r, gen_helper_sve_ldff1bhu_r, gen_helper_sve_ldff1bsu_r, gen_helper_sve_ldff1bdu_r,

          gen_helper_sve_ldff1sds_le_r, gen_helper_sve_ldff1hh_le_r, gen_helper_sve_ldff1hsu_le_r,
          gen_helper_sve_ldff1hdu_le_r, gen_helper_sve_ldff1hds_le_r, gen_helper_sve_ldff1hss_le_r,
          gen_helper_sve_ldff1ss_le_r, gen_helper_sve_ldff1sdu_le_r, gen_helper_sve_ldff1bds_r,
          gen_helper_sve_ldff1bss_r, gen_helper_sve_ldff1bhs_r, gen_helper_sve_ldff1dd_le_r},

         /* mte inactive, big-endian */
         {gen_helper_sve_ldff1bb_r, gen_helper_sve_ldff1bhu_r, gen_helper_sve_ldff1bsu_r, gen_helper_sve_ldff1bdu_r,

          gen_helper_sve_ldff1sds_be_r, gen_helper_sve_ldff1hh_be_r, gen_helper_sve_ldff1hsu_be_r,
          gen_helper_sve_ldff1hdu_be_r, gen_helper_sve_ldff1hds_be_r, gen_helper_sve_ldff1hss_be_r,
          gen_helper_sve_ldff1ss_be_r, gen_helper_sve_ldff1sdu_be_r, gen_helper_sve_ldff1bds_r,
          gen_helper_sve_ldff1bss_r, gen_helper_sve_ldff1bhs_r, gen_helper_sve_ldff1dd_be_r}},

        {/* mte active, little-endian */
         {gen_helper_sve_ldff1bb_r_mte, gen_helper_sve_ldff1bhu_r_mte, gen_helper_sve_ldff1bsu_r_mte,
          gen_helper_sve_ldff1bdu_r_mte, gen_helper_sve_ldff1sds_le_r_mte, gen_helper_sve_ldff1hh_le_r_mte,
          gen_helper_sve_ldff1hsu_le_r_mte, gen_helper_sve_ldff1hdu_le_r_mte, gen_helper_sve_ldff1hds_le_r_mte,
          gen_helper_sve_ldff1hss_le_r_mte, gen_helper_sve_ldff1ss_le_r_mte, gen_helper_sve_ldff1sdu_le_r_mte,

          gen_helper_sve_ldff1bds_r_mte, gen_helper_sve_ldff1bss_r_mte, gen_helper_sve_ldff1bhs_r_mte,
          gen_helper_sve_ldff1dd_le_r_mte},

         /* mte active, big-endian */
         {gen_helper_sve_ldff1bb_r_mte, gen_helper_sve_ldff1bhu_r_mte, gen_helper_sve_ldff1bsu_r_mte,
          gen_helper_sve_ldff1bdu_r_mte, gen_helper_sve_ldff1sds_be_r_mte, gen_helper_sve_ldff1hh_be_r_mte,
          gen_helper_sve_ldff1hsu_be_r_mte, gen_helper_sve_ldff1hdu_be_r_mte, gen_helper_sve_ldff1hds_be_r_mte,
          gen_helper_sve_ldff1hss_be_r_mte, gen_helper_sve_ldff1ss_be_r_mte, gen_helper_sve_ldff1sdu_be_r_mte,
    ...
    if (sve_access_check(s)) {
        ...
        tcg_gen_shli_i64(addr, cpu_reg(s, a->rm), dtype_msz(a->dtype));
        tcg_gen_add_i64(addr, addr, cpu_reg_sp(s, a->rn));
        do_mem_zpa(s, a->rd, a->pg, addr, a->dtype, 1, false, fns[s->mte_active[0]][s->be_data == MO_BE][a->dtype]);
    }
    return true;
}
...
static bool trans_LDNF1_zpri(DisasContext* s, arg_rpri_load* a)
{
    static gen_helper_gvec_mem* const fns[2][2][16] = {
        {/* mte inactive, little-endian */
         {gen_helper_sve_ldnf1bb_r, gen_helper_sve_ldnf1bhu_r, gen_helper_sve_ldnf1bsu_r, gen_helper_sve_ldnf1bdu_r,

          gen_helper_sve_ldnf1sds_le_r, gen_helper_sve_ldnf1hh_le_r, gen_helper_sve_ldnf1hsu_le_r,
          gen_helper_sve_ldnf1hdu_le_r, gen_helper_sve_ldnf1hds_le_r, gen_helper_sve_ldnf1hss_le_r,
          gen_helper_sve_ldnf1ss_le_r, gen_helper_sve_ldnf1sdu_le_r, gen_helper_sve_ldnf1bds_r,
          gen_helper_sve_ldnf1bss_r, gen_helper_sve_ldnf1bhs_r, gen_helper_sve_ldnf1dd_le_r},

         /* mte inactive, big-endian */
         {gen_helper_sve_ldnf1bb_r, gen_helper_sve_ldnf1bhu_r, gen_helper_sve_ldnf1bsu_r, gen_helper_sve_ldnf1bdu_r,

          gen_helper_sve_ldnf1sds_be_r, gen_helper_sve_ldnf1hh_be_r, gen_helper_sve_ldnf1hsu_be_r,
          gen_helper_sve_ldnf1hdu_be_r, gen_helper_sve_ldnf1hds_be_r, gen_helper_sve_ldnf1hss_be_r,
          gen_helper_sve_ldnf1ss_be_r, gen_helper_sve_ldnf1sdu_be_r, gen_helper_sve_ldnf1bds_r,
          gen_helper_sve_ldnf1bss_r, gen_helper_sve_ldnf1bhs_r, gen_helper_sve_ldnf1dd_be_r}},

        {/* mte inactive, little-endian */
         {gen_helper_sve_ldnf1bb_r_mte, gen_helper_sve_ldnf1bhu_r_mte, gen_helper_sve_ldnf1bsu_r_mte,
          gen_helper_sve_ldnf1bdu_r_mte, gen_helper_sve_ldnf1sds_le_r_mte, gen_helper_sve_ldnf1hh_le_r_mte,
          gen_helper_sve_ldnf1hsu_le_r_mte, gen_helper_sve_ldnf1hdu_le_r_mte, gen_helper_sve_ldnf1hds_le_r_mte,
          gen_helper_sve_ldnf1hss_le_r_mte, gen_helper_sve_ldnf1ss_le_r_mte, gen_helper_sve_ldnf1sdu_le_r_mte,

          gen_helper_sve_ldnf1bds_r_mte, gen_helper_sve_ldnf1bss_r_mte, gen_helper_sve_ldnf1bhs_r_mte,
          gen_helper_sve_ldnf1dd_le_r_mte},

         /* mte inactive, big-endian */
         {gen_helper_sve_ldnf1bb_r_mte, gen_helper_sve_ldnf1bhu_r_mte, gen_helper_sve_ldnf1bsu_r_mte,
          gen_helper_sve_ldnf1bdu_r_mte, gen_helper_sve_ldnf1sds_be_r_mte, gen_helper_sve_ldnf1hh_be_r_mte,
          gen_helper_sve_ldnf1hsu_be_r_mte, gen_helper_sve_ldnf1hdu_be_r_mte, gen_helper_sve_ldnf1hds_be_r_mte,
          gen_helper_sve_ldnf1hss_be_r_mte, gen_helper_sve_ldnf1ss_be_r_mte, gen_helper_sve_ldnf1sdu_be_r_mte,
...
static void do_ldrq(DisasContext* s, int zt, int pg, TCGv_i64 addr, int dtype)
{
    ...
    gen_helper_gvec_mem* fn = ldr_fns[s->mte_active[0]][s->be_data == MO_BE][dtype][0];
...
{
    if (a->rm == 31 || !dc_isar_feature(aa64_sve, s)) { return false; }
    if (sve_access_check(s)) {
...
static void do_ldro(DisasContext* s, int zt, int pg, TCGv_i64 addr, int dtype)
{
    ...
    if (vsz >= 64) { tcg_gen_gvec_dup_mem(5, doff + 32, doff, vsz_r32 - 32, vsz_r32 - 32); }
    vsz -= vsz_r32;
    if (vsz) { tcg_gen_gvec_dup_imm(MO_64, doff + vsz_r32, vsz, vsz, 0); }
}

static bool trans_LD1RO_zprr(DisasContext* s, arg_rprr_load* a)
{
    if (!dc_isar_feature(aa64_sve_f64mm, s)) { return false; }
    if (a->rm == 31) { return false; }
    s->is_nonstreaming = true;
    if (sve_access_check(s)) {
        TCGv_i64 addr = tcg_temp_new_i64();
...
static bool trans_LD1R_zpri(DisasContext* s, arg_rpri_load* a)
{
    ...
    tcg_gen_gvec_dup_i64(esz, vec_full_reg_offset(s, a->rd), vsz, vsz, temp);
...
static void do_st_zpa(DisasContext* s, int zt, int pg, TCGv_i64 addr, int msz, int esz, int nreg)
{
    static gen_helper_gvec_mem* const fn_single[2][2][4][5] = {
        {{{gen_helper_sve_st1bb_r, gen_helper_sve_st1bh_r, gen_helper_sve_st1bs_r, gen_helper_sve_st1bd_r},
          {NULL, gen_helper_sve_st1hh_le_r, gen_helper_sve_st1hs_le_r, gen_helper_sve_st1hd_le_r},
          {
              NULL,
              NULL,
         ...
         {{gen_helper_sve_st1bb_r, gen_helper_sve_st1bh_r, gen_helper_sve_st1bs_r, gen_helper_sve_st1bd_r},
          {NULL, gen_helper_sve_st1hh_be_r, gen_helper_sve_st1hs_be_r, gen_helper_sve_st1hd_be_r},
          {NULL, NULL, gen_helper_sve_st1ss_be_r, gen_helper_sve_st1sd_be_r, gen_helper_sve_st1sq_be_r},
          {NULL, NULL, NULL, gen_helper_sve_st1dd_be_r, gen_helper_sve_st1dq_be_r}}},

        {{{gen_helper_sve_st1bb_r_mte, gen_helper_sve_st1bh_r_mte, gen_helper_sve_st1bs_r_mte,
           gen_helper_sve_st1bd_r_mte},
          {NULL, gen_helper_sve_st1hh_le_r_mte, gen_helper_sve_st1hs_le_r_mte, gen_helper_sve_st1hd_le_r_mte},
          {NULL, NULL, gen_helper_sve_st1ss_le_r_mte, gen_helper_sve_st1sd_le_r_mte, gen_helper_sve_st1sq_le_r_mte},
          {NULL, NULL, NULL, gen_helper_sve_st1dd_le_r_mte, gen_helper_sve_st1dq_le_r_mte}},
         {{gen_helper_sve_st1bb_r_mte, gen_helper_sve_st1bh_r_mte, gen_helper_sve_st1bs_r_mte,
           gen_helper_sve_st1bd_r_mte},
          {NULL, gen_helper_sve_st1hh_be_r_mte, gen_helper_sve_st1hs_be_r_mte, gen_helper_sve_st1hd_be_r_mte},
          {NULL, NULL, gen_helper_sve_st1ss_be_r_mte, gen_helper_sve_st1sd_be_r_mte, gen_helper_sve_st1sq_be_r_mte},
          {NULL, NULL, NULL, gen_helper_sve_st1dd_be_r_mte, gen_helper_sve_st1dq_be_r_mte}}},
    };
    static gen_helper_gvec_mem* const fn_multiple[2][2][3][5] = {
        {{{gen_helper_sve_st2bb_r, gen_helper_sve_st2hh_le_r, gen_helper_sve_st2ss_le_r, gen_helper_sve_st2dd_le_r,
           gen_helper_sve_st2qq_le_r},
          {gen_helper_sve_st3bb_r, gen_helper_sve_st3hh_le_r, gen_helper_sve_st3ss_le_r, gen_helper_sve_st3dd_le_r,
           gen_helper_sve_st3qq_le_r},
          {gen_helper_sve_st4bb_r, gen_helper_sve_st4hh_le_r, gen_helper_sve_st4ss_le_r, gen_helper_sve_st4dd_le_r,
           gen_helper_sve_st4qq_le_r}},
         {{gen_helper_sve_st2bb_r, gen_helper_sve_st2hh_be_r, gen_helper_sve_st2ss_be_r, gen_helper_sve_st2dd_be_r,
           gen_helper_sve_st2qq_be_r},
          {gen_helper_sve_st3bb_r, gen_helper_sve_st3hh_be_r, gen_helper_sve_st3ss_be_r, gen_helper_sve_st3dd_be_r,
           gen_helper_sve_st3qq_be_r},
          {gen_helper_sve_st4bb_r, gen_helper_sve_st4hh_be_r, gen_helper_sve_st4ss_be_r, gen_helper_sve_st4dd_be_r,
           gen_helper_sve_st4qq_be_r}}},
        {{{gen_helper_sve_st2bb_r_mte, gen_helper_sve_st2hh_le_r_mte, gen_helper_sve_st2ss_le_r_mte,
           gen_helper_sve_st2dd_le_r_mte, gen_helper_sve_st2qq_le_r_mte},
          {gen_helper_sve_st3bb_r_mte, gen_helper_sve_st3hh_le_r_mte, gen_helper_sve_st3ss_le_r_mte,
           gen_helper_sve_st3dd_le_r_mte, gen_helper_sve_st3qq_le_r_mte},
          {gen_helper_sve_st4bb_r_mte, gen_helper_sve_st4hh_le_r_mte, gen_helper_sve_st4ss_le_r_mte,
           gen_helper_sve_st4dd_le_r_mte, gen_helper_sve_st4qq_le_r_mte}},
         {{gen_helper_sve_st2bb_r_mte, gen_helper_sve_st2hh_be_r_mte, gen_helper_sve_st2ss_be_r_mte,
           gen_helper_sve_st2dd_be_r_mte, gen_helper_sve_st2qq_be_r_mte},
          {gen_helper_sve_st3bb_r_mte, gen_helper_sve_st3hh_be_r_mte, gen_helper_sve_st3ss_be_r_mte,
           gen_helper_sve_st3dd_be_r_mte, gen_helper_sve_st3qq_be_r_mte},
          {gen_helper_sve_st4bb_r_mte, gen_helper_sve_st4hh_be_r_mte, gen_helper_sve_st4ss_be_r_mte,
           gen_helper_sve_st4dd_be_r_mte, gen_helper_sve_st4qq_be_r_mte}}},
    };
    gen_helper_gvec_mem* fn;
...
{
    if (a->rm == 31 || a->msz > a->esz) { return false; }
    switch (a->esz) {
        case MO_8 ... MO_64:
            if (!dc_isar_feature(aa64_sve, s)) { return false; }
            break;
...
static bool trans_ST_zpri(DisasContext* s, arg_rpri_store* a)
{
    ...
    if (sve_access_check(s)) {
        ...
        tcg_gen_addi_i64(addr, cpu_reg_sp(s, a->rn), (a->imm * elements * (a->nreg + 1)) << a->msz);
        do_st_zpa(s, a->rd, a->pg, addr, a->msz, a->esz, a->nreg);
    }
    return true;
}
...
static void do_mem_zpz(DisasContext* s, int zt, int pg, int zm, int scale, TCGv_i64 scalar, int msz, bool is_write,
...
static gen_helper_gvec_mem_scatter* const gather_load_fn32[2][2][2][2][2][3] = {
    { /* MTE Inactive */
     {/* Little-endian */
      {{{
...
static gen_helper_gvec_mem_scatter* const gather_load_fn64[2][2][2][3][2][4] = {
    { /* MTE Inactive */
     {/* Little-endian */
      {{{
...
static gen_helper_gvec_mem_scatter* const gather_load_fn128[2][2] = {
    {gen_helper_sve_ldqq_le_zd, gen_helper_sve_ldqq_be_zd},
    {gen_helper_sve_ldqq_le_zd_mte, gen_helper_sve_ldqq_be_zd_mte}};
...
static bool trans_LD1_zprz(DisasContext* s, arg_LD1_zprz* a)
{
    ...
    switch (a->esz) {
        case MO_32: fn = gather_load_fn32[mte][be][a->ff][a->xs][a->u][a->msz]; break;
        case MO_64: fn = gather_load_fn64[mte][be][a->ff][a->xs][a->u][a->msz]; break;
        default   : assert_not_reached();
    }
    assert(fn != NULL);

    do_mem_zpz(s, a->rd, a->pg, a->rm, a->scale * a->msz, cpu_reg_sp(s, a->rn), a->msz, false, fn);
    return true;
}
...
static bool trans_LD1Q(DisasContext* s, arg_LD1Q* a)
{
     ...
     */
    do_mem_zpz(s, a->rd, a->pg, a->rn, 0, cpu_reg(s, a->rm), MO_128, false, fn);
    return true;
}
...
static bool trans_LD1_zpiz(DisasContext* s, arg_LD1_zpiz* a)
{
    ...
    if (a->esz < a->msz || (a->esz == a->msz && !a->u)) { return false; }
    if (!dc_isar_feature(aa64_sve, s)) { return false; }
    s->is_nonstreaming = true;
    if (!sve_access_check(s)) { return true; }

    switch (a->esz) {
        case MO_32: fn = gather_load_fn32[mte][be][a->ff][0][a->u][a->msz]; break;
        case MO_64: fn = gather_load_fn64[mte][be][a->ff][2][a->u][a->msz]; break;
    }
    assert(fn != NULL);
     ...
     */
    do_mem_zpz(s, a->rd, a->pg, a->rn, 0, tcg_constant_i64(a->imm << a->msz), a->msz, false, fn);
    return true;
}
...
static bool trans_LDNT1_zprz(DisasContext* s, arg_LD1_zprz* a)
{
    ...
    if (a->esz < a->msz + !a->u) { return false; }
    if (!dc_isar_feature(aa64_sve2, s)) { return false; }
    s->is_nonstreaming = true;
    if (!sve_access_check(s)) { return true; }

    switch (a->esz) {
        case MO_32: fn = gather_load_fn32[mte][be][0][0][a->u][a->msz]; break;
        case MO_64: fn = gather_load_fn64[mte][be][0][2][a->u][a->msz]; break;
    }
    assert(fn != NULL);

    do_mem_zpz(s, a->rd, a->pg, a->rn, 0, cpu_reg(s, a->rm), a->msz, false, fn);
    return true;
}
...
static gen_helper_gvec_mem_scatter* const scatter_store_fn128[2][2] = {
    {gen_helper_sve_stqq_le_zd, gen_helper_sve_stqq_be_zd},
    {gen_helper_sve_stqq_le_zd_mte, gen_helper_sve_stqq_be_zd_mte}};
...
static bool trans_ST1_zprz(DisasContext* s, arg_ST1_zprz* a)
{
    ...
    if (a->esz < a->msz || (a->msz == 0 && a->scale)) { return false; }
    if (!dc_isar_feature(aa64_sve, s)) { return false; }
    s->is_nonstreaming = true;
    if (!sve_access_check(s)) { return true; }
    switch (a->esz) {
        case MO_32: fn = scatter_store_fn32[mte][be][a->xs][a->msz]; break;
        case MO_64: fn = scatter_store_fn64[mte][be][a->xs][a->msz]; break;
        default   : assert_not_reached();
    }
    do_mem_zpz(s, a->rd, a->pg, a->rm, a->scale * a->msz, cpu_reg_sp(s, a->rn), a->msz, true, fn);
    return true;
}
...
static bool trans_ST1Q(DisasContext* s, arg_ST1Q* a)
{
     ...
     */
    do_mem_zpz(s, a->rd, a->pg, a->rn, 0, cpu_reg(s, a->rm), MO_128, true, fn);
    return true;
}
...
static bool trans_ST1_zpiz(DisasContext* s, arg_ST1_zpiz* a)
{
    ...
    if (a->esz < a->msz) { return false; }
    if (!dc_isar_feature(aa64_sve, s)) { return false; }
    s->is_nonstreaming = true;
    if (!sve_access_check(s)) { return true; }

    switch (a->esz) {
        case MO_32: fn = scatter_store_fn32[mte][be][0][a->msz]; break;
        case MO_64: fn = scatter_store_fn64[mte][be][2][a->msz]; break;
    }
    assert(fn != NULL);
     ...
     * by loading the immediate into the scalar parameter.
     */
    do_mem_zpz(s, a->rd, a->pg, a->rn, 0, tcg_constant_i64(a->imm << a->msz), a->msz, true, fn);
    return true;
}
...
static bool trans_STNT1_zprz(DisasContext* s, arg_ST1_zprz* a)
{
    ...
    do_mem_zpz(s, a->rd, a->pg, a->rn, 0, cpu_reg(s, a->rm), a->msz, true, fn);
    return true;
}
...
static gen_helper_gvec_3* const smulh_zzz_fns[4] = {
    gen_helper_gvec_smulh_b,
    gen_helper_gvec_smulh_h,
    gen_helper_gvec_smulh_s,
    gen_helper_gvec_smulh_d,
};
TRANS_FEAT(SMULH_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, smulh_zzz_fns[a->esz], a, 0)

static gen_helper_gvec_3* const umulh_zzz_fns[4] = {
    gen_helper_gvec_umulh_b,
    gen_helper_gvec_umulh_h,
    gen_helper_gvec_umulh_s,
    gen_helper_gvec_umulh_d,
};
TRANS_FEAT(UMULH_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, umulh_zzz_fns[a->esz], a, 0)

TRANS_FEAT(PMUL_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, gen_helper_gvec_pmul_b, a, 0)
...
TRANS_FEAT(SQRDMULH_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, sqrdmulh_zzz_fns[a->esz], a, 0)
...
TRANS_FEAT(SADALP_zpzz, aa64_sve2, gen_gvec_ool_arg_zpzz, sadlp_fns[a->esz], a, 0)
...
TRANS_FEAT(UADALP_zpzz, aa64_sve2, gen_gvec_ool_arg_zpzz, uadlp_fns[a->esz], a, 0)

/*
 * SVE2 integer unary operations (predicated)
 */

TRANS_FEAT(URECPE, aa64_sve2, gen_gvec_ool_arg_zpz, a->esz == 2 ? gen_helper_sve2_urecpe_s : NULL, a, 0)

TRANS_FEAT(URSQRTE, aa64_sve2, gen_gvec_ool_arg_zpz, a->esz == 2 ? gen_helper_sve2_ursqrte_s : NULL, a, 0)
...
TRANS_FEAT(SADDLB, aa64_sve2, gen_gvec_ool_arg_zzz, saddl_fns[a->esz], a, 0)
TRANS_FEAT(SADDLT, aa64_sve2, gen_gvec_ool_arg_zzz, saddl_fns[a->esz], a, 3)
TRANS_FEAT(SADDLBT, aa64_sve2, gen_gvec_ool_arg_zzz, saddl_fns[a->esz], a, 2)
...
TRANS_FEAT(SSUBLB, aa64_sve2, gen_gvec_ool_arg_zzz, ssubl_fns[a->esz], a, 0)
TRANS_FEAT(SSUBLT, aa64_sve2, gen_gvec_ool_arg_zzz, ssubl_fns[a->esz], a, 3)
TRANS_FEAT(SSUBLBT, aa64_sve2, gen_gvec_ool_arg_zzz, ssubl_fns[a->esz], a, 2)
TRANS_FEAT(SSUBLTB, aa64_sve2, gen_gvec_ool_arg_zzz, ssubl_fns[a->esz], a, 1)

static gen_helper_gvec_3* const sabdl_fns[4] = {
    NULL,
    gen_helper_sve2_sabdl_h,
    gen_helper_sve2_sabdl_s,
    gen_helper_sve2_sabdl_d,
};
TRANS_FEAT(SABDLB, aa64_sve2, gen_gvec_ool_arg_zzz, sabdl_fns[a->esz], a, 0)
TRANS_FEAT(SABDLT, aa64_sve2, gen_gvec_ool_arg_zzz, sabdl_fns[a->esz], a, 3)
...
TRANS_FEAT(UADDLB, aa64_sve2, gen_gvec_ool_arg_zzz, uaddl_fns[a->esz], a, 0)
TRANS_FEAT(UADDLT, aa64_sve2, gen_gvec_ool_arg_zzz, uaddl_fns[a->esz], a, 3)
...
TRANS_FEAT(USUBLB, aa64_sve2, gen_gvec_ool_arg_zzz, usubl_fns[a->esz], a, 0)
TRANS_FEAT(USUBLT, aa64_sve2, gen_gvec_ool_arg_zzz, usubl_fns[a->esz], a, 3)

static gen_helper_gvec_3* const uabdl_fns[4] = {
    NULL,
    gen_helper_sve2_uabdl_h,
    gen_helper_sve2_uabdl_s,
    gen_helper_sve2_uabdl_d,
};
TRANS_FEAT(UABDLB, aa64_sve2, gen_gvec_ool_arg_zzz, uabdl_fns[a->esz], a, 0)
TRANS_FEAT(UABDLT, aa64_sve2, gen_gvec_ool_arg_zzz, uabdl_fns[a->esz], a, 3)

static gen_helper_gvec_3* const sqdmull_fns[4] = {
    NULL,
    gen_helper_sve2_sqdmull_zzz_h,
    gen_helper_sve2_sqdmull_zzz_s,
    gen_helper_sve2_sqdmull_zzz_d,
};
TRANS_FEAT(SQDMULLB_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, sqdmull_fns[a->esz], a, 0)
TRANS_FEAT(SQDMULLT_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, sqdmull_fns[a->esz], a, 3)

static gen_helper_gvec_3* const smull_fns[4] = {
    NULL,
    gen_helper_sve2_smull_zzz_h,
    gen_helper_sve2_smull_zzz_s,
    gen_helper_sve2_smull_zzz_d,
};
TRANS_FEAT(SMULLB_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, smull_fns[a->esz], a, 0)
TRANS_FEAT(SMULLT_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, smull_fns[a->esz], a, 3)

static gen_helper_gvec_3* const umull_fns[4] = {
    NULL,
    gen_helper_sve2_umull_zzz_h,
    gen_helper_sve2_umull_zzz_s,
    gen_helper_sve2_umull_zzz_d,
};
TRANS_FEAT(UMULLB_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, umull_fns[a->esz], a, 0)
TRANS_FEAT(UMULLT_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, umull_fns[a->esz], a, 3)
...
static bool do_trans_pmull(DisasContext* s, arg_rrr_esz* a, bool sel)
{
    ...
    if (a->esz == 0) {
        if (!dc_isar_feature(aa64_sve2_pmull128, s)) { return false; }
        s->is_nonstreaming = true;
    }
...
static void gen_sshll_vec(unsigned vece, TCGv_vec d, TCGv_vec n, int64_t imm)
{
    ...
    if (top) {
        if (shl == halfbits) {
            tcg_gen_and_vec(vece, d, n, tcg_constant_vec_matching(d, vece, MAKE_64BIT_MASK(halfbits, halfbits)));
        }
        else {
...
static void gen_ushll_i64(unsigned vece, TCGv_i64 d, TCGv_i64 n, int imm)
{
    ...
    if (shift < 0) { tcg_gen_shri_i64(d, n, -shift); }
    else {
...
static void gen_ushll16_i64(TCGv_i64 d, TCGv_i64 n, int64_t imm) { gen_ushll_i64(MO_16, d, n, imm); }

static void gen_ushll32_i64(TCGv_i64 d, TCGv_i64 n, int64_t imm) { gen_ushll_i64(MO_32, d, n, imm); }

static void gen_ushll64_i64(TCGv_i64 d, TCGv_i64 n, int64_t imm) { gen_ushll_i64(MO_64, d, n, imm); }
...
static void gen_ushll_vec(unsigned vece, TCGv_vec d, TCGv_vec n, int64_t imm)
{
    ...
    if (top) {
        ...
        if (shl == 0) { tcg_gen_and_vec(vece, d, n, tcg_constant_vec_matching(d, vece, MAKE_64BIT_MASK(0, halfbits))); }
        else {
            tcg_gen_shli_vec(vece, d, n, halfbits);
...
static bool do_shll_tb(DisasContext* s, arg_rri_esz* a, const GVecGen2i ops[3], bool sel)
{

    if (a->esz < 0 || a->esz > 2) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_2i(vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), vsz, vsz, (a->imm << 1) | sel,
                        &ops[a->esz]);
    }
    return true;
}

static const TCGOpcode sshll_list[] = {INDEX_op_shli_vec, INDEX_op_sari_vec, 0};
static const GVecGen2i sshll_ops[3] = {
    {.fniv = gen_sshll_vec, .opt_opc = sshll_list, .fno = gen_helper_sve2_sshll_h, .vece = MO_16},
    {.fniv = gen_sshll_vec, .opt_opc = sshll_list, .fno = gen_helper_sve2_sshll_s, .vece = MO_32},
    {.fniv = gen_sshll_vec, .opt_opc = sshll_list, .fno = gen_helper_sve2_sshll_d, .vece = MO_64}};
TRANS_FEAT(SSHLLB, aa64_sve2, do_shll_tb, a, sshll_ops, false)
TRANS_FEAT(SSHLLT, aa64_sve2, do_shll_tb, a, sshll_ops, true)

static const TCGOpcode ushll_list[] = {INDEX_op_shli_vec, INDEX_op_shri_vec, 0};
...
TRANS_FEAT_NONSTREAMING(BEXT, aa64_sve2_bitperm, gen_gvec_ool_arg_zzz, bext_fns[a->esz], a, 0)
...
TRANS_FEAT_NONSTREAMING(BDEP, aa64_sve2_bitperm, gen_gvec_ool_arg_zzz, bdep_fns[a->esz], a, 0)
...
TRANS_FEAT_NONSTREAMING(BGRP, aa64_sve2_bitperm, gen_gvec_ool_arg_zzz, bgrp_fns[a->esz], a, 0)
...
TRANS_FEAT(CADD_rot90, aa64_sve2, gen_gvec_ool_arg_zzz, cadd_fns[a->esz], a, 0)
TRANS_FEAT(CADD_rot270, aa64_sve2, gen_gvec_ool_arg_zzz, cadd_fns[a->esz], a, 1)
...
TRANS_FEAT(SQCADD_rot90, aa64_sve2, gen_gvec_ool_arg_zzz, sqcadd_fns[a->esz], a, 0)
TRANS_FEAT(SQCADD_rot270, aa64_sve2, gen_gvec_ool_arg_zzz, sqcadd_fns[a->esz], a, 1)
...
static bool do_narrow_extract(DisasContext* s, arg_rri_esz* a, const GVecGen2 ops[3])
{
    if (a->esz < 0 || a->esz > MO_32 || a->imm != 0) { return false; }
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_2(vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), vsz, vsz, &ops[a->esz]);
    }
    return true;
}

static const TCGOpcode sqxtn_list[] = {INDEX_op_shli_vec, INDEX_op_smin_vec, INDEX_op_smax_vec, 0};
...
static const GVecGen2 sqxtnb_ops[3] = {
    {.fniv = gen_sqxtnb_vec, .opt_opc = sqxtn_list, .fno = gen_helper_sve2_sqxtnb_h, .vece = MO_16},
    {.fniv = gen_sqxtnb_vec, .opt_opc = sqxtn_list, .fno = gen_helper_sve2_sqxtnb_s, .vece = MO_32},
    {.fniv = gen_sqxtnb_vec, .opt_opc = sqxtn_list, .fno = gen_helper_sve2_sqxtnb_d, .vece = MO_64},
};
...
static const GVecGen2 sqxtnt_ops[3] = {
    {.fniv = gen_sqxtnt_vec, .opt_opc = sqxtn_list, .load_dest = true, .fno = gen_helper_sve2_sqxtnt_h, .vece = MO_16},
    {.fniv = gen_sqxtnt_vec, .opt_opc = sqxtn_list, .load_dest = true, .fno = gen_helper_sve2_sqxtnt_s, .vece = MO_32},
    {.fniv = gen_sqxtnt_vec, .opt_opc = sqxtn_list, .load_dest = true, .fno = gen_helper_sve2_sqxtnt_d, .vece = MO_64},
};
TRANS_FEAT(SQXTNT, aa64_sve2, do_narrow_extract, a, sqxtnt_ops)

static const TCGOpcode uqxtn_list[] = {INDEX_op_shli_vec, INDEX_op_umin_vec, 0};
...
static const GVecGen2 uqxtnb_ops[3] = {
    {.fniv = gen_uqxtnb_vec, .opt_opc = uqxtn_list, .fno = gen_helper_sve2_uqxtnb_h, .vece = MO_16},
    {.fniv = gen_uqxtnb_vec, .opt_opc = uqxtn_list, .fno = gen_helper_sve2_uqxtnb_s, .vece = MO_32},
    {.fniv = gen_uqxtnb_vec, .opt_opc = uqxtn_list, .fno = gen_helper_sve2_uqxtnb_d, .vece = MO_64},
};
...
static const GVecGen2 uqxtnt_ops[3] = {
    {.fniv = gen_uqxtnt_vec, .opt_opc = uqxtn_list, .load_dest = true, .fno = gen_helper_sve2_uqxtnt_h, .vece = MO_16},
    {.fniv = gen_uqxtnt_vec, .opt_opc = uqxtn_list, .load_dest = true, .fno = gen_helper_sve2_uqxtnt_s, .vece = MO_32},
    {.fniv = gen_uqxtnt_vec, .opt_opc = uqxtn_list, .load_dest = true, .fno = gen_helper_sve2_uqxtnt_d, .vece = MO_64},
};
TRANS_FEAT(UQXTNT, aa64_sve2, do_narrow_extract, a, uqxtnt_ops)

static const TCGOpcode sqxtun_list[] = {INDEX_op_shli_vec, INDEX_op_umin_vec, INDEX_op_smax_vec, 0};
...
static const GVecGen2 sqxtunb_ops[3] = {
    {.fniv = gen_sqxtunb_vec, .opt_opc = sqxtun_list, .fno = gen_helper_sve2_sqxtunb_h, .vece = MO_16},
    {.fniv = gen_sqxtunb_vec, .opt_opc = sqxtun_list, .fno = gen_helper_sve2_sqxtunb_s, .vece = MO_32},
    {.fniv = gen_sqxtunb_vec, .opt_opc = sqxtun_list, .fno = gen_helper_sve2_sqxtunb_d, .vece = MO_64},
};
...
static bool do_shr_narrow(DisasContext* s, arg_rri_esz* a, const GVecGen2i ops[3])
{
    if (a->esz < 0 || a->esz > MO_32) { return false; }
    assert(a->imm > 0 && a->imm <= (8 << a->esz));
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_2i(vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn), vsz, vsz, a->imm, &ops[a->esz]);
    }
    return true;
}
...
static void gen_shrnb16_i64(TCGv_i64 d, TCGv_i64 n, int64_t shr) { gen_shrnb_i64(MO_16, d, n, shr); }

static void gen_shrnb32_i64(TCGv_i64 d, TCGv_i64 n, int64_t shr) { gen_shrnb_i64(MO_32, d, n, shr); }

static void gen_shrnb64_i64(TCGv_i64 d, TCGv_i64 n, int64_t shr) { gen_shrnb_i64(MO_64, d, n, shr); }
...
static void gen_shrnt16_i64(TCGv_i64 d, TCGv_i64 n, int64_t shr) { gen_shrnt_i64(MO_16, d, n, shr); }

static void gen_shrnt32_i64(TCGv_i64 d, TCGv_i64 n, int64_t shr) { gen_shrnt_i64(MO_32, d, n, shr); }
...
static void gen_sqshrunb_vec(unsigned vece, TCGv_vec d, TCGv_vec n, int64_t shr)
{
    int      halfbits = 4 << vece;
...
static const TCGOpcode sqshrunb_vec_list[] = {INDEX_op_sari_vec, INDEX_op_smax_vec, INDEX_op_umin_vec, 0};
static const GVecGen2i sqshrunb_ops[3]     = {
    {.fniv = gen_sqshrunb_vec, .opt_opc = sqshrunb_vec_list, .fno = gen_helper_sve2_sqshrunb_h, .vece = MO_16},
    {.fniv = gen_sqshrunb_vec, .opt_opc = sqshrunb_vec_list, .fno = gen_helper_sve2_sqshrunb_s, .vece = MO_32},
    {.fniv = gen_sqshrunb_vec, .opt_opc = sqshrunb_vec_list, .fno = gen_helper_sve2_sqshrunb_d, .vece = MO_64},
};
...
static const TCGOpcode sqshrunt_vec_list[] = {INDEX_op_shli_vec, INDEX_op_sari_vec, INDEX_op_smax_vec,
                                              INDEX_op_umin_vec, 0};
...
static void gen_sqshrnb_vec(unsigned vece, TCGv_vec d, TCGv_vec n, int64_t shr)
{
    int     halfbits = 4 << vece;
...
static const TCGOpcode sqshrnb_vec_list[] = {INDEX_op_sari_vec, INDEX_op_smax_vec, INDEX_op_smin_vec, 0};
static const GVecGen2i sqshrnb_ops[3]     = {
    {.fniv = gen_sqshrnb_vec, .opt_opc = sqshrnb_vec_list, .fno = gen_helper_sve2_sqshrnb_h, .vece = MO_16},
    {.fniv = gen_sqshrnb_vec, .opt_opc = sqshrnb_vec_list, .fno = gen_helper_sve2_sqshrnb_s, .vece = MO_32},
    {.fniv = gen_sqshrnb_vec, .opt_opc = sqshrnb_vec_list, .fno = gen_helper_sve2_sqshrnb_d, .vece = MO_64},
};
TRANS_FEAT(SQSHRNB, aa64_sve2, do_shr_narrow, a, sqshrnb_ops)

static void gen_sqshrnt_vec(unsigned vece, TCGv_vec d, TCGv_vec n, int64_t shr)
{
    int     halfbits = 4 << vece;
    int64_t max      = MAKE_64BIT_MASK(0, halfbits - 1);
    int64_t min      = -max - 1;
...
static const TCGOpcode sqshrnt_vec_list[] = {INDEX_op_shli_vec, INDEX_op_sari_vec, INDEX_op_smax_vec, INDEX_op_smin_vec,
                                             0};
...
static void gen_uqshrnb_vec(unsigned vece, TCGv_vec d, TCGv_vec n, int64_t shr)
{
    int     halfbits = 4 << vece;
...
static const TCGOpcode uqshrnb_vec_list[] = {INDEX_op_shri_vec, INDEX_op_umin_vec, 0};
static const GVecGen2i uqshrnb_ops[3]     = {
    {.fniv = gen_uqshrnb_vec, .opt_opc = uqshrnb_vec_list, .fno = gen_helper_sve2_uqshrnb_h, .vece = MO_16},
    {.fniv = gen_uqshrnb_vec, .opt_opc = uqshrnb_vec_list, .fno = gen_helper_sve2_uqshrnb_s, .vece = MO_32},
    {.fniv = gen_uqshrnb_vec, .opt_opc = uqshrnb_vec_list, .fno = gen_helper_sve2_uqshrnb_d, .vece = MO_64},
};
TRANS_FEAT(UQSHRNB, aa64_sve2, do_shr_narrow, a, uqshrnb_ops)

static void gen_uqshrnt_vec(unsigned vece, TCGv_vec d, TCGv_vec n, int64_t shr)
{
    int      halfbits = 4 << vece;
    int64_t  max      = MAKE_64BIT_MASK(0, halfbits);
    TCGv_vec maxv     = tcg_constant_vec_matching(d, vece, max);
...
static const TCGOpcode uqshrnt_vec_list[] = {INDEX_op_shli_vec, INDEX_op_shri_vec, INDEX_op_umin_vec, 0};
...
#define DO_SVE2_ZZZ_NARROW(NAME, name)                                          \
    ...
    TRANS_FEAT(NAME, aa64_sve2, gen_gvec_ool_arg_zzz, name##_fns[a->esz], a, 0)
...
static gen_helper_gvec_flags_4* const match_fns[4] = {gen_helper_sve2_match_ppzz_b, gen_helper_sve2_match_ppzz_h, NULL,
                                                      NULL};
TRANS_FEAT_NONSTREAMING(MATCH, aa64_sve2, do_ppzz_flags, a, match_fns[a->esz])

static gen_helper_gvec_flags_4* const nmatch_fns[4] = {gen_helper_sve2_nmatch_ppzz_b, gen_helper_sve2_nmatch_ppzz_h,
                                                       NULL, NULL};
TRANS_FEAT_NONSTREAMING(NMATCH, aa64_sve2, do_ppzz_flags, a, nmatch_fns[a->esz])

static gen_helper_gvec_4* const histcnt_fns[4] = {NULL, NULL, gen_helper_sve2_histcnt_s, gen_helper_sve2_histcnt_d};
TRANS_FEAT_NONSTREAMING(HISTCNT, aa64_sve2, gen_gvec_ool_arg_zpzz, histcnt_fns[a->esz], a, 0)

TRANS_FEAT_NONSTREAMING(HISTSEG, aa64_sve2, gen_gvec_ool_arg_zzz, a->esz == 0 ? gen_helper_sve2_histseg : NULL, a, 0)
...
static bool do_fmmla(DisasContext* s, arg_rrrr_esz* a, gen_helper_gvec_4_ptr* fn)
{
    if (sve_access_check(s)) {
        if (vec_full_reg_size(s) < 4 * memop_size(a->esz)) { unallocated_encoding(s); }
        else {
...
static gen_helper_gvec_4* const sqdmlal_zzzw_fns[] = {
    ...
    gen_helper_sve2_sqdmlal_zzzw_s,
    gen_helper_sve2_sqdmlal_zzzw_d,
};
TRANS_FEAT(SQDMLALB_zzzw, aa64_sve2, gen_gvec_ool_arg_zzzz, sqdmlal_zzzw_fns[a->esz], a, 0)
TRANS_FEAT(SQDMLALT_zzzw, aa64_sve2, gen_gvec_ool_arg_zzzz, sqdmlal_zzzw_fns[a->esz], a, 3)
TRANS_FEAT(SQDMLALBT, aa64_sve2, gen_gvec_ool_arg_zzzz, sqdmlal_zzzw_fns[a->esz], a, 2)

static gen_helper_gvec_4* const sqdmlsl_zzzw_fns[] = {
    NULL,
    gen_helper_sve2_sqdmlsl_zzzw_h,
    gen_helper_sve2_sqdmlsl_zzzw_s,
    gen_helper_sve2_sqdmlsl_zzzw_d,
};
TRANS_FEAT(SQDMLSLB_zzzw, aa64_sve2, gen_gvec_ool_arg_zzzz, sqdmlsl_zzzw_fns[a->esz], a, 0)
TRANS_FEAT(SQDMLSLT_zzzw, aa64_sve2, gen_gvec_ool_arg_zzzz, sqdmlsl_zzzw_fns[a->esz], a, 3)
TRANS_FEAT(SQDMLSLBT, aa64_sve2, gen_gvec_ool_arg_zzzz, sqdmlsl_zzzw_fns[a->esz], a, 2)
...
TRANS_FEAT(SQRDMLAH_zzzz, aa64_sve2, gen_gvec_ool_arg_zzzz, sqrdmlah_fns[a->esz], a, 0)
...
TRANS_FEAT(SQRDMLSH_zzzz, aa64_sve2, gen_gvec_ool_arg_zzzz, sqrdmlsh_fns[a->esz], a, 0)

static gen_helper_gvec_4* const smlal_zzzw_fns[] = {
    NULL,
    gen_helper_sve2_smlal_zzzw_h,
    gen_helper_sve2_smlal_zzzw_s,
    gen_helper_sve2_smlal_zzzw_d,
};
TRANS_FEAT(SMLALB_zzzw, aa64_sve2, gen_gvec_ool_arg_zzzz, smlal_zzzw_fns[a->esz], a, 0)
TRANS_FEAT(SMLALT_zzzw, aa64_sve2, gen_gvec_ool_arg_zzzz, smlal_zzzw_fns[a->esz], a, 1)

static gen_helper_gvec_4* const umlal_zzzw_fns[] = {
    NULL,
    gen_helper_sve2_umlal_zzzw_h,
    gen_helper_sve2_umlal_zzzw_s,
    gen_helper_sve2_umlal_zzzw_d,
};
TRANS_FEAT(UMLALB_zzzw, aa64_sve2, gen_gvec_ool_arg_zzzz, umlal_zzzw_fns[a->esz], a, 0)
TRANS_FEAT(UMLALT_zzzw, aa64_sve2, gen_gvec_ool_arg_zzzz, umlal_zzzw_fns[a->esz], a, 1)

static gen_helper_gvec_4* const smlsl_zzzw_fns[] = {
    NULL,
    gen_helper_sve2_smlsl_zzzw_h,
    gen_helper_sve2_smlsl_zzzw_s,
    gen_helper_sve2_smlsl_zzzw_d,
};
TRANS_FEAT(SMLSLB_zzzw, aa64_sve2, gen_gvec_ool_arg_zzzz, smlsl_zzzw_fns[a->esz], a, 0)
TRANS_FEAT(SMLSLT_zzzw, aa64_sve2, gen_gvec_ool_arg_zzzz, smlsl_zzzw_fns[a->esz], a, 1)

static gen_helper_gvec_4* const umlsl_zzzw_fns[] = {
    NULL,
    gen_helper_sve2_umlsl_zzzw_h,
    gen_helper_sve2_umlsl_zzzw_s,
    gen_helper_sve2_umlsl_zzzw_d,
};
TRANS_FEAT(UMLSLB_zzzw, aa64_sve2, gen_gvec_ool_arg_zzzz, umlsl_zzzw_fns[a->esz], a, 0)
TRANS_FEAT(UMLSLT_zzzw, aa64_sve2, gen_gvec_ool_arg_zzzz, umlsl_zzzw_fns[a->esz], a, 1)
...
TRANS_FEAT(CMLA_zzzz, aa64_sve2, gen_gvec_ool_zzzz, cmla_fns[a->esz], a->rd, a->rn, a->rm, a->ra, a->rot)

static gen_helper_gvec_4* const cdot_fns[] = {NULL, NULL, gen_helper_sve2_cdot_zzzz_s, gen_helper_sve2_cdot_zzzz_d};
TRANS_FEAT(CDOT_zzzz, aa64_sve2, gen_gvec_ool_zzzz, cdot_fns[a->esz], a->rd, a->rn, a->rm, a->ra, a->rot)
...
TRANS_FEAT(SQRDCMLAH_zzzz, aa64_sve2, gen_gvec_ool_zzzz, sqrdcmlah_fns[a->esz], a->rd, a->rn, a->rm, a->ra, a->rot)

TRANS_FEAT(USDOT_zzzz_4s, aa64_sve_i8mm, gen_gvec_ool_arg_zzzz, gen_helper_gvec_usdot_4b, a, 0)

TRANS_FEAT(SDOT_zzzz_2s, aa64_sme2_or_sve2p1, gen_gvec_ool_arg_zzzz, gen_helper_gvec_sdot_2h, a, 0)
TRANS_FEAT(UDOT_zzzz_2s, aa64_sme2_or_sve2p1, gen_gvec_ool_arg_zzzz, gen_helper_gvec_udot_2h, a, 0)

TRANS_FEAT_NONSTREAMING(AESMC, aa64_sve2_aes, gen_gvec_ool_zz, gen_helper_crypto_aesmc, a->rd, a->rd, 0)
TRANS_FEAT_NONSTREAMING(AESIMC, aa64_sve2_aes, gen_gvec_ool_zz, gen_helper_crypto_aesimc, a->rd, a->rd, 0)

TRANS_FEAT_NONSTREAMING(AESE, aa64_sve2_aes, gen_gvec_ool_arg_zzz, gen_helper_crypto_aese, a, 0)
TRANS_FEAT_NONSTREAMING(AESD, aa64_sve2_aes, gen_gvec_ool_arg_zzz, gen_helper_crypto_aesd, a, 0)

TRANS_FEAT_NONSTREAMING(SM4E, aa64_sve2_sm4, gen_gvec_ool_arg_zzz, gen_helper_crypto_sm4e, a, 0)
TRANS_FEAT_NONSTREAMING(SM4EKEY, aa64_sve2_sm4, gen_gvec_ool_arg_zzz, gen_helper_crypto_sm4ekey, a, 0)

TRANS_FEAT_NONSTREAMING(RAX1, aa64_sve2_sha3, gen_gvec_fn_arg_zzz, gen_gvec_rax1, a)

TRANS_FEAT(FCVTNT_sh, aa64_sve2, gen_gvec_fpst_arg_zpz, gen_helper_sve2_fcvtnt_sh, a, 0, FPST_A64)
TRANS_FEAT(FCVTNT_ds, aa64_sve2, gen_gvec_fpst_arg_zpz, gen_helper_sve2_fcvtnt_ds, a, 0, FPST_A64)

TRANS_FEAT(BFCVTNT, aa64_sve_bf16, gen_gvec_fpst_arg_zpz, gen_helper_sve_bfcvtnt, a, 0, s->fpcr_ah ? FPST_AH : FPST_A64)

TRANS_FEAT(FCVTLT_hs, aa64_sve2, gen_gvec_fpst_arg_zpz, gen_helper_sve2_fcvtlt_hs, a, 0, FPST_A64)
TRANS_FEAT(FCVTLT_sd, aa64_sve2, gen_gvec_fpst_arg_zpz, gen_helper_sve2_fcvtlt_sd, a, 0, FPST_A64)

TRANS_FEAT(FCVTX_ds, aa64_sve2, do_frint_mode, a, FPROUNDING_ODD, gen_helper_sve_fcvt_ds)
TRANS_FEAT(FCVTXNT_ds, aa64_sve2, do_frint_mode, a, FPROUNDING_ODD, gen_helper_sve2_fcvtnt_ds)

static gen_helper_gvec_3_ptr* const flogb_fns[] = {NULL, gen_helper_flogb_h, gen_helper_flogb_s, gen_helper_flogb_d};
TRANS_FEAT(FLOGB, aa64_sve2, gen_gvec_fpst_arg_zpz, flogb_fns[a->esz], a, 0, a->esz == MO_16 ? FPST_A64_F16 : FPST_A64)

static bool do_FMLAL_zzzw(DisasContext* s, arg_rrrr_esz* a, bool sub, bool sel)
{ return gen_gvec_ptr_zzzz(s, gen_helper_sve2_fmlal_zzzw_s, a->rd, a->rn, a->rm, a->ra, (sel << 1) | sub, tcg_env); }
...
{
    return gen_gvec_ptr_zzzz(s, gen_helper_sve2_fmlal_zzxw_s, a->rd, a->rn, a->rm, a->ra,
...
TRANS_FEAT_NONSTREAMING(SMMLA, aa64_sve_i8mm, gen_gvec_ool_arg_zzzz, gen_helper_gvec_smmla_b, a, 0)
TRANS_FEAT_NONSTREAMING(USMMLA, aa64_sve_i8mm, gen_gvec_ool_arg_zzzz, gen_helper_gvec_usmmla_b, a, 0)
TRANS_FEAT_NONSTREAMING(UMMLA, aa64_sve_i8mm, gen_gvec_ool_arg_zzzz, gen_helper_gvec_ummla_b, a, 0)

TRANS_FEAT(FDOT_zzzz, aa64_sme2_or_sve2p1, gen_gvec_env_arg_zzzz, gen_helper_sme2_fdot_h, a, 0)
TRANS_FEAT(FDOT_zzxz, aa64_sme2_or_sve2p1, gen_gvec_env_arg_zzxz, gen_helper_sme2_fdot_idx_h, a)

TRANS_FEAT(BFDOT_zzzz, aa64_sve_bf16, gen_gvec_env_arg_zzzz, gen_helper_gvec_bfdot, a, 0)
TRANS_FEAT(BFDOT_zzxz, aa64_sve_bf16, gen_gvec_env_arg_zzxz, gen_helper_gvec_bfdot_idx, a)

TRANS_FEAT_NONSTREAMING(BFMMLA, aa64_sve_bf16, gen_gvec_env_arg_zzzz, gen_helper_gvec_bfmmla, a, 0)

static bool do_BFMLAL_zzzw(DisasContext* s, arg_rrrr_esz* a, bool sel)
{
    return gen_gvec_fpst_zzzz(s, gen_helper_gvec_bfmlal, a->rd, a->rn, a->rm, a->ra, sel,
...
{
    return gen_gvec_fpst_zzzz(s, gen_helper_gvec_bfmlal_idx, a->rd, a->rn, a->rm, a->ra, (a->index << 1) | sel,
                              s->fpcr_ah ? FPST_AH : FPST_A64);
}
...
{
    if (s->fpcr_ah) {
        return gen_gvec_fpst_zzzz(s, gen_helper_gvec_ah_bfmlsl, a->rd, a->rn, a->rm, a->ra, sel, FPST_AH);
    }
    else {
        return gen_gvec_fpst_zzzz(s, gen_helper_gvec_bfmlsl, a->rd, a->rn, a->rm, a->ra, sel, FPST_A64);
    }
}
...
{
    if (s->fpcr_ah) {
        return gen_gvec_fpst_zzzz(s, gen_helper_gvec_ah_bfmlsl_idx, a->rd, a->rn, a->rm, a->ra, (a->index << 1) | sel,
                                  FPST_AH);
    }
    else {
        return gen_gvec_fpst_zzzz(s, gen_helper_gvec_bfmlsl_idx, a->rd, a->rn, a->rm, a->ra, (a->index << 1) | sel,
                                  FPST_A64);
    }
}
...
static bool trans_PSEL(DisasContext* s, arg_psel* a)
{
    ...
    if (!dc_isar_feature(aa64_sme_or_sve2p1, s)) { return false; }
    if (!sve_access_check(s)) { return true; }
    ...
    if (is_power_of_2(elements)) { tcg_gen_andi_i64(tmp, tmp, elements - 1); }
    else {
    ...
    if (HOST_BIG_ENDIAN) { tcg_gen_xori_i64(didx, didx, 7); }
    ...
    pl = size_for_gvec(pl);
    tcg_gen_gvec_ands(MO_64, pred_full_reg_offset(s, a->pd), pred_full_reg_offset(s, a->pn), tmp, pl, pl);
    return true;
}
...
static void gen_sclamp_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m, TCGv_vec a)
{
    tcg_gen_smax_vec(vece, d, a, n);
    tcg_gen_smin_vec(vece, d, d, m);
}

static void gen_sclamp(unsigned vece, uint32_t d, uint32_t n, uint32_t m, uint32_t a, uint32_t oprsz, uint32_t maxsz)
{
    static const TCGOpcode vecop[] = {INDEX_op_smin_vec, INDEX_op_smax_vec, 0};
    static const GVecGen4  ops[4]  = {
        {.fniv = gen_sclamp_vec, .fno = gen_helper_gvec_sclamp_b, .opt_opc = vecop, .vece = MO_8},
        {.fniv = gen_sclamp_vec, .fno = gen_helper_gvec_sclamp_h, .opt_opc = vecop, .vece = MO_16},
        {.fni4    = gen_sclamp_i32,
         .fniv    = gen_sclamp_vec,
...
static void gen_uclamp_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m, TCGv_vec a)
{
    tcg_gen_umax_vec(vece, d, a, n);
    tcg_gen_umin_vec(vece, d, d, m);
}

static void gen_uclamp(unsigned vece, uint32_t d, uint32_t n, uint32_t m, uint32_t a, uint32_t oprsz, uint32_t maxsz)
{
    static const TCGOpcode vecop[] = {INDEX_op_umin_vec, INDEX_op_umax_vec, 0};
    static const GVecGen4  ops[4]  = {
        {.fniv = gen_uclamp_vec, .fno = gen_helper_gvec_uclamp_b, .opt_opc = vecop, .vece = MO_8},
        {.fniv = gen_uclamp_vec, .fno = gen_helper_gvec_uclamp_h, .opt_opc = vecop, .vece = MO_16},
        {.fni4    = gen_uclamp_i32,
         .fniv    = gen_uclamp_vec,
...
static bool trans_FCLAMP(DisasContext* s, arg_FCLAMP* a)
{
    ...
    if (a->esz == MO_8 ? !dc_isar_feature(aa64_sve_b16b16, s) : !dc_isar_feature(aa64_sme2_or_sve2p1, s)) {
        return false;
    }

    /* So far we never optimize rda with MOVPRFX */
    assert(a->rd == a->ra);
    return gen_gvec_fpst_zzz(s, fn[a->esz], a->rd, a->rn, a->rm, 1, a->esz == MO_16 ? FPST_A64_F16 : FPST_A64);
}

TRANS_FEAT(SQCVTN_sh, aa64_sme2_or_sve2p1, gen_gvec_ool_zz, gen_helper_sme2_sqcvtn_sh, a->rd, a->rn, 0)
TRANS_FEAT(UQCVTN_sh, aa64_sme2_or_sve2p1, gen_gvec_ool_zz, gen_helper_sme2_uqcvtn_sh, a->rd, a->rn, 0)
TRANS_FEAT(SQCVTUN_sh, aa64_sme2_or_sve2p1, gen_gvec_ool_zz, gen_helper_sme2_sqcvtun_sh, a->rd, a->rn, 0)

static bool gen_ldst_c(DisasContext* s, TCGv_i64 addr, int zd, int png, MemOp esz, bool is_write, int n, bool strided)
{
    typedef void            ldst_c_fn(TCGv_env, TCGv_ptr, TCGv_i64, TCGv_i32, TCGv_i64);
    ...
    if (strided || !dc_isar_feature(aa64_sve2p1, s) ? !sme_sm_enabled_check(s) : !sve_access_check(s)) { return true; }
    ...
    t_png = tcg_temp_new_i32();
    tcg_gen_ld16u_i32(t_png, tcg_env, pred_full_reg_offset(s, png) ^ (HOST_BIG_ENDIAN ? 6 : 0));
...
static bool gen_ldst_zcrr_c(DisasContext* s, arg_zcrr_ldst* a, bool is_write, bool strided)
{
    TCGv_i64 addr = tcg_temp_new_i64();

    tcg_gen_shli_i64(addr, cpu_reg(s, a->rm), a->esz);
    tcg_gen_add_i64(addr, addr, cpu_reg_sp(s, a->rn));
    return gen_ldst_c(s, addr, a->rd, a->png, a->esz, is_write, a->nreg, strided);
}

static bool gen_ldst_zcri_c(DisasContext* s, arg_zcri_ldst* a, bool is_write, bool strided)
{
    TCGv_i64 addr = tcg_temp_new_i64();

    tcg_gen_addi_i64(addr, cpu_reg_sp(s, a->rn), a->imm * a->nreg * vec_full_reg_size(s));
    return gen_ldst_c(s, addr, a->rd, a->png, a->esz, is_write, a->nreg, strided);
}
