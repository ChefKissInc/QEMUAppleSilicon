...
#define NEON_GVEC_VOP2(name, vtype)                                                 \
    ...
    {                                                                               \
        ...
        for (i = 0; i < opr_sz / sizeof(vtype); i++) { NEON_FN(d[i], n[i], m[i]); } \
...
#define NEON_GVEC_VOP2i_ENV(name, vtype)                                           \
    ...
    {                                                                              \
        ...
        vtype *  d = vd, *n = vn;                                                  \
        for (i = 0; i < opr_sz / sizeof(vtype); i++) { NEON_FN(d[i], n[i], imm); } \
        clear_tail(d, opr_sz, simd_maxsz(desc));                                   \
    }
...
#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_bhs(src1, (int8_t)src2, 16, false, NULL))
NEON_VOP(shl_u16, neon_u16, 2)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_bhs(src1, (int8_t)src2, 16, false, NULL))
NEON_VOP(shl_s16, neon_s16, 2)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_bhs(src1, (int8_t)src2, 8, true, NULL))
NEON_VOP(rshl_s8, neon_s8, 4)
NEON_GVEC_VOP2(gvec_srshl_b, int8_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_bhs(src1, (int8_t)src2, 16, true, NULL))
NEON_VOP(rshl_s16, neon_s16, 2)
NEON_GVEC_VOP2(gvec_srshl_h, int16_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_bhs(src1, src2, 16, true, NULL))
NEON_GVEC_VOP2(sme2_srshl_h, int16_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_bhs(src1, (int8_t)src2, 32, true, NULL))
NEON_GVEC_VOP2(gvec_srshl_s, int32_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_bhs(src1, src2, 32, true, NULL))
NEON_GVEC_VOP2(sme2_srshl_s, int32_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_d(src1, (int8_t)src2, true, NULL))
NEON_GVEC_VOP2(gvec_srshl_d, int64_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_d(src1, src2, true, NULL))
...
uint64_t HELPER(neon_rshl_s64)(uint64_t val, uint64_t shift) { return do_sqrshl_d(val, (int8_t)shift, true, NULL); }

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_bhs(src1, (int8_t)src2, 8, true, NULL))
NEON_VOP(rshl_u8, neon_u8, 4)
NEON_GVEC_VOP2(gvec_urshl_b, uint8_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_bhs(src1, (int8_t)src2, 16, true, NULL))
NEON_VOP(rshl_u16, neon_u16, 2)
NEON_GVEC_VOP2(gvec_urshl_h, uint16_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_bhs(src1, (int16_t)src2, 16, true, NULL))
NEON_GVEC_VOP2(sme2_urshl_h, uint16_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_bhs(src1, (int8_t)src2, 32, true, NULL))
NEON_GVEC_VOP2(gvec_urshl_s, int32_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_bhs(src1, src2, 32, true, NULL))
NEON_GVEC_VOP2(sme2_urshl_s, int32_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_d(src1, (int8_t)src2, true, NULL))
NEON_GVEC_VOP2(gvec_urshl_d, int64_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_d(src1, src2, true, NULL))
...
uint64_t HELPER(neon_rshl_u64)(uint64_t val, uint64_t shift) { return do_uqrshl_d(val, (int8_t)shift, true, NULL); }

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_bhs(src1, (int8_t)src2, 8, false, env->vfp.qc))
NEON_VOP_ENV(qshl_u8, neon_u8, 4)
NEON_GVEC_VOP2_ENV(neon_uqshl_b, uint8_t)
NEON_GVEC_VOP2i_ENV(neon_uqshli_b, uint8_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_bhs(src1, (int8_t)src2, 16, false, env->vfp.qc))
    NEON_VOP_ENV(qshl_u16, neon_u16, 2) NEON_GVEC_VOP2_ENV(neon_uqshl_h, uint16_t)
        NEON_GVEC_VOP2i_ENV(neon_uqshli_h, uint16_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_bhs(src1, (int8_t)src2, 32, false, env->vfp.qc))
            NEON_GVEC_VOP2_ENV(neon_uqshl_s, uint32_t) NEON_GVEC_VOP2i_ENV(neon_uqshli_s, uint32_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_d(src1, (int8_t)src2, false, env->vfp.qc))
                NEON_GVEC_VOP2_ENV(neon_uqshl_d, uint64_t) NEON_GVEC_VOP2i_ENV(neon_uqshli_d, uint64_t)
#undef NEON_FN
...
#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_bhs(src1, (int8_t)src2, 8, false, env->vfp.qc))
NEON_VOP_ENV(qshl_s8, neon_s8, 4)
NEON_GVEC_VOP2_ENV(neon_sqshl_b, int8_t)
NEON_GVEC_VOP2i_ENV(neon_sqshli_b, int8_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_bhs(src1, (int8_t)src2, 16, false, env->vfp.qc))
    NEON_VOP_ENV(qshl_s16, neon_s16, 2) NEON_GVEC_VOP2_ENV(neon_sqshl_h, int16_t)
        NEON_GVEC_VOP2i_ENV(neon_sqshli_h, int16_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_bhs(src1, (int8_t)src2, 32, false, env->vfp.qc))
            NEON_GVEC_VOP2_ENV(neon_sqshl_s, int32_t) NEON_GVEC_VOP2i_ENV(neon_sqshli_s, int32_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_d(src1, (int8_t)src2, false, env->vfp.qc))
                NEON_GVEC_VOP2_ENV(neon_sqshl_d, int64_t) NEON_GVEC_VOP2i_ENV(neon_sqshli_d, int64_t)
#undef NEON_FN
...
#define NEON_FN(dest, src1, src2) (dest = do_suqrshl_bhs(src1, (int8_t)src2, 8, false, env->vfp.qc))
NEON_VOP_ENV(qshlu_s8, neon_s8, 4)
NEON_GVEC_VOP2i_ENV(neon_sqshlui_b, int8_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_suqrshl_bhs(src1, (int8_t)src2, 16, false, env->vfp.qc))
    NEON_VOP_ENV(qshlu_s16, neon_s16, 2) NEON_GVEC_VOP2i_ENV(neon_sqshlui_h, int16_t)
#undef NEON_FN
...
#define NEON_FN(dest, src1, src2) (dest = do_suqrshl_bhs(src1, (int8_t)src2, 32, false, env->vfp.qc))
NEON_GVEC_VOP2i_ENV(neon_sqshlui_s, int32_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_suqrshl_d(src1, (int8_t)src2, false, env->vfp.qc))
    NEON_GVEC_VOP2i_ENV(neon_sqshlui_d, int64_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_bhs(src1, (int8_t)src2, 8, true, env->vfp.qc))
        NEON_VOP_ENV(qrshl_u8, neon_u8, 4) NEON_GVEC_VOP2_ENV(neon_uqrshl_b, uint8_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_bhs(src1, (int8_t)src2, 16, true, env->vfp.qc))
            NEON_VOP_ENV(qrshl_u16, neon_u16, 2) NEON_GVEC_VOP2_ENV(neon_uqrshl_h, uint16_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_bhs(src1, (int8_t)src2, 32, true, env->vfp.qc))
                NEON_GVEC_VOP2_ENV(neon_uqrshl_s, uint32_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_uqrshl_d(src1, (int8_t)src2, true, env->vfp.qc))
...
#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_bhs(src1, (int8_t)src2, 8, true, env->vfp.qc))
NEON_VOP_ENV(qrshl_s8, neon_s8, 4)
NEON_GVEC_VOP2_ENV(neon_sqrshl_b, int8_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_bhs(src1, (int8_t)src2, 16, true, env->vfp.qc))
NEON_VOP_ENV(qrshl_s16, neon_s16, 2)
NEON_GVEC_VOP2_ENV(neon_sqrshl_h, int16_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_bhs(src1, (int8_t)src2, 32, true, env->vfp.qc))
NEON_GVEC_VOP2_ENV(neon_sqrshl_s, int32_t)
#undef NEON_FN

#define NEON_FN(dest, src1, src2) (dest = do_sqrshl_d(src1, (int8_t)src2, true, env->vfp.qc))
...
/* Only the low 32-bits of output are significant. */
uint64_t HELPER(neon_narrow_u16)(uint64_t x) { return (x & 0xffffu) | ((x >> 16) & 0xffff0000u); }

uint32_t HELPER(neon_narrow_high_u8)(uint64_t x)
{ return ((x >> 8) & 0xff) | ((x >> 16) & 0xff00) | ((x >> 24) & 0xff0000) | ((x >> 32) & 0xff000000); }

uint32_t HELPER(neon_narrow_high_u16)(uint64_t x) { return ((x >> 16) & 0xffff) | ((x >> 32) & 0xffff0000); }
