 ...
 * The controlling predicate is known to be true.
 */
typedef void sve_ldst1_tlb_fn(CPUARMState* env, void* vd, intptr_t reg_off, target_ulong vaddr, uintptr_t retaddr);
...
#define DO_LD_TLB(NAME, H, TYPEE, TYPEM, TLB)                                                                          \
    static inline void sve_##NAME##_tlb(CPUARMState* env, void* vd, intptr_t reg_off, target_ulong addr, uintptr_t ra) \
    {                                                                                                                  \
...
static inline void sve_ld1qq_be_tlb(CPUARMState* env, void* vd, intptr_t reg_off, target_ulong addr, uintptr_t ra)
{
    sve_ld1dd_be_tlb(env, vd, reg_off + 8, addr, ra);
    sve_ld1dd_be_tlb(env, vd, reg_off, addr + 8, ra);
}

static inline void sve_ld1qq_le_tlb(CPUARMState* env, void* vd, intptr_t reg_off, target_ulong addr, uintptr_t ra)
{
...
static inline void sve_st1qq_be_tlb(CPUARMState* env, void* vd, intptr_t reg_off, target_ulong addr, uintptr_t ra)
{
    sve_st1dd_be_tlb(env, vd, reg_off + 8, addr, ra);
    sve_st1dd_be_tlb(env, vd, reg_off, addr + 8, ra);
}

static inline void sve_st1qq_le_tlb(CPUARMState* env, void* vd, intptr_t reg_off, target_ulong addr, uintptr_t ra)
{
