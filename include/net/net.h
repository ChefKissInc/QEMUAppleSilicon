...
#define MAC_ARG(x)                                                                                      \
    ((uint8_t*)(x))[0], ((uint8_t*)(x))[1], ((uint8_t*)(x))[2], ((uint8_t*)(x))[3], ((uint8_t*)(x))[4], \
        ((uint8_t*)(x))[5]
...
#define DEFINE_NIC_PROPERTIES(_state, _conf)                                                             \
    DEFINE_PROP_MACADDR("mac", _state, _conf.macaddr), DEFINE_PROP_NETDEV("netdev", _state, _conf.peers)
...
ssize_t qemu_sendv_packet_async(NetClientState* nc, const struct iovec* iov, int iovcnt, NetPacketSent* sent_cb);
ssize_t qemu_send_packet(NetClientState* nc, const uint8_t* buf, int size);
ssize_t qemu_receive_packet(NetClientState* nc, const uint8_t* buf, int size);
ssize_t qemu_send_packet_raw(NetClientState* nc, const uint8_t* buf, int size);
ssize_t qemu_send_packet_async(NetClientState* nc, const uint8_t* buf, int size, NetPacketSent* sent_cb);
...
static inline bool net_peer_needs_padding(NetClientState* nc) { return nc->peer && !nc->peer->do_not_pad; }
