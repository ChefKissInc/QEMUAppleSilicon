...
typedef void G_GNUC_PRINTF(2, 3) ReadLinePrintfFunc(void* opaque, const char* fmt, ...);
...
void readline_start(ReadLineState* rs, const char* prompt, int read_password, ReadLineFunc* readline_func,
                    void* readline_opaque);
