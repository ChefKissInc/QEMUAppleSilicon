...
#define qatomic_rcu_read(ptr) qatomic_rcu_read_internal((ptr), MAKE_IDENTIFIER(_val))
...
#define qatomic_fetch_inc_nonzero(ptr)                                                                  \
    ({                                                                                                  \
        ...
        while (_oldn && qatomic_cmpxchg(ptr, _oldn, _oldn + 1) != _oldn) { _oldn = qatomic_read(ptr); } \
        _oldn;                                                                                          \
    })
