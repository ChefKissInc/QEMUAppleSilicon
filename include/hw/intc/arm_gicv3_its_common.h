 ...
 */
static inline void gicv3_add_its(GICv3State* s, DeviceState* its) { g_ptr_array_add(s->itslist, its); }
...
DECLARE_OBJ_CHECKERS(GICv3ITSState, GICv3ITSCommonClass, ARM_GICV3_ITS_COMMON, TYPE_ARM_GICV3_ITS_COMMON)
