...
DECLARE_CLASS_CHECKERS_IF(InterruptStatsProviderClass, INTERRUPT_STATS_PROVIDER, TYPE_INTERRUPT_STATS_PROVIDER)
#define INTERRUPT_STATS_PROVIDER(obj) INTERFACE_CHECK(InterruptStatsProvider, (obj), TYPE_INTERRUPT_STATS_PROVIDER)
...
struct InterruptStatsProviderClass
{
     ...
     */
    bool (*get_statistics)(InterruptStatsProvider* obj, uint64_t** irq_counts, unsigned int* nb_irqs);
