...
#define REG_FIELD(_reg, _field, _shift, _length)                      \
    enum                                                              \
    {                                                                 \
        R_##_reg##_##_field##_SHIFT = (_shift)                        \
    };                                                                \
    enum                                                              \
    {                                                                 \
        R_##_reg##_##_field##_LENGTH = (_length)                      \
    };                                                                \
    enum                                                              \
    {                                                                 \
        R_##_reg##_##_field##_MASK = MAKE_64BIT_MASK(_shift, _length) \
    };

#define REG_FIELD_EX8(_storage, _reg, _field)                                       \
    extract8((_storage), R_##_reg##_##_field##_SHIFT, R_##_reg##_##_field##_LENGTH)
#define REG_FIELD_EX16(_storage, _reg, _field)                                       \
    extract16((_storage), R_##_reg##_##_field##_SHIFT, R_##_reg##_##_field##_LENGTH)
#define REG_FIELD_EX32(_storage, _reg, _field)                                       \
    extract32((_storage), R_##_reg##_##_field##_SHIFT, R_##_reg##_##_field##_LENGTH)
#define REG_FIELD_EX64(_storage, _reg, _field)                                       \
    extract64((_storage), R_##_reg##_##_field##_SHIFT, R_##_reg##_##_field##_LENGTH)

#define REG_FIELD_SEX8(_storage, _reg, _field)                                       \
    sextract8((_storage), R_##_reg##_##_field##_SHIFT, R_##_reg##_##_field##_LENGTH)
#define REG_FIELD_SEX16(_storage, _reg, _field)                                       \
    sextract16((_storage), R_##_reg##_##_field##_SHIFT, R_##_reg##_##_field##_LENGTH)
#define REG_FIELD_SEX32(_storage, _reg, _field)                                       \
    sextract32((_storage), R_##_reg##_##_field##_SHIFT, R_##_reg##_##_field##_LENGTH)
#define REG_FIELD_SEX64(_storage, _reg, _field)                                       \
    sextract64((_storage), R_##_reg##_##_field##_SHIFT, R_##_reg##_##_field##_LENGTH)

#define REG_ARRAY_FIELD_EX32(_regs, _reg, _field) REG_FIELD_EX32((_regs)[R_##_reg], _reg, _field)
#define REG_ARRAY_FIELD_EX64(_regs, _reg, _field) REG_FIELD_EX64((_regs)[R_##_reg], _reg, _field)
...
#define SHARED_REG_FIELD(_name, _shift, _length)          \
    enum                                                  \
    {                                                     \
        _name##_##SHIFT = (_shift)                        \
    };                                                    \
    enum                                                  \
    {                                                     \
        _name##_##LENGTH = (_length)                      \
    };                                                    \
    enum                                                  \
    {                                                     \
        _name##_##MASK = MAKE_64BIT_MASK(_shift, _length) \
    };

#define SHARED_REG_FIELD_EX8(_storage, _field)  extract8((_storage), _field##_SHIFT, _field##_LENGTH)
#define SHARED_REG_FIELD_EX16(_storage, _field) extract16((_storage), _field##_SHIFT, _field##_LENGTH)
#define SHARED_REG_FIELD_EX32(_storage, _field) extract32((_storage), _field##_SHIFT, _field##_LENGTH)
#define SHARED_REG_FIELD_EX64(_storage, _field) extract64((_storage), _field##_SHIFT, _field##_LENGTH)

#define SHARED_REG_ARRAY_FIELD_EX32(_regs, _offset, _field) SHARED_REG_FIELD_EX32((_regs)[(_offset)], _field)
#define SHARED_REG_ARRAY_FIELD_EX64(_regs, _offset, _field) SHARED_REG_FIELD_EX64((_regs)[(_offset)], _field)
...
#define SHARED_REG_ARRAY_FIELD_DP32(_regs, _offset, _field, _val)                 \
    (_regs)[(_offset)] = SHARED_REG_FIELD_DP32((_regs)[(_offset)], _field, _val);
#define SHARED_REG_ARRAY_FIELD_DP64(_regs, _offset, _field, _val)                 \
    (_regs)[(_offset)] = SHARED_REG_FIELD_DP64((_regs)[(_offset)], _field, _val);
