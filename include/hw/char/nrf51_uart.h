...
REG32(UART_INTEN, 0x300)
    REG_FIELD(UART_INTEN, CTS, 0, 1)
    REG_FIELD(UART_INTEN, NCTS, 1, 1)
    REG_FIELD(UART_INTEN, RXDRDY, 2, 1)
    REG_FIELD(UART_INTEN, TXDRDY, 7, 1)
    REG_FIELD(UART_INTEN, ERROR, 9, 1)
    REG_FIELD(UART_INTEN, RXTO, 17, 1)
