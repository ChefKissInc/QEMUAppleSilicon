...
REG32(CRB_LOC_STATE, 0x00)
  REG_FIELD(CRB_LOC_STATE, tpmEstablished, 0, 1)
  REG_FIELD(CRB_LOC_STATE, locAssigned, 1, 1)
  REG_FIELD(CRB_LOC_STATE, activeLocality, 2, 3)
  REG_FIELD(CRB_LOC_STATE, reserved, 5, 2)
  REG_FIELD(CRB_LOC_STATE, tpmRegValidSts, 7, 1)
REG32(CRB_LOC_CTRL, 0x08)
REG32(CRB_LOC_STS, 0x0C)
  REG_FIELD(CRB_LOC_STS, Granted, 0, 1)
  REG_FIELD(CRB_LOC_STS, beenSeized, 1, 1)
REG32(CRB_INTF_ID, 0x30)
  REG_FIELD(CRB_INTF_ID, InterfaceType, 0, 4)
  REG_FIELD(CRB_INTF_ID, InterfaceVersion, 4, 4)
  REG_FIELD(CRB_INTF_ID, CapLocality, 8, 1)
  REG_FIELD(CRB_INTF_ID, CapCRBIdleBypass, 9, 1)
  REG_FIELD(CRB_INTF_ID, Reserved1, 10, 1)
  REG_FIELD(CRB_INTF_ID, CapDataXferSizeSupport, 11, 2)
  REG_FIELD(CRB_INTF_ID, CapFIFO, 13, 1)
  REG_FIELD(CRB_INTF_ID, CapCRB, 14, 1)
  REG_FIELD(CRB_INTF_ID, CapIFRes, 15, 2)
  REG_FIELD(CRB_INTF_ID, InterfaceSelector, 17, 2)
  REG_FIELD(CRB_INTF_ID, IntfSelLock, 19, 1)
  REG_FIELD(CRB_INTF_ID, Reserved2, 20, 4)
  REG_FIELD(CRB_INTF_ID, RID, 24, 8)
REG32(CRB_INTF_ID2, 0x34)
  REG_FIELD(CRB_INTF_ID2, VID, 0, 16)
  REG_FIELD(CRB_INTF_ID2, DID, 16, 16)
REG32(CRB_CTRL_EXT, 0x38)
REG32(CRB_CTRL_REQ, 0x40)
REG32(CRB_CTRL_STS, 0x44)
  REG_FIELD(CRB_CTRL_STS, tpmSts, 0, 1)
  REG_FIELD(CRB_CTRL_STS, tpmIdle, 1, 1)
