...
/* PLLs */
REG32(CM_PLLA, 0x104)
    REG_FIELD(CM_PLLA, LOADDSI0, 0, 1)
    REG_FIELD(CM_PLLA, HOLDDSI0, 1, 1)
    REG_FIELD(CM_PLLA, LOADCCP2, 2, 1)
    REG_FIELD(CM_PLLA, HOLDCCP2, 3, 1)
    REG_FIELD(CM_PLLA, LOADCORE, 4, 1)
    REG_FIELD(CM_PLLA, HOLDCORE, 5, 1)
    REG_FIELD(CM_PLLA, LOADPER, 6, 1)
    REG_FIELD(CM_PLLA, HOLDPER, 7, 1)
    REG_FIELD(CM_PLLx, ANARST, 8, 1)
REG32(CM_PLLC, 0x108)
    REG_FIELD(CM_PLLC, LOADCORE0, 0, 1)
    REG_FIELD(CM_PLLC, HOLDCORE0, 1, 1)
    REG_FIELD(CM_PLLC, LOADCORE1, 2, 1)
    REG_FIELD(CM_PLLC, HOLDCORE1, 3, 1)
    REG_FIELD(CM_PLLC, LOADCORE2, 4, 1)
    REG_FIELD(CM_PLLC, HOLDCORE2, 5, 1)
    REG_FIELD(CM_PLLC, LOADPER, 6, 1)
    REG_FIELD(CM_PLLC, HOLDPER, 7, 1)
REG32(CM_PLLD, 0x10c)
    REG_FIELD(CM_PLLD, LOADDSI0, 0, 1)
    REG_FIELD(CM_PLLD, HOLDDSI0, 1, 1)
    REG_FIELD(CM_PLLD, LOADDSI1, 2, 1)
    REG_FIELD(CM_PLLD, HOLDDSI1, 3, 1)
    REG_FIELD(CM_PLLD, LOADCORE, 4, 1)
    REG_FIELD(CM_PLLD, HOLDCORE, 5, 1)
    REG_FIELD(CM_PLLD, LOADPER, 6, 1)
    REG_FIELD(CM_PLLD, HOLDPER, 7, 1)
REG32(CM_PLLH, 0x110)
    REG_FIELD(CM_PLLH, LOADPIX, 0, 1)
    REG_FIELD(CM_PLLH, LOADAUX, 1, 1)
    REG_FIELD(CM_PLLH, LOADRCAL, 2, 1)
REG32(CM_PLLB, 0x170)
    REG_FIELD(CM_PLLB, LOADARM, 0, 1)
    REG_FIELD(CM_PLLB, HOLDARM, 1, 1)

REG32(A2W_PLLA_CTRL, 0x1100)
    REG_FIELD(A2W_PLLx_CTRL, NDIV, 0, 10)
    REG_FIELD(A2W_PLLx_CTRL, PDIV, 12, 3)
    REG_FIELD(A2W_PLLx_CTRL, PWRDN, 16, 1)
    REG_FIELD(A2W_PLLx_CTRL, PRST_DISABLE, 17, 1)
...
REG32(A2W_PLLA_ANA1, 0x1014)
    REG_FIELD(A2W_PLLx_ANA1, FB_PREDIV, 14, 1)
...
REG32(A2W_PLLH_ANA1, 0x1074)
    REG_FIELD(A2W_PLLH_ANA1, FB_PREDIV, 11, 1)
...
REG32(A2W_PLLA_FRAC, 0x1200)
    REG_FIELD(A2W_PLLx_FRAC, FRAC, 0, 20)
...
REG32(A2W_PLLA_DSI0, 0x1300)
    REG_FIELD(A2W_PLLx_CHANNELy, DIV, 0, 8)
    REG_FIELD(A2W_PLLx_CHANNELy, DISABLE, 8, 1)
...
REG32(CM_GNRICCTL, 0x000)
    REG_FIELD(CM_CLOCKx_CTL, SRC, 0, 4)
    REG_FIELD(CM_CLOCKx_CTL, ENABLE, 4, 1)
    REG_FIELD(CM_CLOCKx_CTL, KILL, 5, 1)
    REG_FIELD(CM_CLOCKx_CTL, GATE, 6, 1)
    REG_FIELD(CM_CLOCKx_CTL, BUSY, 7, 1)
    REG_FIELD(CM_CLOCKx_CTL, BUSYD, 8, 1)
    REG_FIELD(CM_CLOCKx_CTL, MASH, 9, 2)
    REG_FIELD(CM_CLOCKx_CTL, FLIP, 11, 1)
REG32(CM_GNRICDIV, 0x004)
    REG_FIELD(CM_CLOCKx_DIV, FRAC, 0, 12)
...
/* misc registers */
REG32(CM_LOCK, 0x114)
    REG_FIELD(CM_LOCK, FLOCKH, 12, 1)
    REG_FIELD(CM_LOCK, FLOCKD, 11, 1)
    REG_FIELD(CM_LOCK, FLOCKC, 10, 1)
    REG_FIELD(CM_LOCK, FLOCKB, 9, 1)
    REG_FIELD(CM_LOCK, FLOCKA, 8, 1)

REG32(CM_DSI0HSCK, 0x120)
    REG_FIELD(CM_DSI0HSCK, SELPLLD, 0, 1)

/*
 * This field is common to all registers. Each register write value must match
 * the CPRMAN_PASSWORD magic value in its 8 MSB.
 */
REG_FIELD(CPRMAN, PASSWORD, 24, 8)
