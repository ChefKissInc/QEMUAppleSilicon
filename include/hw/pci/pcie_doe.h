...
REG32(PCI_DOE_CAP_REG, 0)
    REG_FIELD(PCI_DOE_CAP_REG, INTR_SUPP, 0, 1)
    REG_FIELD(PCI_DOE_CAP_REG, DOE_INTR_MSG_NUM, 1, 11)

/* Control Register - r6.0 7.9.24.3 */
#define PCI_EXP_DOE_CTRL            0x08
REG32(PCI_DOE_CAP_CONTROL, 0)
    REG_FIELD(PCI_DOE_CAP_CONTROL, DOE_ABORT, 0, 1)
    REG_FIELD(PCI_DOE_CAP_CONTROL, DOE_INTR_EN, 1, 1)
    REG_FIELD(PCI_DOE_CAP_CONTROL, DOE_GO, 31, 1)

/* Status Register - r6.0 7.9.24.4 */
#define PCI_EXP_DOE_STATUS          0x0c
REG32(PCI_DOE_CAP_STATUS, 0)
    REG_FIELD(PCI_DOE_CAP_STATUS, DOE_BUSY, 0, 1)
    REG_FIELD(PCI_DOE_CAP_STATUS, DOE_INTR_STATUS, 1, 1)
    REG_FIELD(PCI_DOE_CAP_STATUS, DOE_ERROR, 2, 1)
    REG_FIELD(PCI_DOE_CAP_STATUS, DATA_OBJ_RDY, 31, 1)
