...
#define DEFINE_PROP_RESERVED_REGION(_n, _s, _f) DEFINE_PROP(_n, _s, _f, qdev_prop_reserved_region, ReservedRegion)
#define DEFINE_PROP_MULTIFD_COMPRESSION(_n, _s, _f, _d)                                   \
    DEFINE_PROP_SIGNED(_n, _s, _f, _d, qdev_prop_multifd_compression, MultiFDCompression)
#define DEFINE_PROP_MIG_MODE(_n, _s, _f, _d) DEFINE_PROP_SIGNED(_n, _s, _f, _d, qdev_prop_mig_mode, MigMode)
#define DEFINE_PROP_ZERO_PAGE_DETECTION(_n, _s, _f, _d)                                  \
    DEFINE_PROP_SIGNED(_n, _s, _f, _d, qdev_prop_zero_page_detection, ZeroPageDetection)
#define DEFINE_PROP_BLOCKDEV_ON_ERROR(_n, _s, _f, _d)                                \
    DEFINE_PROP_SIGNED(_n, _s, _f, _d, qdev_prop_blockdev_on_error, BlockdevOnError)
#define DEFINE_PROP_BIOS_CHS_TRANS(_n, _s, _f, _d) DEFINE_PROP_SIGNED(_n, _s, _f, _d, qdev_prop_bios_chs_trans, int)
#define DEFINE_PROP_BLOCKSIZE(_n, _s, _f)          DEFINE_PROP_UNSIGNED(_n, _s, _f, 0, qdev_prop_blocksize, uint32_t)
#define DEFINE_PROP_PCI_HOST_DEVADDR(_n, _s, _f)                              \
    DEFINE_PROP(_n, _s, _f, qdev_prop_pci_host_devaddr, PCIHostDeviceAddress)
#define DEFINE_PROP_OFF_AUTO_PCIBAR(_n, _s, _f, _d)                              \
    DEFINE_PROP_SIGNED(_n, _s, _f, _d, qdev_prop_off_auto_pcibar, OffAutoPCIBAR)
#define DEFINE_PROP_PCIE_LINK_SPEED(_n, _s, _f, _d)                                \
    DEFINE_PROP_SIGNED(_n, _s, _f, _d, qdev_prop_pcie_link_speed, PCIExpLinkSpeed)
#define DEFINE_PROP_PCIE_LINK_WIDTH(_n, _s, _f, _d)                                \
    DEFINE_PROP_SIGNED(_n, _s, _f, _d, qdev_prop_pcie_link_width, PCIExpLinkWidth)

#define DEFINE_PROP_UUID(_name, _state, _field)                                       \
    DEFINE_PROP(_name, _state, _field, qdev_prop_uuid, QemuUUID, .set_default = true)

#define DEFINE_PROP_AUDIODEV(_n, _s, _f) DEFINE_PROP(_n, _s, _f, qdev_prop_audiodev, QEMUSoundCard)

#define DEFINE_PROP_UUID_NODEFAULT(_name, _state, _field) DEFINE_PROP(_name, _state, _field, qdev_prop_uuid, QemuUUID)

#define DEFINE_PROP_ENDIAN(_name, _state, _field, _default)                                  \
    DEFINE_PROP_UNSIGNED(_name, _state, _field, _default, qdev_prop_endian_mode, EndianMode)
