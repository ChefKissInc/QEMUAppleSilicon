...
struct PropertyInfo
{
    ...
    ObjectProperty*         (*create)(ObjectClass* oc, const char* name, const Property* prop);
...
#define DEFINE_PROP(_name, _state, _field, _prop, _type, ...)                              \
    {.name   = (_name),                                                                    \
     .info   = &(_prop),                                                                   \
     .offset = offsetof(_state, _field) + type_check(_type, typeof_field(_state, _field)), \
     __VA_ARGS__}

#define DEFINE_PROP_SIGNED(_name, _state, _field, _defval, _prop, _type)                              \
    DEFINE_PROP(_name, _state, _field, _prop, _type, .set_default = true, .defval.i = (_type)_defval)

#define DEFINE_PROP_SIGNED_NODEFAULT(_name, _state, _field, _prop, _type) \
    DEFINE_PROP(_name, _state, _field, _prop, _type)

#define DEFINE_PROP_BIT(_name, _state, _field, _bit, _defval)                                         \
    DEFINE_PROP(_name, _state, _field, qdev_prop_bit, uint32_t, .bitnr = (_bit), .set_default = true, \
                .defval.u = (bool)_defval)

#define DEFINE_PROP_UNSIGNED(_name, _state, _field, _defval, _prop, _type)                            \
    DEFINE_PROP(_name, _state, _field, _prop, _type, .set_default = true, .defval.u = (_type)_defval)

#define DEFINE_PROP_UNSIGNED_NODEFAULT(_name, _state, _field, _prop, _type) \
    DEFINE_PROP(_name, _state, _field, _prop, _type)

#define DEFINE_PROP_BIT64(_name, _state, _field, _bit, _defval)                                         \
    DEFINE_PROP(_name, _state, _field, qdev_prop_bit64, uint64_t, .bitnr = (_bit), .set_default = true, \
                .defval.u = (bool)_defval)

#define DEFINE_PROP_ON_OFF_AUTO_BIT64(_name, _state, _field, _bit, _defval)                          \
    DEFINE_PROP(_name, _state, _field, qdev_prop_on_off_auto_bit64, OnOffAutoBit64, .bitnr = (_bit), \
                .set_default = true, .defval.i = (OnOffAuto)_defval)

#define DEFINE_PROP_BOOL(_name, _state, _field, _defval)                                                     \
    DEFINE_PROP(_name, _state, _field, qdev_prop_bool, bool, .set_default = true, .defval.u = (bool)_defval)
...
#define DEFINE_PROP_UINT64_CHECKMASK(_name, _state, _field, _bitmask)                               \
    DEFINE_PROP(_name, _state, _field, qdev_prop_uint64_checkmask, uint64_t, .bitmask = (_bitmask), \
                .set_default = false)
...
#define DEFINE_PROP_ARRAY(_name, _state, _field, _arrayfield, _arrayprop, _arraytype)                 \
    DEFINE_PROP(_name, _state, _field, qdev_prop_array, uint32_t, .set_default = true, .defval.u = 0, \
                .arrayinfo = &(_arrayprop), .arrayfieldsize = sizeof(_arraytype),                     \
                .arrayoffset = offsetof(_state, _arrayfield))

#define DEFINE_PROP_LINK(_name, _state, _field, _type, _ptr_type)                     \
    DEFINE_PROP(_name, _state, _field, qdev_prop_link, _ptr_type, .link_type = _type)
...
#define DEFINE_PROP_SIZE32(_n, _s, _f, _d)      DEFINE_PROP_UNSIGNED(_n, _s, _f, _d, qdev_prop_size32, uint32_t)
