...
REG32(CXL_CAPABILITY_HEADER, 0)
    REG_FIELD(CXL_CAPABILITY_HEADER, ID, 0, 16)
    REG_FIELD(CXL_CAPABILITY_HEADER, VERSION, 16, 4)
    REG_FIELD(CXL_CAPABILITY_HEADER, CACHE_MEM_VERSION, 20, 4)
    REG_FIELD(CXL_CAPABILITY_HEADER, ARRAY_SIZE, 24, 8)

#define CXLx_CAPABILITY_HEADER(type, offset)                  \
    REG32(CXL_##type##_CAPABILITY_HEADER, offset)             \
        REG_FIELD(CXL_##type##_CAPABILITY_HEADER, ID, 0, 16)      \
        REG_FIELD(CXL_##type##_CAPABILITY_HEADER, VERSION, 16, 4) \
        REG_FIELD(CXL_##type##_CAPABILITY_HEADER, PTR, 20, 12)
...
REG32(CXL_RAS_ERR_CAP_CTRL, CXL_RAS_REGISTERS_OFFSET + 0x14)
    REG_FIELD(CXL_RAS_ERR_CAP_CTRL, FIRST_ERROR_POINTER, 0, 6)
    REG_FIELD(CXL_RAS_ERR_CAP_CTRL, MULTIPLE_HEADER_RECORDING_CAP, 9, 1)
    REG_FIELD(CXL_RAS_ERR_POISON_ENABLED, POISON_ENABLED, 13, 1)
...
#define HDM_DECODER_INIT(n)                                                    \
  REG32(CXL_HDM_DECODER##n##_BASE_LO,                                          \
        CXL_HDM_REGISTERS_OFFSET + (0x20 * n) + 0x10)                          \
            REG_FIELD(CXL_HDM_DECODER##n##_BASE_LO, L, 28, 4)                      \
  ...
  REG32(CXL_HDM_DECODER##n##_CTRL,                                             \
        CXL_HDM_REGISTERS_OFFSET + (0x20 * n) + 0x20)                          \
            REG_FIELD(CXL_HDM_DECODER##n##_CTRL, IG, 0, 4)                         \
            REG_FIELD(CXL_HDM_DECODER##n##_CTRL, IW, 4, 4)                         \
            REG_FIELD(CXL_HDM_DECODER##n##_CTRL, LOCK_ON_COMMIT, 8, 1)             \
            REG_FIELD(CXL_HDM_DECODER##n##_CTRL, COMMIT, 9, 1)                     \
            REG_FIELD(CXL_HDM_DECODER##n##_CTRL, COMMITTED, 10, 1)                 \
            REG_FIELD(CXL_HDM_DECODER##n##_CTRL, ERR, 11, 1)                       \
            REG_FIELD(CXL_HDM_DECODER##n##_CTRL, TYPE, 12, 1)                      \
            REG_FIELD(CXL_HDM_DECODER##n##_CTRL, BI, 13, 1)                        \
            REG_FIELD(CXL_HDM_DECODER##n##_CTRL, UIO, 14, 1)                       \
            REG_FIELD(CXL_HDM_DECODER##n##_CTRL, UIG, 16, 4)                       \
            REG_FIELD(CXL_HDM_DECODER##n##_CTRL, UIW, 20, 4)                       \
            REG_FIELD(CXL_HDM_DECODER##n##_CTRL, ISP, 24, 4)                       \
...
REG32(CXL_HDM_DECODER_CAPABILITY, CXL_HDM_REGISTERS_OFFSET)
    REG_FIELD(CXL_HDM_DECODER_CAPABILITY, DECODER_COUNT, 0, 4)
    REG_FIELD(CXL_HDM_DECODER_CAPABILITY, TARGET_COUNT, 4, 4)
    REG_FIELD(CXL_HDM_DECODER_CAPABILITY, INTERLEAVE_256B, 8, 1)
    REG_FIELD(CXL_HDM_DECODER_CAPABILITY, INTERLEAVE_4K, 9, 1)
    REG_FIELD(CXL_HDM_DECODER_CAPABILITY, POISON_ON_ERR_CAP, 10, 1)
    REG_FIELD(CXL_HDM_DECODER_CAPABILITY, 3_6_12_WAY, 11, 1)
    REG_FIELD(CXL_HDM_DECODER_CAPABILITY, 16_WAY, 12, 1)
    REG_FIELD(CXL_HDM_DECODER_CAPABILITY, UIO, 13, 1)
    REG_FIELD(CXL_HDM_DECODER_CAPABILITY, UIO_DECODER_COUNT, 16, 4)
    REG_FIELD(CXL_HDM_DECODER_CAPABILITY, MEMDATA_NXM_CAP, 20, 1)
    REG_FIELD(CXL_HDM_DECODER_CAPABILITY, SUPPORTED_COHERENCY_MODEL, 21, 2)
REG32(CXL_HDM_DECODER_GLOBAL_CONTROL, CXL_HDM_REGISTERS_OFFSET + 4)
    REG_FIELD(CXL_HDM_DECODER_GLOBAL_CONTROL, POISON_ON_ERR_EN, 0, 1)
    REG_FIELD(CXL_HDM_DECODER_GLOBAL_CONTROL, HDM_DECODER_ENABLE, 1, 1)
