...
REG_FIELD(CAP, NUTRS, 0, 5)
REG_FIELD(CAP, RTT, 8, 8)
REG_FIELD(CAP, NUTMRS, 16, 3)
REG_FIELD(CAP, AUTOH8, 23, 1)
REG_FIELD(CAP, 64AS, 24, 1)
REG_FIELD(CAP, OODDS, 25, 1)
REG_FIELD(CAP, UICDMETMS, 26, 1)
REG_FIELD(CAP, CS, 28, 1)
REG_FIELD(CAP, LSDBS, 29, 1)
REG_FIELD(CAP, MCQS, 30, 1)
REG32(MCQCAP, offsetof(UfsReg, mcqcap))
REG_FIELD(MCQCAP, MAXQ, 0, 8)
REG_FIELD(MCQCAP, SP, 8, 1)
REG_FIELD(MCQCAP, RRP, 9, 1)
REG_FIELD(MCQCAP, EIS, 10, 1)
REG_FIELD(MCQCAP, QCFGPTR, 16, 8)
REG_FIELD(MCQCAP, MIAG, 24, 8)
...
REG_FIELD(IS, UTRCS, 0, 1)
REG_FIELD(IS, UDEPRI, 1, 1)
REG_FIELD(IS, UE, 2, 1)
REG_FIELD(IS, UTMS, 3, 1)
REG_FIELD(IS, UPMS, 4, 1)
REG_FIELD(IS, UHXS, 5, 1)
REG_FIELD(IS, UHES, 6, 1)
REG_FIELD(IS, ULLS, 7, 1)
REG_FIELD(IS, ULSS, 8, 1)
REG_FIELD(IS, UTMRCS, 9, 1)
REG_FIELD(IS, UCCS, 10, 1)
REG_FIELD(IS, DFES, 11, 1)
REG_FIELD(IS, UTPES, 12, 1)
REG_FIELD(IS, HCFES, 16, 1)
REG_FIELD(IS, SBFES, 17, 1)
REG_FIELD(IS, CEFES, 18, 1)
REG_FIELD(IS, CQES, 20, 1)
REG32(IE, offsetof(UfsReg, ie))
REG_FIELD(IE, UTRCE, 0, 1)
REG_FIELD(IE, UDEPRIE, 1, 1)
REG_FIELD(IE, UEE, 2, 1)
REG_FIELD(IE, UTMSE, 3, 1)
REG_FIELD(IE, UPMSE, 4, 1)
REG_FIELD(IE, UHXSE, 5, 1)
REG_FIELD(IE, UHESE, 6, 1)
REG_FIELD(IE, ULLSE, 7, 1)
REG_FIELD(IE, ULSSE, 8, 1)
REG_FIELD(IE, UTMRCE, 9, 1)
REG_FIELD(IE, UCCE, 10, 1)
REG_FIELD(IE, DFEE, 11, 1)
REG_FIELD(IE, UTPEE, 12, 1)
REG_FIELD(IE, HCFEE, 16, 1)
REG_FIELD(IE, SBFEE, 17, 1)
REG_FIELD(IE, CEFEE, 18, 1)
REG_FIELD(IE, CQEE, 20, 1)
REG32(HCS, offsetof(UfsReg, hcs))
REG_FIELD(HCS, DP, 0, 1)
REG_FIELD(HCS, UTRLRDY, 1, 1)
REG_FIELD(HCS, UTMRLRDY, 2, 1)
REG_FIELD(HCS, UCRDY, 3, 1)
REG_FIELD(HCS, UPMCRS, 8, 3)
REG32(HCE, offsetof(UfsReg, hce))
REG_FIELD(HCE, HCE, 0, 1)
REG_FIELD(HCE, CGE, 1, 1)
...
REG_FIELD(UTMRLBA, UTMRLBA, 10, 22)
...
REG_FIELD(CONFIG, QT, 0, 1)
REG32(MCQCONFIG, offsetof(UfsReg, mcqconfig))
REG_FIELD(MCQCONFIG, MAC, 8, 8)

#define UFS_INTR_MASK                                                                                       \
    ((1 << R_IS_CQES_SHIFT) | (1 << R_IS_CEFES_SHIFT) | (1 << R_IS_SBFES_SHIFT) | (1 << R_IS_HCFES_SHIFT)   \
     | (1 << R_IS_UTPES_SHIFT) | (1 << R_IS_DFES_SHIFT) | (1 << R_IS_UCCS_SHIFT) | (1 << R_IS_UTMRCS_SHIFT) \
     | (1 << R_IS_ULSS_SHIFT) | (1 << R_IS_ULLS_SHIFT) | (1 << R_IS_UHES_SHIFT) | (1 << R_IS_UHXS_SHIFT)    \
     | (1 << R_IS_UPMS_SHIFT) | (1 << R_IS_UTMS_SHIFT) | (1 << R_IS_UE_SHIFT) | (1 << R_IS_UDEPRI_SHIFT)    \
     | (1 << R_IS_UTRCS_SHIFT))
...
#define UFS_UPIU_HEADER_TRANSACTION_TYPE(dword0)                                                              \
    ((be32_to_cpu(dword0) >> UFS_UPIU_HEADER_TRANSACTION_TYPE_SHIFT) & UFS_UPIU_HEADER_TRANSACTION_TYPE_MASK)
...
#define UFS_UPIU_HEADER_QUERY_FUNC(dword1)                                                        \
    ((be32_to_cpu(dword1) >> UFS_UPIU_HEADER_QUERY_FUNC_SHIFT) & UFS_UPIU_HEADER_QUERY_FUNC_MASK)
...
#define UFS_UPIU_HEADER_DATA_SEGMENT_LENGTH(dword2)                                                                 \
    ((be32_to_cpu(dword2) >> UFS_UPIU_HEADER_DATA_SEGMENT_LENGTH_SHIFT) & UFS_UPIU_HEADER_DATA_SEGMENT_LENGTH_MASK)
...
REG_FIELD(SQATTR, SIZE, 0, 16)
REG_FIELD(SQATTR, CQID, 16, 8)
REG_FIELD(SQATTR, SQPL, 28, 3)
REG_FIELD(SQATTR, SQEN, 31, 1)
...
REG_FIELD(CQATTR, SIZE, 0, 16)
REG_FIELD(CQATTR, CQEN, 31, 1)
