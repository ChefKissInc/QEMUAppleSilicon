...
#define TLB_SLOW_FLAGS_MASK (TLB_BSWAP | TLB_WATCHPOINT | TLB_CHECK_ALIGNED | TLB_DISCARD_WRITE | TLB_MMIO)
 ...
 * in a TCG backend.
 */
#define TLB_FLAGS_MASK (TLB_INVALID_MASK | TLB_NOTDIRTY | TLB_FORCE_SLOW)
