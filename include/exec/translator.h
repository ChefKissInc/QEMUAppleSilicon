...
static inline uint16_t translator_lduw(CPUArchState* env, DisasContextBase* db, vaddr pc)
{ return translator_lduw_end(env, db, pc, MO_TE); }

static inline uint32_t translator_ldl(CPUArchState* env, DisasContextBase* db, vaddr pc)
{ return translator_ldl_end(env, db, pc, MO_TE); }

static inline uint64_t translator_ldq(CPUArchState* env, DisasContextBase* db, vaddr pc)
{ return translator_ldq_end(env, db, pc, MO_TE); }

static inline uint16_t translator_lduw_swap(CPUArchState* env, DisasContextBase* db, vaddr pc, bool do_swap)
{ return translator_lduw_end(env, db, pc, MO_TE ^ (do_swap * MO_BSWAP)); }

static inline uint32_t translator_ldl_swap(CPUArchState* env, DisasContextBase* db, vaddr pc, bool do_swap)
{ return translator_ldl_end(env, db, pc, MO_TE ^ (do_swap * MO_BSWAP)); }

static inline uint64_t translator_ldq_swap(CPUArchState* env, DisasContextBase* db, vaddr pc, bool do_swap)
