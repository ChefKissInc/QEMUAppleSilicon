...
DECLARE_INSTANCE_CHECKER(KVMState, KVM_STATE, TYPE_KVM_ACCEL)
...
int kvm_update_guest_debug(CPUState* cpu, unsigned long reinject_trap);
    #else
static inline int kvm_update_guest_debug(CPUState* cpu, unsigned long reinject_trap) { return -EINVAL; }
    #endif
...
int kvm_physical_memory_addr_from_host(KVMState* s, void* ram_addr, hwaddr* phys_addr);
