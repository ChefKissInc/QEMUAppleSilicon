...
static int qcrypto_tls_creds_anon_load(QCryptoTLSCredsAnon* creds, Error** errp)
{
    g_autofree char* dhparams = NULL;
    int              ret;

    trace_qcrypto_tls_creds_anon_load(creds, creds->parent_obj.dir ? creds->parent_obj.dir : "<nodir>");
    ...
    if (creds->parent_obj.endpoint == QCRYPTO_TLS_CREDS_ENDPOINT_SERVER) {
        ...
        gnutls_anon_set_server_dh_params(creds->data.server, creds->parent_obj.dh_params);
    }
    else {
...
static void qcrypto_tls_creds_anon_unload(QCryptoTLSCredsAnon* creds)
{
...
static void qcrypto_tls_creds_anon_load(QCryptoTLSCredsAnon* creds G_GNUC_UNUSED, Error** errp)
{ error_setg(errp, "TLS credentials support requires GNUTLS"); }

static void qcrypto_tls_creds_anon_unload(QCryptoTLSCredsAnon* creds G_GNUC_UNUSED) { /* nada */ }

#endif /* ! CONFIG_GNUTLS */

static void qcrypto_tls_creds_anon_complete(UserCreatable* uc, Error** errp)
{
...
static void qcrypto_tls_creds_anon_finalize(Object* obj)
{
...
static void qcrypto_tls_creds_anon_class_init(ObjectClass* oc, const void* data)
{
