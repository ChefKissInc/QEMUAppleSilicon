                                ...
                                const uint8_t* key, size_t nkey, Error** errp)
{
    ...
    switch (alg) {
        case QCRYPTO_IV_GEN_ALGO_PLAIN  : ivgen->driver = &qcrypto_ivgen_plain; break;
        case QCRYPTO_IV_GEN_ALGO_PLAIN64: ivgen->driver = &qcrypto_ivgen_plain64; break;
        case QCRYPTO_IV_GEN_ALGO_ESSIV  : ivgen->driver = &qcrypto_ivgen_essiv; break;
        default:
...
QCryptoIVGenAlgo qcrypto_ivgen_get_algorithm(QCryptoIVGen* ivgen) { return ivgen->algorithm; }

QCryptoCipherAlgo qcrypto_ivgen_get_cipher(QCryptoIVGen* ivgen) { return ivgen->cipher; }

QCryptoHashAlgo qcrypto_ivgen_get_hash(QCryptoIVGen* ivgen) { return ivgen->hash; }
