...
#if (defined(__mips_isa_rev) && (__mips_isa_rev >= 1)) || defined(_MIPS_ARCH_LOONGSON2E) \
    || defined(_MIPS_ARCH_LOONGSON2F) || defined(_MIPS_ARCH_MIPS4)
...
static inline bool tcg_target_sextract_valid(TCGType type, unsigned ofs, unsigned len)
{
    if (ofs == 0) {
        switch (len) {
            case 8:
            case 16: return use_mips32r2_instructions;
