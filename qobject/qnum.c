...
{
    switch (qn->kind) {
        case QNUM_I64: *val = qn->u.i64; return true;
        case QNUM_U64:
            if (qn->u.u64 > INT64_MAX) { return false; }
            *val = qn->u.u64;
            return true;
        case QNUM_DOUBLE: return false;
    }
...
bool qnum_get_try_uint(const QNum* qn, uint64_t* val)
{
    switch (qn->kind) {
        case QNUM_I64:
            if (qn->u.i64 < 0) { return false; }
            *val = qn->u.i64;
            return true;
        case QNUM_U64   : *val = qn->u.u64; return true;
        case QNUM_DOUBLE: return false;
    }
...
{
    switch (qn->kind) {
        case QNUM_I64   : return qn->u.i64;
        case QNUM_U64   : return qn->u.u64;
        case QNUM_DOUBLE: return qn->u.dbl;
    }
...
{
    switch (qn->kind) {
        case QNUM_I64: return g_strdup_printf("%" PRId64, qn->u.i64);
        case QNUM_U64: return g_strdup_printf("%" PRIu64, qn->u.u64);
        case QNUM_DOUBLE:
...
bool qnum_is_equal(const QObject* x, const QObject* y)
{
    ...
    switch (num_x->kind) {
        ...
        case QNUM_U64:
            switch (num_y->kind) {
                case QNUM_I64: return qnum_is_equal(y, x);
                case QNUM_U64:
...
void qnum_unref(QNum* q) { qobject_unref(q); }
