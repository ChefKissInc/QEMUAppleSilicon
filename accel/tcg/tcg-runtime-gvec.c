...
static inline void clear_high(void* d, intptr_t oprsz, uint32_t desc)
{
    ...
    if (unlikely(maxsz > oprsz)) {
        for (i = oprsz; i < maxsz; i += sizeof(uint64_t)) { *(uint64_t*)(d + i) = 0; }
    }
}
...
void HELPER(gvec_add8)(void* d, void* a, void* b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint8_t)) { *(uint8_t*)(d + i) = *(uint8_t*)(a + i) + *(uint8_t*)(b + i); }
...
void HELPER(gvec_add16)(void* d, void* a, void* b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint16_t)) { *(uint16_t*)(d + i) = *(uint16_t*)(a + i) + *(uint16_t*)(b + i); }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_add32)(void* d, void* a, void* b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint32_t)) { *(uint32_t*)(d + i) = *(uint32_t*)(a + i) + *(uint32_t*)(b + i); }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_add64)(void* d, void* a, void* b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint64_t)) { *(uint64_t*)(d + i) = *(uint64_t*)(a + i) + *(uint64_t*)(b + i); }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_adds8)(void* d, void* a, uint64_t b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint8_t)) { *(uint8_t*)(d + i) = *(uint8_t*)(a + i) + (uint8_t)b; }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_adds16)(void* d, void* a, uint64_t b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint16_t)) { *(uint16_t*)(d + i) = *(uint16_t*)(a + i) + (uint16_t)b; }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_adds32)(void* d, void* a, uint64_t b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint32_t)) { *(uint32_t*)(d + i) = *(uint32_t*)(a + i) + (uint32_t)b; }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_adds64)(void* d, void* a, uint64_t b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint64_t)) { *(uint64_t*)(d + i) = *(uint64_t*)(a + i) + b; }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_neg8)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint8_t)) { *(uint8_t*)(d + i) = -*(uint8_t*)(a + i); }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_neg16)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint16_t)) { *(uint16_t*)(d + i) = -*(uint16_t*)(a + i); }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_neg32)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint32_t)) { *(uint32_t*)(d + i) = -*(uint32_t*)(a + i); }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_neg64)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint64_t)) { *(uint64_t*)(d + i) = -*(uint64_t*)(a + i); }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_dup64)(void* d, uint32_t desc, uint64_t c)
{
    ...
    if (c == 0) { oprsz = 0; }
        ...
        for (i = 0; i < oprsz; i += sizeof(uint64_t)) { *(uint64_t*)(d + i) = c; }
    }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_dup32)(void* d, uint32_t desc, uint32_t c)
{
    ...
    if (c == 0) { oprsz = 0; }
        ...
        for (i = 0; i < oprsz; i += sizeof(uint32_t)) { *(uint32_t*)(d + i) = c; }
    }
    clear_high(d, oprsz, desc);
}

void HELPER(gvec_dup16)(void* d, uint32_t desc, uint32_t c) { HELPER(gvec_dup32)(d, desc, 0x00010001 * (c & 0xffff)); }
...
void HELPER(gvec_shl8i)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint8_t)) { *(uint8_t*)(d + i) = *(uint8_t*)(a + i) << shift; }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_shl16i)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint16_t)) { *(uint16_t*)(d + i) = *(uint16_t*)(a + i) << shift; }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_shl32i)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint32_t)) { *(uint32_t*)(d + i) = *(uint32_t*)(a + i) << shift; }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_shl64i)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint64_t)) { *(uint64_t*)(d + i) = *(uint64_t*)(a + i) << shift; }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_sar8i)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint8_t)) { *(int8_t*)(d + i) = *(int8_t*)(a + i) >> shift; }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_sar16i)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint16_t)) { *(int16_t*)(d + i) = *(int16_t*)(a + i) >> shift; }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_sar32i)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint32_t)) { *(int32_t*)(d + i) = *(int32_t*)(a + i) >> shift; }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_sar64i)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint64_t)) { *(int64_t*)(d + i) = *(int64_t*)(a + i) >> shift; }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_rotl8i)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint8_t)) { *(uint8_t*)(d + i) = rol8(*(uint8_t*)(a + i), shift); }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_rotl16i)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint16_t)) { *(uint16_t*)(d + i) = rol16(*(uint16_t*)(a + i), shift); }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_rotl32i)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint32_t)) { *(uint32_t*)(d + i) = rol32(*(uint32_t*)(a + i), shift); }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_rotl64i)(void* d, void* a, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint64_t)) { *(uint64_t*)(d + i) = rol64(*(uint64_t*)(a + i), shift); }
    clear_high(d, oprsz, desc);
}
...
#define DO_CMP1(NAME, TYPE, OP)                                                                                 \
    ...
    {                                                                                                           \
        intptr_t oprsz = simd_oprsz(desc);                                                                      \
        intptr_t i;                                                                                             \
        for (i = 0; i < oprsz; i += sizeof(TYPE)) { *(TYPE*)(d + i) = -(*(TYPE*)(a + i) OP * (TYPE*)(b + i)); } \
        clear_high(d, oprsz, desc);                                                                             \
    }
...
#define DO_CMP1(NAME, TYPE, OP)                                                                                   \
    ...
    {                                                                                                             \
        ...
        for (intptr_t i = 0; i < oprsz; i += sizeof(TYPE)) { *(TYPE*)(d + i) = -((*(TYPE*)(a + i) OP b) ^ inv); } \
        clear_high(d, oprsz, desc);                                                                               \
    }
...
void HELPER(gvec_ssadd32)(void* d, void* a, void* b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(int32_t)) {
        ...
        int32_t di;
        if (sadd32_overflow(ai, bi, &di)) { di = (di < 0 ? INT32_MAX : INT32_MIN); }
        *(int32_t*)(d + i) = di;
    }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_ssadd64)(void* d, void* a, void* b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(int64_t)) {
        ...
        int64_t di;
        if (sadd64_overflow(ai, bi, &di)) { di = (di < 0 ? INT64_MAX : INT64_MIN); }
        *(int64_t*)(d + i) = di;
    }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_sssub32)(void* d, void* a, void* b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(int32_t)) {
        ...
        int32_t bi = *(int32_t*)(b + i);
        int32_t di;
        if (ssub32_overflow(ai, bi, &di)) { di = (di < 0 ? INT32_MAX : INT32_MIN); }
        *(int32_t*)(d + i) = di;
    }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_sssub64)(void* d, void* a, void* b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(int64_t)) {
        ...
        int64_t bi = *(int64_t*)(b + i);
        int64_t di;
        if (ssub64_overflow(ai, bi, &di)) { di = (di < 0 ? INT64_MAX : INT64_MIN); }
        *(int64_t*)(d + i) = di;
    }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_usadd32)(void* d, void* a, void* b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint32_t)) {
        ...
        uint32_t di;
        if (uadd32_overflow(ai, bi, &di)) { di = UINT32_MAX; }
        *(uint32_t*)(d + i) = di;
    }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_usadd64)(void* d, void* a, void* b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint64_t)) {
        ...
        uint64_t di;
        if (uadd64_overflow(ai, bi, &di)) { di = UINT64_MAX; }
        *(uint64_t*)(d + i) = di;
    }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_ussub32)(void* d, void* a, void* b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint32_t)) {
        ...
        uint32_t bi = *(uint32_t*)(b + i);
        uint32_t di;
        if (usub32_overflow(ai, bi, &di)) { di = 0; }
        *(uint32_t*)(d + i) = di;
    }
    clear_high(d, oprsz, desc);
}
...
void HELPER(gvec_ussub64)(void* d, void* a, void* b, uint32_t desc)
{
    ...
    for (i = 0; i < oprsz; i += sizeof(uint64_t)) {
        ...
        uint64_t bi = *(uint64_t*)(b + i);
        uint64_t di;
        if (usub64_overflow(ai, bi, &di)) { di = 0; }
        *(uint64_t*)(d + i) = di;
    }
    clear_high(d, oprsz, desc);
}
